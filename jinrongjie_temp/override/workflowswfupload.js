        ...
        switch (errorCode) {
            ...
            case SWFUpload.UPLOAD_ERROR.FILE_CANCELLED:
                ...
                if (this.getStats().files_queued === 0) {
                    ...
                    $("#" + this.customSettings.cancelButtonId).attr("style", "color:gray;cursor:pointer");
                }
...
function fileDialogComplete_1() {
    ...
    if (this.getStats().files_queued > 0) {
        if (document.getElementById(this.customSettings.cancelButtonId)) {
            ...
            $("#" + this.customSettings.cancelButtonId).attr("style", "color:black;cursor:pointer");
        }
