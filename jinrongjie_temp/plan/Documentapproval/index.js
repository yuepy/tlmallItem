...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control108_46cZtf: function getData_control108_46cZtf(elem) {
      if (!elem) {
        return;
          ...
          content: [], degree: [], miji: { content: [], id: [] } }, base_info: { content: [] }, related_document: [], related_process: [], file: [] }; //附件-----------
    ...
    getData_control112_1msmLu: function getData_control112_1msmLu(elem) {
      var data = ['06公文审批流程-报告阅知类'];return data;
    },
    ...
    getData_control139_KCrEat: function getData_control139_KCrEat(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl118_x342Nu: function doAction_uiControl118_x342Nu(data, elem) {
    ...
    getData_control144_K9tuXT: function getData_control144_K9tuXT(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl123_pTBHQG: function doAction_uiControl123_pTBHQG(data, elem) {
    ...
    getTemplate_uiControl123_pTBHQG: function getTemplate_uiControl123_pTBHQG() {
    ...
    getData_control138_5sq6Uh: function getData_control138_5sq6Uh(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl117_4CC1vU: function doAction_uiControl117_4CC1vU(data, elem) {
    ...
    getTemplate_uiControl117_4CC1vU: function getTemplate_uiControl117_4CC1vU() {
