  ...
  ysp.runtime.Model.extendLoadingModel({
            ...
            $(this).children("td").each(function () {
              if ($(this).next().find('img').length == 1 && $(this).next().find('img').attr('src').indexOf('BacoError') !== -1) {
                ...
                //判断附件-------------------------------------
                    ...
                    var arr3 = [];if ($(this).children("table").find("a").length > 0) {
                      ...
                      var arr4 = [];$(this).children("select").children("option").each(function () {
                        ...
                        id: $(this).children("select").prop("id"), mark: '1', disabled: 'false' });
                ...
                var arr2 = [];if ($(this)[0].className == 'zdm' && /签字意见/.test($(this).text())) {
                  ...
                  }arr2.push({ type: 'fujian222', name: '相关附件', user: user }); // return {
                  //   name: elem.querySelector('td').textContent.trim(),
                  //   user
                  // };
                } //判断附件-------------------------------------
    ...
    getData_control167_Wi4pKJ: function getData_control167_Wi4pKJ(elem) {
      if (!elem) {
        ...
        var logintype = fileuploadannexupload.match(/"logintype":"[0-9]{1,}"/)[0].split(':')[1].replace(/"/g, '');user.logintype = logintype || '';
      }return { name: elem.querySelector('td').textContent.trim(), user: user };
    },
