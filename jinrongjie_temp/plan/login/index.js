...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control5_CNTcxJ: function getData_control5_CNTcxJ(elem) {
      if (!elem) {
        return;
      }
    },
    doAction_uiControl5_zOagGr: function doAction_uiControl5_zOagGr(data, elem) {},
    getTemplate_uiControl5_zOagGr: function getTemplate_uiControl5_zOagGr() {
