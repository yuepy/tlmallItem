(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control29_bpluQ1: function (elem) {
      if (!elem) {
        return;
      }var obj = {};obj.title = elem.querySelector('.panel-title').textContent;obj.currentPage = elem.querySelector('.datagrid-pager').querySelectorAll('td')[6].querySelector('input').value;obj.allPage = elem.querySelector('.datagrid-pager').querySelectorAll('td')[7].textContent;return obj;
    },
