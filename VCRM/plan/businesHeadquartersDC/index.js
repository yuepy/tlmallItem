(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control24_TVoMJ5: function (elem) {
      if (!elem) {
    ...
    doAction_uiControl24_zhHa86: function (data, elem) {
      ...
      // }
      if (data.eventType == 'AndroidBack') {//ysp.customHelper.AndroidBackFlag = 'reachBigData';
      }if (data.eventType === 'back') {
        var li = elem && elem.ownerDocument.querySelector('#searchHead').querySelectorAll('li').length;li > 1 ? elem.ownerDocument.querySelector('#searchHead').querySelectorAll('li')[li - 2].querySelector('a').click() : elem.ownerDocument.defaultView.close(); // if (!top.EAPI.isAndroid()) {
        //   var li = elem && elem.ownerDocument.querySelector('#searchHead').querySelectorAll('li').length;
    ...
    getTemplate_uiControl24_zhHa86: function () {
    ...
    getData_control25_glNhGn: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl25_W1tT4i: function (data, elem) {
    ...
    getTemplate_uiControl25_W1tT4i: function () {
    ...
    getData_control26_6nt4XO: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl26_oOKcTQ: function (data, elem) {
    ...
    getTemplate_uiControl26_oOKcTQ: function () {
    ...
    getData_control27_WVXydC: function (elem) {
      if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl27_48hTMO: function (data, elem) {
      if (!elem) {
        return;
    ...
    getTemplate_uiControl27_48hTMO: function () {
    ...
    getData_control28_RGrvIa: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl28_CnlucP: function (data, elem) {},
    getTemplate_uiControl28_CnlucP: function () {
