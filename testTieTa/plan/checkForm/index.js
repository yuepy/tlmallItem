(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control18_zVDwO4: function (elem) {
      if (elem) {
        var arr = [];var tit = [];var pData = [];var body = elem.contentWindow.document.querySelector("body");if (body.getAttribute("id") == "Form1") {
          var tab = body.querySelector("#TableLayoutPanel1");var tds = tab.querySelectorAll("td");var tdsLen = tds.length;for (var j = 0; j < 21; j++) {
            if (j % 2 == 0) {
          ...
          }for (var i = 21; i < tdsLen; i++) {
            if (i % 2 != 0) {
              if (tds[i].style.display != "none") {
                if (tds[i].textContent != "") {
                  tit.push(tds[i].textContent);
                }
              }
            } else {
              if (tds[i].style.display != "none") {
                if (tds[i].querySelector(".fluidWrap").querySelectorAll("input")[0]) {
                  pData.push(tds[i].querySelector(".fluidWrap").querySelectorAll("input")[0].value);
                } else {
                  pData.push(tds[i].querySelector(".fluidWrap").querySelectorAll("textarea")[0].value);
                }
              }
            }
    ...
    getTemplate_uiControl20_ygrQQk: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n      <div>\n        {data? <div className=\"ysp_mask\"><span className=\"suces\"></span></div> : \"\"}</div>\n    )\n  }\n});";
    ...
    getData_control33_PWLkyA: function (elem) {
      if (elem) {
        var data = [];var tit = elem.querySelector(".c").textContent.trim();var content = elem.querySelector(".messager-icon").nextElementSibling.textContent;var button = elem.querySelector(".messager-button").textContent;data.push(tit);data.push(content);data.push(button);return data;
      }return [];
    },
    doAction_uiControl5_vTT80c: function (data, elem) {},
    getTemplate_uiControl5_vTT80c: function () {
      var selfTemplate = "module.exports = React.createClass({\n  onClick:function(e){\n     var target=e.target;\n    var handler=this.props.customHandler;\n    if(handler){\n      handler({\n        data:target.getAttribute(\"data-index\"),\n        eventType:\"click\"\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.customData || [];\n    var _this = this;\n    return (\n      <div className=\"messagers\">{data&&data.length>0 ? <div className=\"messager\">\n        <div className=\"messager-title\">{data[0]}</div>\n        <div className=\"messager-body\">\n          <div className=\"messager-news\">{data[1]}</div>\n          <div className=\"btns\">\n            <span className=\"btn\" data-index=\"1\" onClick={_this.onClick.bind(_this)}>{data[2]}</span>\n          </div>\n        </div>\n      </div> : \"\"}</div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  onClick: function onClick(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        data: target.getAttribute(\"data-index\"),\n        eventType: \"click\"\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.customData || [];\n    var _this = this;\n    return React.createElement(\n      \"div\",\n      { className: \"messagers\" },\n      data && data.length > 0 ? React.createElement(\n        \"div\",\n        { className: \"messager\" },\n        React.createElement(\n          \"div\",\n          { className: \"messager-title\" },\n          data[0]\n        ),\n        React.createElement(\n          \"div\",\n          { className: \"messager-body\" },\n          React.createElement(\n            \"div\",\n            { className: \"messager-news\" },\n            data[1]\n          ),\n          React.createElement(\n            \"div\",\n            { className: \"btns\" },\n            React.createElement(\n              \"span\",\n              { className: \"btn\", \"data-index\": \"1\", onClick: _this.onClick.bind(_this) },\n              data[2]\n            )\n          )\n        )\n      ) : \"\"\n    );\n  }\n});";
    },

    getData_control36_f37TRe: function (elem) {
      if (elem) {
        var arr = [];var div = elem.nextElementSibling;if (div) {
          if (div.querySelector(".messager-body.panel-body.panel-body-noheader.panel-body-noborder.window-body.notify.notify-info")) {
            return true;
          } else {
            return false;
          }
    ...
    doAction_uiControl25_dOg56w: function (data, elem) {},
    getTemplate_uiControl25_dOg56w: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n      <div>\n        {data? <div className=\"ysp_mask\"><span className=\"spnull\">\u5BA1\u6279\u5185\u5BB9\u4E0D\u80FD\u4E3A\u7A7A</span></div> : \"\"}\n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    var data = this.props.customData;\n    return React.createElement(\n      \"div\",\n      null,\n      data ? React.createElement(\n        \"div\",\n        { className: \"ysp_mask\" },\n        React.createElement(\n          \"span\",\n          { className: \"spnull\" },\n          \"\\u5BA1\\u6279\\u5185\\u5BB9\\u4E0D\\u80FD\\u4E3A\\u7A7A\"\n        )\n      ) : \"\"\n    );\n  }\n});";
    },
    getData_control38_HZWfKG: function (elem) {
      if (elem) {
        var data = [];var tit = elem.querySelector(".panel-title").textContent.trim();var content = elem.querySelector(".messager-icon").nextElementSibling.textContent;var button = elem.querySelector(".messager-button").textContent;data.push(tit);data.push(content);data.push(button);return data;
      }return [];
    },
    doAction_uiControl26_npeIRM: function (data, elem) {
      if (data.eventType == "click") {
        elem.querySelector(".messager-button").querySelector("a").click();
      }
    },
    getTemplate_uiControl26_npeIRM: function () {
      var selfTemplate = "module.exports = React.createClass({\n  onClick:function(e){\n     var target=e.target;\n    var handler=this.props.customHandler;\n    if(handler){\n      handler({\n        eventType:\"click\"\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.customData || [];\n    var _this = this;\n    return (\n      <div className=\"messagers\">{data&&data.length>0 ? <div className=\"messager\">\n        <div className=\"messager-title\">{data[0]}</div>\n        <div className=\"messager-body\">\n          <div className=\"messager-news\">{data[1]}</div>\n          <div className=\"btns\">\n            <span className=\"btn\" onClick={_this.onClick.bind(_this)}>{data[2]}</span>\n          </div>\n        </div>\n      </div> : \"\"}</div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  onClick: function onClick(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \"click\"\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.customData || [];\n    var _this = this;\n    return React.createElement(\n      \"div\",\n      { className: \"messagers\" },\n      data && data.length > 0 ? React.createElement(\n        \"div\",\n        { className: \"messager\" },\n        React.createElement(\n          \"div\",\n          { className: \"messager-title\" },\n          data[0]\n        ),\n        React.createElement(\n          \"div\",\n          { className: \"messager-body\" },\n          React.createElement(\n            \"div\",\n            { className: \"messager-news\" },\n            data[1]\n          ),\n          React.createElement(\n            \"div\",\n            { className: \"btns\" },\n            React.createElement(\n              \"span\",\n              { className: \"btn\", onClick: _this.onClick.bind(_this) },\n              data[2]\n            )\n          )\n        )\n      ) : \"\"\n    );\n  }\n});";
    },
    getData_control35_hPHXP9: function (elem) {
      if (elem) {
        var arr = [];var div = elem.querySelector(".datagrid-mask-msg.loading-msg");if (div) {
          return true;
        } else {
          return false;
        }
    ...
    doAction_uiControl24_LrH2IK: function (data, elem) {},
    getTemplate_uiControl24_LrH2IK: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n      <div>\n        {data? <div className=\"ysp_mask\"><div className=\"load\"><span className=\"loading\"></span><span className=\"loadText\">\u6B63\u5728\u52A0\u8F7D\uFF0C\u8BF7\u7A0D\u7B49...</span></div></div> : \"\"}</div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    var data = this.props.customData;\n    return React.createElement(\n      \"div\",\n      null,\n      data ? React.createElement(\n        \"div\",\n        { className: \"ysp_mask\" },\n        React.createElement(\n          \"div\",\n          { className: \"load\" },\n          React.createElement(\"span\", { className: \"loading\" }),\n          React.createElement(\n            \"span\",\n            { className: \"loadText\" },\n            \"\\u6B63\\u5728\\u52A0\\u8F7D\\uFF0C\\u8BF7\\u7A0D\\u7B49...\"\n          )\n        )\n      ) : \"\"\n    );\n  }\n});";
    },
    getData_control41_zQtLrN: function (elem) {
      if (elem) {
        var arr = [];var div = elem.querySelector(".datagrid-mask-msg.loading-msg");if (div) {
          return true;
        } else {
    ...
    doAction_uiControl30_M7M0dC: function (data, elem) {},
    getTemplate_uiControl30_M7M0dC: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n      <div>\n        {data? <div className=\"ysp_mask\"><div className=\"load\"><span className=\"loading\"></span><span className=\"loadText\">\u6B63\u5728\u52A0\u8F7D\uFF0C\u8BF7\u7A0D\u7B49...</span></div></div> : \"\"}</div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    var data = this.props.customData;\n    return React.createElement(\n      \"div\",\n      null,\n      data ? React.createElement(\n        \"div\",\n        { className: \"ysp_mask\" },\n        React.createElement(\n          \"div\",\n          { className: \"load\" },\n          React.createElement(\"span\", { className: \"loading\" }),\n          React.createElement(\n            \"span\",\n            { className: \"loadText\" },\n            \"\\u6B63\\u5728\\u52A0\\u8F7D\\uFF0C\\u8BF7\\u7A0D\\u7B49...\"\n          )\n        )\n      ) : \"\"\n    );\n  }\n});";
    }
  }, 'checkForm');
