                    ...
                    if (configType != '02') {
                        ...
                        if(branches) {
                            for (var i = 0; i < branches.length; i++) {
                                var link = getLinkNew("04","branchName",branches[i].name);
      ...
      window.timeInit = function() {
        ...
        function getMap(datas, totalDatas, Id) {
            ...
            chart.on('click', function(params) {
                ...
                var link = getLinkNew("04","branchName",params.name);
                        ...
                        itemStyle: {
                            normal: {
                                ...
                                label: {
                                    ...
                                    offset: [23, 26],
                                    formatter: function formatter(params) {
                                      if(datas[0].value && datas[0].value > 0) {
                        ...
                        itemStyle: {
                            normal: {
                                ...
                                label: {
                                    ...
                                    offset: [23, 26],
                                    formatter: function formatter(params) {
                                      if(datas[2].value && datas[2].value > 0) {
