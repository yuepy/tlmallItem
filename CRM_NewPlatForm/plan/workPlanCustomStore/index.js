(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control42_A9IB6L: function (elem) {
      ...
      }var doc = elem.ownerDocument;var win = doc.defaultView;var isShow = '';var queryBtn;var queryInput;
      ...
      if ('query' == data.eventType) {
        ...
        input.blur();targetJump && targetJump.querySelector('.skip_right_goto .skip-right-icon') && targetJump.querySelector('.skip_right_goto .skip-right-icon').click();
