...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control264_7GTTNq: function getData_control264_7GTTNq(elem) {
      if (!elem) {
        return;
      }var data = { header: { title: [], number: [] }, base_lc_info: { title: [], content: [], degree: [], miji: { content: [], id: [] } }, base_info: { content: [] }, related_document: [], related_process: [], file: [], state: [] }; //附件-----------
    ...
    }, doAction_uiControl253_4RR9p0: function doAction_uiControl253_4RR9p0(data, elem) {
    ...
    getTemplate_uiControl255_maBNaH: function getTemplate_uiControl255_maBNaH() {
    ...
    doAction_uiControl257_dCsl0B: function doAction_uiControl257_dCsl0B(data, elem) {
    ...
    getTemplate_uiControl257_dCsl0B: function getTemplate_uiControl257_dCsl0B() {
    ...
    getData_control337_RJ68ue: function getData_control337_RJ68ue(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl337_gvHE9F: function doAction_uiControl337_gvHE9F(data, elem) {},
    getTemplate_uiControl337_gvHE9F: function getTemplate_uiControl337_gvHE9F() {
