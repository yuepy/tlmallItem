  ...
  ysp.runtime.Model.extendLoadingModel({
            ...
            if ($(this)[0].className == 'zdm') {
              arr2.push({ text: $(this).text().replace(/\s/ig, "").trim(), type: 'title' });
                ...
                $(this).children("table").find("a").each(function () {
                  //var arr3 = [];
                  arr2.push({ text: $(this).text().trim(), type: 'fujian' }); //arr2.push(arr3);
                }); //判断select-------------------------------------
                    ...
                    arr2.push({ text: $(this).children("span").text(), type: 'a' });
                      ...
                      arr2.push({ text: $(this).children("textarea").prop('value'), type: 'textarea' });
                        ...
                        $(this).children("button").each(function () {
                          arr2.push({ text: $(this).attr('title'),
                            type: 'button' });
                        }); // arr2.push(arr5);
                      } //判断意见-------------------------------------
                          ...
                          arr2.push({
                            text: $(this).find(".cke_editor").find('iframe')[0].contentDocument.body.innerHTML, type: 'suggest_final' });
    ...
    getData_control14_w3F5Ok: function (elem) {
      var data = { title: [], content: [] };if ($(elem).children(".HeaderForWF").length > 0 && $(elem).children(".HeaderForWF").children("th").length > 0) {
        ...
        $(elem).children(".datalight").children("td").each(function () {
          data.content.push($(this).text().replace(/\s/ig, ""));
        });
      }return data;
    },
    doAction_uiControl15_IHevAQ: function (data, elem) {},
    getTemplate_uiControl15_IHevAQ: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    var _this = this;\n    var item = data.title.map(function(d,i){\n      return(<div><span>{d}</span><span>{data.content[i]}</span></div>)\n    })\n    return (\n      <div>\n        {item}\n      </div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData;\n    var _this = this;\n    var item = data.title.map(function (d, i) {\n      return React.createElement(\n        "div",\n        null,\n        React.createElement(\n          "span",\n          null,\n          d\n        ),\n        React.createElement(\n          "span",\n          null,\n          data.content[i]\n        )\n      );\n    });\n    return React.createElement(\n      "div",\n      null,\n      item\n    );\n  }\n});';
    }
  });
})(window, ysp);