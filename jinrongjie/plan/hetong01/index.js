  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl28_SgTJbB: function (data, elem) {
      if (data.eventType == 'inputBlur') {
        ...
        elem.ownerDocument.defaultView.eval(elem.querySelector('.Browser').onclick());elem.querySelector('.Browser').onclick(); // var tbody2 = $(elem).children("table").eq(1).children("tbody")[0];
