    ...
    ysp.runtime.Model.extendLoadingModel({
                ...
                $(tbody2).children("tr").each(function() {
                    if ($(this)[0].style.display !== 'none') {
                        $(this).children("td").each(function() {
                            ...
                            if ($(this)[0].className == 'zdm' && $(this).next().find('img').length == 2 && $(this).next().find('img').eq(1).attr('src').indexOf('BacoError') !== -1) {
                                arr2.push({ text: $(this).text().replace(/\s/ig, "").trim(), type: 'title', mark: '1' });
                            }
        ...
        doAction_uiControl139_GxHQcK: function(data, elem) {
            ...
            if (data.eventType == 'about1') {
                ...
                elem.querySelector('button[title="相关文档"]').onclick(); // var tbody2 = $(elem).children("table").eq(1).children("tbody")[0];
