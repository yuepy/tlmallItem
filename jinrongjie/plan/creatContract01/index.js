...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control160_Nogrz1: function getData_control160_Nogrz1(elem) {},
    doAction_uiControl137_fmCR9N: function doAction_uiControl137_fmCR9N(data, elem) {
      if (data.eventType == 'click') {
        ysp.customHelper.back();setTimeout(function () {
    ...
    getTemplate_uiControl137_fmCR9N: function getTemplate_uiControl137_fmCR9N() {
    ...
    getData_control161_WPzyCP: function (elem) {
      if (!elem) {
        return;
      }var data = { header: { title: [], number: [] }, base_lc_info: { title: [], content: [], degree: [], miji: { content: [], id: [] } }, base_info: { content: [] }, related_document: [], related_process: [], file: [], state: [] }; //展开收起
      if ($(elem).find('#field27376span').length > 0 || $(elem).find('#field27381span').length > 0) {
                      ...
                      if ($(this).attr('onclick') !== undefined && $(this).attr('onclick').indexOf('openAccessory') !== -1) {
                        if ($(this).text().indexOf('txt') !== -1) {
                          ...
                          arr3.push({ name: $(this).text().trim(),
                            stl: 'xls', no: $(this).attr('onClick').match(/\d+/g)[1] });
                          ...
                          arr3.push({ name: $(this).text().trim(), stl: 'ppt', no: $(this).attr('onClick').match(/\d+/g)[1] });
                        } else {
                          arr3.push({
    ...
    }, doAction_uiControl139_GxHQcK: function (data, elem) {
      if (data.eventType == 'deleteFile') {
        ...
        setTimeout(function () {
          ysp.appMain.hideLoading();
        }, 1000);var id = data.dataCustom;var elem2 = $(elem).children("table").eq(1)[0];var tbody2 = $(elem).children("table").eq(1).children("tbody")[0];$(tbody2).find("button").each(function () {
        ...
        setTimeout(function () {
          ysp.appMain.hideLoading();
        }, 1000);debugger;var id = data.dataCustom;var elem2 = $(elem).children("table").eq(1)[0];var tbody2 = $(elem).children("table").eq(1).children("tbody")[0];$(tbody2).find("button").each(function () {
          if ($(this)[0].id == id) {
            $(this).click();
          }
        });
    ...
    doAction_uiControl140_Jf3wSc: function doAction_uiControl140_Jf3wSc(data, elem) {
      if (data.eventType == 'deleteFile') {
    ...
    getTemplate_uiControl140_Jf3wSc: function getTemplate_uiControl140_Jf3wSc() {
    ...
    getData_control189_AJKiTl: function getData_control189_AJKiTl(elem) {
      if (!elem) {
        return;
      }var data = [];data.push(elem.textContent);return data;
    },
    doAction_uiControl170_rVTTrd: function doAction_uiControl170_rVTTrd(data, elem) {
    ...
    getData_control324_LALT5Q: function getData_control324_LALT5Q(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl324_MokEaU: function doAction_uiControl324_MokEaU(data, elem) {// {this.props.customData? <div ref="load" className="ysp_roatLoading"><span className="roatImg"></span></div>:""}
    },
    getTemplate_uiControl324_MokEaU: function getTemplate_uiControl324_MokEaU() {
