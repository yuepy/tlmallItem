(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control160_Nogrz1: function (elem) {},
    doAction_uiControl137_fmCR9N: function (data, elem) {
    ...
    getTemplate_uiControl137_fmCR9N: function () {
    ...
    getTemplate_uiControl140_Jf3wSc: function () {
    ...
    getData_control189_AJKiTl: function (elem) {
      if (!elem) {
        return;
      }var data = [];data.push(elem.textContent);return data;
    },
    doAction_uiControl170_rVTTrd: function (data, elem) {
    ...
    getTemplate_uiControl170_rVTTrd: function () {
    ...
    getData_control324_LALT5Q: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl324_MokEaU: function (data, elem) {// {this.props.customData? <div ref="load" className="ysp_roatLoading"><span className="roatImg"></span></div>:""}
    },
    getTemplate_uiControl324_MokEaU: function () {
