...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control161_WPzyCP: function getData_control161_WPzyCP(elem) {
      if (!elem) {
        return;
          ...
          if ($(this)[0].style.display !== 'none') {
            $(this).children("td").each(function () {
              ...
              if ($(this)[0].className == 'zdm' && $(this).next().find('img').length == 1 && $(this).next().find('img').attr('src').indexOf('BacoError') !== -1) {
                ...
                arr2.push({
                  text: $(this).text().replace(/\s/ig, "").trim(), type: 'tit_yell2' });
                    ...
                    $(this).children("table").find("a").each(function (i) {
                      if ($(this).attr('onclick') !== undefined && $(this).attr('onclick').indexOf('openAccessory') !== -1) {
                        if ($(this).text().indexOf('txt') !== -1) {
                          ...
                          arr3.push({ name: $(this).text().trim(), stl: 'ppt',
                        ...
                        if ($(this).next().text().indexOf('txt') !== -1) {
                          ...
                          arr3.push({
                            name: $(this).next().text().trim(), stl: 'jpg', no: 'push' });
    ...
    }, doAction_uiControl139_GxHQcK: function doAction_uiControl139_GxHQcK(data, elem) {
