(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control83_eX9RZZ: function (elem) {},
    doAction_uiControl69_Q02nTc: function (data, elem) {
    ...
    getTemplate_uiControl69_Q02nTc: function () {
    ...
    getData_control84_WLPGeH: function (elem) {
      if (!elem) {
        return;
    ...
    getTemplate_uiControl70_cTSkQ7: function () {
    ...
    getData_control85_iBDsJk: function (elem) {
      if (!elem) {
        return;
      }var data = {};var tds = elem.querySelectorAll('td');if (tds.length < 1) {
        return;
    ...
    doAction_uiControl74_PW1aWC: function (data, elem) {
    ...
    getTemplate_uiControl74_PW1aWC: function () {
    ...
    getData_control93_uSqtZQ: function (elem) {},
    doAction_uiControl77_5LxAdz: function (data, elem) {},
    getTemplate_uiControl77_5LxAdz: function () {
