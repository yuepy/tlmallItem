...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control71_KwgXqv: function getData_control71_KwgXqv(elem) {
      if (!elem) {
        return;
      }var data = { header: { title: [], number: [] },
        base_lc_info: { title: [],
          content: [], degree: [], miji: { content: [], id: [] } },
        base_info: { content: [] }, related_document: [], related_process: [], file: [] }; //附件-----------
            ...
            if ($(this).next().children('.zdm').length == 2 && $(this).next().children('.zdn').length == 0) {
              var _this = this;$(this).next().children(".zdm").eq(1).find("tr").each(function (i) {
                if ($(this)[0].style.display !== 'none') {
                  var arr2 = [];arr2.push({ num: $(this).children("td").eq(0).find("input").prop("value"), idInput: $(this).children("td").eq(0).find("input").prop("id"), no: i, type: 'card', idButton: $(_this).next().children(".zdm").eq(0).find("tr").eq(i).children("td").eq(0).find("button")[0].getAttribute('onClick').match(/field\d+_\d+/), a: $(_this).next().children(".zdm").eq(0).find("tr").eq(i).children("td").eq(0).find("a").text() });data.base_info.content.push(arr2);
                }
              });
            }
          } else {
    ...
    }, doAction_uiControl61_VyRqhF: function doAction_uiControl61_VyRqhF(data, elem) {
    ...
    doAction_uiControl85_D8fJnW: function doAction_uiControl85_D8fJnW(data, elem) {
      if (data.eventType == 'textarea') {
        debugger;var inner = data.dataCustom;$(elem).find(".cke_editor").find("iframe")[0].contentDocument.body.innerHTML = inner;
      }
    },
    getTemplate_uiControl85_D8fJnW: function getTemplate_uiControl85_D8fJnW() {
    ...
    getData_control100_TOs6Ev: function getData_control100_TOs6Ev(elem) {
      if (!elem) {
        return;
      }var data = [];data.push(elem.textContent);return data;
    },
    doAction_uiControl88_bzSt0V: function doAction_uiControl88_bzSt0V(data, elem) {
    ...
    getTemplate_uiControl88_bzSt0V: function getTemplate_uiControl88_bzSt0V() {
    ...
    getData_control101_BtLdvd: function getData_control101_BtLdvd(elem) {},
    doAction_uiControl89_AAi0kp: function doAction_uiControl89_AAi0kp(data, elem) {
    ...
    doAction_uiControl336_aVDpkZ: function doAction_uiControl336_aVDpkZ(data, elem) {},
    getTemplate_uiControl336_aVDpkZ: function getTemplate_uiControl336_aVDpkZ() {
