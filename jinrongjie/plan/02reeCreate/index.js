...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control107_hcDcDs: function getData_control107_hcDcDs(elem) {},
    doAction_uiControl92_agONR6: function doAction_uiControl92_agONR6(data, elem) {
    ...
    getTemplate_uiControl92_agONR6: function getTemplate_uiControl92_agONR6() {
    ...
    getData_control222_bEGuqJ: function (elem) {
      if (!elem) {
        return;
      }var data = { header: { title: [], number: [] }, base_lc_info: { title: [], content: [], degree: [], miji: { content: [], id: [] } }, base_info: { content: [] }, related_document: [], related_process: [], file: [], state: [] };if ($(elem).find('#field9081span').length > 0) {
        if ($(elem).find('#field9081span').find("a").length > 0) {
    ...
    doAction_uiControl273_TdCDGP: function (data, elem) {
    ...
    doAction_uiControl274_Zr6Vn0: function doAction_uiControl274_Zr6Vn0(data, elem) {
      if (data.eventType == 'deleteFile') {
    ...
    getTemplate_uiControl274_Zr6Vn0: function getTemplate_uiControl274_Zr6Vn0() {
    ...
    getData_control287_imfHhl: function getData_control287_imfHhl(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl275_h4JoXl: function doAction_uiControl275_h4JoXl(data, elem) {
    ...
    getData_control334_0qTQLL: function getData_control334_0qTQLL(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl334_y3fM7C: function doAction_uiControl334_y3fM7C(data, elem) {},
    getTemplate_uiControl334_y3fM7C: function getTemplate_uiControl334_y3fM7C() {
