...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control192_TDRc14: function getData_control192_TDRc14(elem) {
      if (!elem) {
        retrun;
      } else {
    ...
    doAction_uiControl172_wZVdbQ: function doAction_uiControl172_wZVdbQ(data, elem) {
    ...
    getData_control193_oSeDNM: function getData_control193_oSeDNM(elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl175_QTdTSV: function doAction_uiControl175_QTdTSV(data, elem) {
      if (data.eventType == 'deleteFile') {
