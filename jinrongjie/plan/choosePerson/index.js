    ...
    getData_control31_MQw3uc: function (elem) {
      ...
      if (data.eventType == 'selectPerson') {
        ...
        var val = data.dataCustom;if (elem.contentDocument.getElementById("oTable1")) {
          var elem1 = elem.contentDocument.getElementById("oTable1");if ($(elem1).find("#frame1").length > 0) {
            var elem2 = $(elem1).find("#frame1")[0].contentDocument.body;if ($(elem2).find("#SearchForm").length > 0 && $(elem2).find("#SearchForm").children(".ViewForm").length > 0) {
              var search = $(elem2).find("#SearchForm").children(".ViewForm")[0];
              if ($(search).find("input[name='lastname']").length > 0) {
        ...
        ysp.customHelper.pageid();elem.ownerDocument.defaultView.BrowseTable_onclick = function (e) {
          ...
          var curTr = elem.ownerDocument.querySelectorAll('frame')[1].contentDocument.querySelectorAll('iframe')[1].contentDocument.querySelector('tbody tbody').querySelectorAll('tr')[data.dataCustom];elem.ownerDocument.defaultView.opener._setReturnValue({ id: elem.ownerDocument.defaultView.jQuery(curTr.cells[0]).text(),
            name: elem.ownerDocument.defaultView.jQuery(curTr.cells[1]).text(), a1: elem.ownerDocument.defaultView.jQuery(curTr.cells[3]).text(), a2: elem.ownerDocument.defaultView.jQuery(curTr.cells[4]).text() });if (elem.ownerDocument.defaultView.parent.parent.opener.searchcreaterSpan) {
