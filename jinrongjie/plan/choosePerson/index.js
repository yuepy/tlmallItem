...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control31_MQw3uc: function getData_control31_MQw3uc(elem) {
          ...
          var elem1 = elem.contentDocument.getElementById("oTable1");if ($(elem1).find("#frame2").length > 0) {
            var elem3 = $(elem1).find("#frame2")[0].contentDocument.body;if ($(elem3).find("table").length > 0) {
              ...
              if ($(tr1).children("td").eq(0).find('option').length > 0) {
                ...
                });$(tr1).children("td").eq(0).find("select")[0].dispatchEvent(new MouseEvent("dblclick"));
              }
            }
          }
        }
      ...
      }if (data.eventType == 'dlssrds') {
        ysp.customHelper.pageid();elem.ownerDocument.defaultView.BrowseTable_onclick = function (e) {
          // var e = e || elem.ownerDocument.defaultView.event;
          // var target = e.srcElement || e.target;
          // if (target.nodeName == "TD" || target.nodeName == "A") {
          var curTr = elem.ownerDocument.querySelectorAll('frame')[1].contentDocument.querySelectorAll('iframe')[1].contentDocument.querySelector('tbody tbody').querySelectorAll('tr')[data.dataCustom];elem.ownerDocument.defaultView.opener._setReturnValue({ id: elem.ownerDocument.defaultView.jQuery(curTr.cells[0]).text(), name: elem.ownerDocument.defaultView.jQuery(curTr.cells[1]).text(), a1: elem.ownerDocument.defaultView.jQuery(curTr.cells[3]).text(), a2: elem.ownerDocument.defaultView.jQuery(curTr.cells[4]).text() });if (elem.ownerDocument.defaultView.parent.parent.opener.searchcreaterSpan) {
            elem.ownerDocument.defaultView.parent.parent.opener.searchcreaterSpan.textContent = curTr.cells[1].textContent;
          } else if (elem.ownerDocument.defaultView.parent.parent.opener.createrSpan) {
            elem.ownerDocument.defaultView.parent.parent.opener.createrSpan.textContent = curTr.cells[1].textContent;
          }elem.ownerDocument.defaultView.parent.parent.close();
    ...
    doAction_uiControl36_Ik9Qso: function doAction_uiControl36_Ik9Qso(data, elem) {
      if (data.eventType == 'click') {
        ...
        elem.ownerDocument.defaultView.parent.parent.opener._setReturnValue({ id: '', name: '' });elem.ownerDocument.defaultView.parent.parent.close(); // elem.ownerDocument.defaultView.btnok_onclick();
      }
    },
