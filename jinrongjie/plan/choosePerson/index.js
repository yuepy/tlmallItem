  ...
  ysp.runtime.Model.extendLoadingModel({
    getData_control31_MQw3uc: function (elem) {
      ...
      if (data.eventType == 'selectPerson') {
        ...
        elem.ownerDocument.defaultView.BrowseTable_onclick = function (e) {
          // var e = e || elem.ownerDocument.defaultView.event;
          // var target = e.srcElement || e.target;
          // if (target.nodeName == "TD" || target.nodeName == "A") {
          var curTr = elem.ownerDocument.querySelectorAll('frame')[1].contentDocument.querySelectorAll('iframe')[1].contentDocument.querySelector('tbody tbody').querySelectorAll('tr')[data.dataCustom];elem.ownerDocument.defaultView.opener._setReturnValue({ id: elem.ownerDocument.defaultView.jQuery(curTr.cells[0]).text(), name: elem.ownerDocument.defaultView.jQuery(curTr.cells[1]).text(),
            a1: elem.ownerDocument.defaultView.jQuery(curTr.cells[3]).text(), a2: elem.ownerDocument.defaultView.jQuery(curTr.cells[4]).text() });if (elem.ownerDocument.defaultView.parent.parent.opener.searchcreaterSpan) {
        ...
        var elem1 = elem.contentDocument.getElementById("oTable1");var elem3 = $(elem1).find("#frame2")[0].contentDocument.body;var Tbody = $(elem3).find("table").children("tbody")[0];var tr0 = $(Tbody).children("tr").eq(0)[0];
        if ($(tr0).children("td").length > 0 && $(tr0).find("input").length > 0) {
