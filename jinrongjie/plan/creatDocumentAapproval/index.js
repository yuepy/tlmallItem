...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control110_XrebWI: function getData_control110_XrebWI(elem) {
      if (!elem) {
        return;
                  ...
                  $(this).children("table").find("a").each(function (i) {
                    if ($(this).attr('onclick') !== undefined && $(this).attr('onclick').indexOf('openAccessory') !== -1) {
                      ...
                      if ($(this).next().text().indexOf('txt') !== -1) {
                        ...
                        arr3.push({
                          name: $(this).next().text().trim(), stl: 'gif', no: 'push' });
    ...
    }, doAction_uiControl63_VG18Wm: function doAction_uiControl63_VG18Wm(data, elem) {
      if (data.eventType == 'deleteFile') {
        ...
        }, 1000); // elem.ownerDocument.defaultView.eval(elem.querySelectorAll('.Browser')[0].onclick());
