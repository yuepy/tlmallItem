(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control31_PFPBZl: function (elem) {
      if (!elem) {
        return;
      }
    },
    doAction_uiControl42_UPQrZg: function (data, elem) {
      var eventType = data.eventType;if (eventType == 'dataChange') {
        console.log(elem);elem.querySelector('body').querySelector('p').textContent = data.dataCustom;
      }
    },
    getTemplate_uiControl42_UPQrZg: function () {
    ...
    getData_control48_mZkhDC: function (elem) {
      if (!elem) {
        return;
      }
    },
    doAction_uiControl45_T2guZ9: function (data, elem) {
      var eventType = data.eventType;if (eventType == 'dataChange') {
        // console.log(data.dataCustom);
        // var iframe = elem.ownerDocument; // console.log(iframe);
        // console.log(elem);
        if (elem.ownerDocument.querySelector('p')) {
          alert(22);console.log(elem.ownerDocument.querySelector('p')); // elem.ownerDocument.querySelector('p').textContent = data.dataCustom;
        } else {
          alert(111);
        }
      }
    },
    getTemplate_uiControl45_T2guZ9: function () {
      var selfTemplate = 'import { Component } from \'react\';\nimport { CustomHeader } from \'ysp-custom-components\';\n\nexport default class extends Component {\n  constructor(){\n    super();\n  }\n\n  onChange=(e)=>{\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        data:e.target.value,\n        eventType:\'dataChange\'\n      })\n    }\n  }\n\n  render(){\n    var _this = this;\n    return (\n      <div className="ysp-manager-audit-sign">\n        <span>\u7B7E\u5B57\u610F\u89C1</span>\n        <div><textarea onChange={_this.onChange.bind(_this)}></textarea></div>\n      </div>\n    )\n  }\n}';
      return '\'use strict\';\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require(\'react\');\n\nvar _yspCustomComponents = require(\'ysp-custom-components\');\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    var _this2 = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this));\n\n    _this2.onChange = function (e) {\n      var handler = _this2.props.customHandler;\n      if (handler) {\n        handler({\n          data: e.target.value,\n          eventType: \'dataChange\'\n        });\n      }\n    };\n\n    return _this2;\n  }\n\n  _createClass(_class, [{\n    key: \'render\',\n    value: function render() {\n      var _this = this;\n      return React.createElement(\n        \'div\',\n        { className: \'ysp-manager-audit-sign\' },\n        React.createElement(\n          \'span\',\n          null,\n          \'\\u7B7E\\u5B57\\u610F\\u89C1\'\n        ),\n        React.createElement(\n          \'div\',\n          null,\n          React.createElement(\'textarea\', { onChange: _this.onChange.bind(_this) })\n        )\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;';
    }
  });
