...
(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control23_nAAQod: function getData_control23_nAAQod(elem) {
      // if (!elem) {
      //   return;
      // }
      // var data = {};
    ...
    }, doAction_uiControl23_PUM7iP: function doAction_uiControl23_PUM7iP(data, elem) {
    ...
    getTemplate_uiControl23_PUM7iP: function getTemplate_uiControl23_PUM7iP() {
    ...
    getData_control24_s2hR81: function getData_control24_s2hR81(elem) {
      if (!elem) {
        return;
      } // var data = {};
    ...
    doAction_uiControl24_s3lOQh: function doAction_uiControl24_s3lOQh(data, elem) {
    ...
    getTemplate_uiControl24_s3lOQh: function getTemplate_uiControl24_s3lOQh() {
    ...
    getData_control28_hPr3qu: function (elem) {
      if (!elem) {
        return;
      }var data = {};var docData = [];var tds = elem.querySelectorAll('td');if (tds.length < 1) {
        return;
      }[].forEach.call(tds, function (item, index) {
        if (index == 0) {
          data.title = item.textContent.trim();
        }
      });if (elem.querySelector('#signdocspan')) {
        [].forEach.call(elem.querySelector('#signdocspan').querySelectorAll('a'), function (item, index) {
          docData.push(item.textContent.trim());
        });
      }data.docData = docData;return data;
    },
    ...
    getData_control29_tXFBoh: function (elem) {
      ...
      });if (elem.querySelector('#signworkflowspan')) {
        [].forEach.call(elem.querySelector('#signworkflowspan').querySelectorAll('a'), function (item, index) {
          docData.push(item.textContent.trim());
        });
      }data.docData = docData;return data;
    },
    ...
    getTemplate_uiControl43_lpdLEi: function getTemplate_uiControl43_lpdLEi() {
    ...
    getTemplate_uiControl42_3fvgmQ: function getTemplate_uiControl42_3fvgmQ() {
      var selfTemplate = "import { Component } from 'react';\nimport { CustomHeader } from 'ysp-custom-components';\n\nexport default class extends Component {\n  constructor(){\n    super();\n  }\n\n  onChange=(e)=>{\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        data:e.target.value,\n        eventType:'dataChange'\n      })\n    }\n  }\n\n  render(){\n    var _this = this;\n    return (\n      <div className=\"ysp-manager-audit-sign\">\n        <span>\u7B7E\u5B57\u610F\u89C1</span>\n        <div><textarea onChange={_this.onChange.bind(_this)}></textarea></div>\n      </div>\n    )\n  }\n}";
    ...
    getData_control54_tKcIkL: function getData_control54_tKcIkL(elem) {},
    doAction_uiControl51_V4IX3G: function doAction_uiControl51_V4IX3G(data, elem) {},
    getTemplate_uiControl51_V4IX3G: function getTemplate_uiControl51_V4IX3G() {
    ...
    getTemplate_uiControl53_WgB6r3: function getTemplate_uiControl53_WgB6r3() {
    ...
    getData_control57_gQMeSo: function getData_control57_gQMeSo(elem) {},
    doAction_uiControl54_f241s1: function doAction_uiControl54_f241s1(data, elem) {},
    getTemplate_uiControl54_f241s1: function getTemplate_uiControl54_f241s1() {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    return (\n      <div className="background-gray"></div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    return React.createElement("div", { className: "background-gray" });\n  }\n});';
    },
    getData_control58_T9FLu4: function getData_control58_T9FLu4(elem) {},
    doAction_uiControl55_kuzLnG: function doAction_uiControl55_kuzLnG(data, elem) {},
    getTemplate_uiControl55_kuzLnG: function getTemplate_uiControl55_kuzLnG() {
      var selfTemplate = 'import { Component } from \'react\';\nimport { CustomHeader } from \'ysp-custom-components\';\n\nexport default class extends Component {\n  \n  render(){\n      var data = this.props.customData;\n      return (\n        <div className="ysp-manager-audit-title-icon">\n          <span>\u76F8\u5173\u6D41\u7A0B</span>\n          <i className="arrow-right"></i>\n        </div>\n      )\n  }\n}';
      return '\'use strict\';\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require(\'react\');\n\nvar _yspCustomComponents = require(\'ysp-custom-components\');\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));\n  }\n\n  _createClass(_class, [{\n    key: \'render\',\n    value: function render() {\n      var data = this.props.customData;\n      return React.createElement(\n        \'div\',\n        { className: \'ysp-manager-audit-title-icon\' },\n        React.createElement(\n          \'span\',\n          null,\n          \'\\u76F8\\u5173\\u6D41\\u7A0B\'\n        ),\n        React.createElement(\'i\', { className: \'arrow-right\' })\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;';
    },
    getData_control59_JQESHT: function getData_control59_JQESHT(elem) {},
    doAction_uiControl56_NvTH1u: function doAction_uiControl56_NvTH1u(data, elem) {},
    getTemplate_uiControl56_NvTH1u: function getTemplate_uiControl56_NvTH1u() {
      var selfTemplate = 'import { Component } from \'react\';\nimport { CustomHeader } from \'ysp-custom-components\';\n\nexport default class extends Component {\n  \n  render(){\n      var data = this.props.customData;\n      return (\n      <div className="ysp-manager-audit-title-icon">\n        <span>\u76F8\u5173\u6587\u6863</span>\n        <i className="arrow-right"></i>\n      </div>);\n  }\n}';
      return '\'use strict\';\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require(\'react\');\n\nvar _yspCustomComponents = require(\'ysp-custom-components\');\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));\n  }\n\n  _createClass(_class, [{\n    key: \'render\',\n    value: function render() {\n      var data = this.props.customData;\n      return React.createElement(\n        \'div\',\n        { className: \'ysp-manager-audit-title-icon\' },\n        React.createElement(\n          \'span\',\n          null,\n          \'\\u76F8\\u5173\\u6587\\u6863\'\n        ),\n        React.createElement(\'i\', { className: \'arrow-right\' })\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;';
    },
    getData_control60_pHbEeO: function getData_control60_pHbEeO(elem) {},
    doAction_uiControl57_paZHVD: function doAction_uiControl57_paZHVD(data, elem) {},
    getTemplate_uiControl57_paZHVD: function getTemplate_uiControl57_paZHVD() {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    return (\n      <div className="background-gray"></div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    return React.createElement("div", { className: "background-gray" });\n  }\n});';
    },

    getData_control62_7sJo6r: function getData_control62_7sJo6r(elem) {},
    doAction_uiControl59_yb8Jcb: function doAction_uiControl59_yb8Jcb(data, elem) {},
    getTemplate_uiControl59_yb8Jcb: function getTemplate_uiControl59_yb8Jcb() {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    return (\n      <div className="background-gray"></div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    return React.createElement("div", { className: "background-gray" });\n  }\n});';
    },
    getData_control37_TGCNSA: function getData_control37_TGCNSA(elem) {},
    doAction_uiControl35_NVoS8U: function doAction_uiControl35_NVoS8U(data, elem) {},
    getTemplate_uiControl35_NVoS8U: function getTemplate_uiControl35_NVoS8U() {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    return (\n      <div className="background-gray"></div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    return React.createElement("div", { className: "background-gray" });\n  }\n});';
    },
        ...
        [].forEach.call(doc.querySelectorAll('tr'), function (trItem, trIndex) {
          if (trIndex == 0) {
            [].forEach.call(trItem.querySelectorAll('th'), function (tdItem, tdIndex) {
              titles.push(tdItem.textContent.replace(/\s/g, ""));
            });
          } else {
            var tdContent = [];[].forEach.call(trItem.querySelectorAll('td'), function (trItem, trIndex) {
              tdContent.push(trItem.textContent.replace(/\s/g, ""));
            });content.push(tdContent);
          }
        });
      }data.titles = titles;data.content = content;return data;
    },
    doAction_uiControl34_Z2l1T9: function (data, elem) {
      var eventType = data.eventType;if (eventType == 'downLoadFile') {
        var index = parseInt(data.dataCustom);console.log(elem.querySelector('#SignTabUpload').querySelector('table').querySelectorAll('tr')[index + 1].querySelectorAll('td')[3].querySelector('a').click());
      } else if (eventType == 'btnClick') {
        var docElem = elem.ownerDocument.querySelector('form[name="frmmain"]');var buttomTab = $(docElem).children('table')[2];buttomTab.querySelectorAll('td')[3].click();
      }
    },
    getTemplate_uiControl34_Z2l1T9: function () {
      var selfTemplate = 'import { Component } from \'react\';\nimport { CustomHeader } from \'ysp-custom-components\';\n\nexport default class extends Component {\n  constructor(props) {\n    super(props);\n    this.state = {\n      openFlg: true\n    }\n\t}\n  \n downLoadFile=(e)=>{\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        data: e.target.getAttribute(\'data-index\'),\n        eventType:\'downLoadFile\'\n      })\n    }\n  }\n \n  btnClick=(e)=>{\n    this.setState((prevState, props) => {\n      return {openFlg: !prevState.openFlg};\n    });\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        eventType:\'btnClick\'\n      })\n    }\n  }\n  \n  render(){\n    \tvar _this = this;\n      var data = this.props.customData||{};\n    \tvar titles = data.titles||[];\n    \tvar content = data.content||[];\n    \tvar isOpen = data.isOpen||"";\n      return (\n        <div className="ysp-manager-audit-title-icon">\n          <span>\u76F8\u5173\u9644\u4EF6</span>\n          <i className="arrow-right" onClick={_this.btnClick.bind(_this)}></i>\n          {(content.length>0&&isOpen==""&&_this.state.openFlg)?\n          content.map((item ,index)=>{\n            return(\n            \t<div className="ysp-sign-tab-upload">\n              \t{/*item instanceof Array &&item.length>0&&\n                \titem.map((tdItem, tdIndex)=>{\n                  \treturn <span>{tdItem}</span>\n                \t})\n                */}\n                <div className="content">\n                \t<span>{item[1]}</span><span data-index={index} onClick={_this.downLoadFile.bind(_this)}>\u4E0B\u8F7D</span>\n                </div>\n              </div>\n            )\n          })\n          :""}\n        </div>\n      )\n  }\n}';
      return '\'use strict\';\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require(\'react\');\n\nvar _yspCustomComponents = require(\'ysp-custom-components\');\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class(props) {\n    _classCallCheck(this, _class);\n\n    var _this2 = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, props));\n\n    _this2.downLoadFile = function (e) {\n      var handler = _this2.props.customHandler;\n      if (handler) {\n        handler({\n          data: e.target.getAttribute(\'data-index\'),\n          eventType: \'downLoadFile\'\n        });\n      }\n    };\n\n    _this2.btnClick = function (e) {\n      _this2.setState(function (prevState, props) {\n        return { openFlg: !prevState.openFlg };\n      });\n      var handler = _this2.props.customHandler;\n      if (handler) {\n        handler({\n          eventType: \'btnClick\'\n        });\n      }\n    };\n\n    _this2.state = {\n      openFlg: true\n    };\n    return _this2;\n  }\n\n  _createClass(_class, [{\n    key: \'render\',\n    value: function render() {\n      var _this = this;\n      var data = this.props.customData || {};\n      var titles = data.titles || [];\n      var content = data.content || [];\n      var isOpen = data.isOpen || "";\n      return React.createElement(\n        \'div\',\n        { className: \'ysp-manager-audit-title-icon\' },\n        React.createElement(\n          \'span\',\n          null,\n          \'\\u76F8\\u5173\\u9644\\u4EF6\'\n        ),\n        React.createElement(\'i\', { className: \'arrow-right\', onClick: _this.btnClick.bind(_this) }),\n        content.length > 0 && isOpen == "" && _this.state.openFlg ? content.map(function (item, index) {\n          return React.createElement(\n            \'div\',\n            { className: \'ysp-sign-tab-upload\' },\n            React.createElement(\n              \'div\',\n              { className: \'content\' },\n              React.createElement(\n                \'span\',\n                null,\n                item[1]\n              ),\n              React.createElement(\n                \'span\',\n                { \'data-index\': index, onClick: _this.downLoadFile.bind(_this) },\n                \'\\u4E0B\\u8F7D\'\n              )\n            )\n          );\n        }) : ""\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;';
    },
    ...
    doAction_uiControl38_zSstZ6: function (data, elem) {
    ...
    getTemplate_uiControl38_zSstZ6: function () {
