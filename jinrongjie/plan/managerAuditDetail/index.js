(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control31_4TfX5x: function (elem) {},
    doAction_uiControl18_cr6ToC: function (data, elem) {
      var eventType = data.eventType;if (eventType == 'click') {
        alert(111);elem.click();
      }
    },
    getTemplate_uiControl18_cr6ToC: function () {
      var selfTemplate = 'import {\n  Component\n} from \'react\';\nexport default class extends Component {\n  constructor(props){\n    super(props);\n  }\n  \n  btnClick(e){//\u5BA2\u6237\u4FE1\u606F\u548C\u5BA2\u6237\u7ECF\u8425\u4FE1\u606F\u5207\u6362\n    let handler=this.props.customHandler;\n    var target=e.target;\n    if(handler){\n      handler({\n        eventType:"docClick"\n      })\n    }\n  }\n  \n  render(){\n    var _this = this;\n    return(<div onClick={_this.btnClick.bind(_this)}>\u6211\u662F\u76F8\u5173\u6D41\u7A0B\u9875\u9762</div>);\n  }\n}';
