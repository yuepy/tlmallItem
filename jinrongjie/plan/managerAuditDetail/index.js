(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl32_PTJzNp: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    return (\n      <div>\n        <span style={{'border-left':'4px solid #C19936', 'font-size':'14px', 'padding-left':'11px'}}>\u7B7E\u5B57\u610F\u89C1</span>\n        <div style={{'padding':'15px'}}><textarea></textarea></div>\n      </div>\n    )\n  }\n});";
      return "'use strict';\n\nmodule.exports = React.createClass({\n  displayName: 'exports',\n\n  render: function render() {\n    return React.createElement(\n      'div',\n      null,\n      React.createElement(\n        'span',\n        { style: { 'border-left': '4px solid #C19936', 'font-size': '14px', 'padding-left': '11px' } },\n        '\\u7B7E\\u5B57\\u610F\\u89C1'\n      ),\n      React.createElement(\n        'div',\n        { style: { 'padding': '15px' } },\n        React.createElement('textarea', null)\n      )\n    );\n  }\n});";
    },
    getData_control35_eTVGlA: function (elem) {},
    doAction_uiControl33_lqkOyA: function (data, elem) {},
    getTemplate_uiControl33_lqkOyA: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    return (\n      <div style={{'padding':'15px'}}>\n        <span style={{'display':'inline-block'}}>\u76F8\u5173\u6587\u6863  </span>\n        <span style={{'display':'inline-block', 'float':'right'}}>\uD83D\uDD0D</span>\n      </div>\n    )\n  }\n});";
      return "'use strict';\n\nmodule.exports = React.createClass({\n  displayName: 'exports',\n\n  render: function render() {\n    return React.createElement(\n      'div',\n      { style: { 'padding': '15px' } },\n      React.createElement(\n        'span',\n        { style: { 'display': 'inline-block' } },\n        '\\u76F8\\u5173\\u6587\\u6863  '\n      ),\n      React.createElement(\n        'span',\n        { style: { 'display': 'inline-block', 'float': 'right' } },\n        '\\uD83D\\uDD0D'\n      )\n    );\n  }\n});";
    },
    getData_control36_RkLeq2: function (elem) {},
    doAction_uiControl34_bTrP6U: function (data, elem) {},
    getTemplate_uiControl34_bTrP6U: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    return (\n      <div style={{'padding':'15px', 'border-bottom':'5px solid #ddd'}}>\n        <div style={{'display':'inline-block'}}>\u76F8\u5173\u6D41\u7A0B</div>\n        <div style={{'display':'inline-block','float':'right', }}>\uD83D\uDD0D</div>\n      </div>\n    )\n  }\n});";
      return "'use strict';\n\nmodule.exports = React.createClass({\n  displayName: 'exports',\n\n  render: function render() {\n    return React.createElement(\n      'div',\n      { style: { 'padding': '15px', 'border-bottom': '5px solid #ddd' } },\n      React.createElement(\n        'div',\n        { style: { 'display': 'inline-block' } },\n        '\\u76F8\\u5173\\u6D41\\u7A0B'\n      ),\n      React.createElement(\n        'div',\n        { style: { 'display': 'inline-block', 'float': 'right' } },\n        '\\uD83D\\uDD0D'\n      )\n    );\n  }\n});";
    },
