  ...
  ysp.runtime.Model.extendLoadingModel({
    getData_control289_R8b47y: function (elem) {
      ...
      if (data.eventType == 'zhengwen') {
        ...
        }var xmlhttp;xmlhttp = new XMLHttpRequest();var url = 'http://192.168.200.63/workflow/request/GetRequestSession.jsp?requestid=' + requestid + '&rand=' + rand;xmlhttp.open("POST", url);xmlhttp.onreadystatechange = function (data) {
