  ...
  ysp.runtime.Model.extendLoadingModel({
    getData_control289_R8b47y: function (elem) {
      ...
      if (data.eventType == 'deleteFile') {
        ...
        //debugger;
        var id = data.dataCustom.id;var val = data.dataCustom.value;var elem1 = $(elem).children("table").eq(0)[0];var tbody1 = $(elem).children("table").eq(0).children("tbody")[0];
