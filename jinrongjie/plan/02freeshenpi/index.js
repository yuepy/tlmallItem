(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control289_R8b47y: function (elem) {
      if (!elem) {
        return;
      }var data = { yes: [], header: { title: [], number: [] },
        base_lc_info: { title: [], content: [], degree: [], miji: { content: [], id: [] }, jjcd: [] }, base_info: { content: [] }, related_document: [], related_process: [], file: [] };if ($(elem).find('#SWFUpload_1').length > 0) {
        data.yes = 'yes';
      } else {
        data.yes = 'no';
      } //附件-----------
      ...
      if ($(elem).children(".bh").length > 0) {
        ...
        var tbody2 = $(elem).children("table").eq(1).children("tbody")[0];$(tbody2).children("tr").each(function () {
          //var arr1 = [];
      ...
      if (data.eventType == 'zhengwen') {
        ...
        var idx = data.dataCustom;debugger;var elem1 = $(elem).children("table").eq(1)[0];$(elem1).find('input').each(function () {
      ...
      if (data.eventType == 'selectFile') {
        ...
        }, 1000);var number = data.dataCustom.number;var type = data.dataCustom.type; //现在的文件名称
    ...
    doAction_uiControl277_n5afSQ: function (data, elem) {
      if (data.eventType == 'deleteFile') {
        ...
        setTimeout(function () {
          ysp.appMain.hideLoading;
        }, 1000);var fileIndex = data.dataCustom;var buttonList = elem.querySelectorAll('#selectDownload');var btnattr = buttonList[fileIndex].querySelector('button');var clickContent = btnattr.getAttribute('onclick');if (clickContent.indexOf('top.location') !== -1) {
