    ...
    ysp.runtime.Model.extendLoadingModel({
        ...
        getData_control253_CceTIQ: function(elem) {
            ...
            if (elem) {
                ...
                var egyArrInput = elem.querySelectorAll("tr")[1].querySelectorAll("td")[1].querySelectorAll("input");
                if (egyArrInput.length > 0) {
                ...
                var msgArrInput = elem.querySelectorAll("tr")[1].querySelectorAll("td")[3].querySelectorAll("input");
                for (var n = 0; n < msgArrInput.length; n++) {
        ...
        doAction_uiControl238_znz6Fh: function(data, elem) {
            if (data.eventType == "click") {
                ...
                var classname = data.dataCustom.classname;
                if (classname == "emergencyCheck") {
