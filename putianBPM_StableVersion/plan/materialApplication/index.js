(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control116_9Qr4Xp: function (elem) {
      ;if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl109_WZNT5v: function (data, elem) {
      ...
      if (data.eventType == 'click') {
        var d = data.dataCustom;var btn = elem.ownerDocument.querySelectorAll('.mini-tools-close')[1];if (d == '领取') {
          ...
          //     } else {
          if (_click) {
            var _icon = _click.querySelector('a');var _innerHTML = _click.querySelector('span').textContent;_innerHTML == '取消领取' && _icon.click();
    ...
    getTemplate_uiControl109_WZNT5v: function () {
    ...
    getData_control126_bMRHyl: function (elem) {
      ;if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl119_z7GBw9: function (data, elem) {
      if (data.eventType == 'click') {
    ...
    getTemplate_uiControl119_z7GBw9: function () {
    ...
    getData_control282_NiRlgc: function (elem) {
      ;if (!elem) {
        return;
      }if (elem) {
        var data = [];var table1 = elem.querySelectorAll("table");if (table1) {
          for (var j = 0; j < table1.length; j++) {
            var title = table1[j].querySelectorAll("td.form_label");for (var i = 0; i < title.length; i++) {
              var obj = { title: "", content: "" };obj.title = title[i].textContent.trim();if (obj.title.indexOf('附件') > -1) continue;if (title[i].nextElementSibling.querySelectorAll("input").length > 0 && title[i].nextElementSibling.querySelectorAll("textarea").length == 0) {
    ...
    doAction_uiControl276_JDcQA1: function (data, elem) {
      if (data.eventType == 'preview') {
        var url = data.dataCustom; // var xhr = new XMLHttpRequest();
    ...
    getTemplate_uiControl276_JDcQA1: function () {
      ...
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  preview: function preview(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'preview\',\n        data: target.textContent\n      });\n    }\n  },\n  render: function render() {\n    var _this = this;\n    var data = this.props.customData || [];\n    if (data && data.length > 0) {\n      return React.createElement(\n        "div",\n        { className: "ysp_hrDetailInfo", style: { marginTop: "10px" } },\n        React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo_title" },\n          "\\u57FA\\u7840\\u5C5E\\u6027"\n        ),\n        React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo_content" },\n          data && data.length > 0 && data.map(function (item, index) {\n            return React.createElement(\n              "div",\n              { className: "ysp_border" },\n              React.createElement(\n                "span",\n                { className: "ysp_title" },\n                item.title,\n                "\\uFF1A"\n              ),\n              React.createElement(\n                "label",\n                { className: "ysp_content" },\n                item.title.indexOf(\'\u76D2\u8D34\') > -1 && item.content !== \'\' ? React.createElement(\n                  AMUI.Button,\n                  { hollow: true, amStyle: "primary", amSize: "xs", onClick: _this.preview, className: "ysp-detail" },\n                  item.content\n                ) : item.title.indexOf(\'\u5305\u88C5\u56FE\') > -1 && item.content !== \'\' ? React.createElement(\n                  AMUI.Button,\n                  { hollow: true, amStyle: "primary", amSize: "xs", onClick: _this.preview, className: "ysp-detail" },\n                  item.content\n                ) : item.content\n              )\n            );\n          })\n        )\n      );\n    } else {\n      return React.createElement("div", null);\n    }\n  }\n});';
    },
    getData_control283_zATWOT: function (elem) {
      ;if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl277_BWZEMh: function (data, elem) {
      if (data.eventType == "blur") {
        elem.value = data.dataCustom;elem.dispatchEvent(new Event("change"));
      }
    },
    getTemplate_uiControl277_BWZEMh: function () {
    ...
    getData_control284_zLt3rx: function (elem) {
      ;if (!elem) {
        return;
    ...
    doAction_uiControl279_QZ26TR: function (data, elem) {
      if (data.eventType == 'click') {
    ...
    getTemplate_uiControl279_QZ26TR: function () {
    ...
    getData_control290_FpTiTQ: function (elem) {
      //loading 加载。
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl286_NQtxwX: function (data, elem) {
    ...
    getTemplate_uiControl286_NQtxwX: function () {
    ...
    getData_control292_LWQyQ2: function (elem) {
      ;if (!elem && elem.getAttribute('name') !== 'materialCode') {
        return;
      } // return elem.tagName
      if (elem && elem.getAttribute('name') == 'materialCode') {
        var input = elem;if (input) {
          return input.value;
        }
      }
    },
    doAction_uiControl288_8Q8Ec9: function (data, elem) {},
    getTemplate_uiControl288_8Q8Ec9: function () {
