  ...
  ysp.runtime.Model.extendLoadingModel({
      ...
      if (data.eventType == 'click') {
        var d = data.dataCustom;var btn = elem.ownerDocument.querySelectorAll('.mini-tools-close')[1];if (d == '领取') {
          ...
          var newRow = elem.contentDocument.querySelectorAll("iframe")[0].contentDocument.querySelectorAll(".mini-grid-rowstable")[1];var reg = /\s/;if (_click && reg.test(newRow.textContent)) {
            ...
            if (_click) {
              var _icon = _click.querySelector('a');var _innerHTML = _click.querySelector('span').textContent;_innerHTML == '取消领取' && _icon.click();var json = { time: new Date().getTime() };ysp.appMain.getActiveWindow().history.pushState(json, "", "http://192.168.220.51:8000/ptsoa/bps/wfclient/task/app/taskTabPage/pendingTask.jsp");
            } else {
              var _click = elem.contentWindow.document.querySelector('#td_0_2').querySelector("a");var _innerHTML = _click.querySelector('span').textContent;_click.click();var json = { time: new Date().getTime() };ysp.appMain.getActiveWindow().history.pushState(json, "", "http://192.168.220.51:8000/ptsoa/bps/wfclient/task/app/taskTabPage/pendingTask.jsp");
            }
          }
        } else {
          var _click = elem.contentWindow.document.querySelector('#td_0_2').querySelector("a");_click.click();var json = { time: new Date().getTime() };ysp.appMain.getActiveWindow().history.pushState(json, "", "http://192.168.220.51:8000/ptsoa/bps/wfclient/task/app/taskTabPage/pendingTask.jsp");
        }
        ...
        var btns = elem.contentDocument.querySelector("#btn");if (btns && btns.style.display != "none") {
          if (btns.querySelector("#recover") && btns.querySelector("#recover").textContent == "追回") {
            ...
            var json = { time: new Date().getTime() };var btn = elem.ownerDocument.querySelectorAll('.mini-tools-close')[1];if (btn) {
              btn.click();ysp.appMain.getActiveWindow().history.pushState(json, "", "http://192.168.220.51:8000/ptsoa/bps/wfclient/task/app/taskTabPage/pendingTask.jsp");
            }
          }
        } else {
          var json = { time: new Date().getTime() };var btn = elem.ownerDocument.querySelectorAll('.mini-tools-close')[1];if (btn) {
    ...
    getData_control123_vwIGHi: function (elem) {
      if (!elem) {
        ...
        var data = { topTitle: "", totalHoliday: "", holidayDetail: [], resonLeave: [], enclosure: [], table: [] };if (elem.querySelector(".mini-panel-header")) {
        ...
        }var holiday = elem.querySelectorAll("#holidayDetail");if (holiday && holiday.length > 0) {
          [].forEach.call(holiday, function (d, i) {
            var holidayArr = [];var oddTd = d.querySelectorAll(".form_label");[].forEach.call(oddTd, function (item, index) {
              var obj = {};obj.title = item.textContent.trim();obj.content = item.nextElementSibling.textContent.trim();holidayArr.push(obj);
            });data.holidayDetail.push(holidayArr);
          });
        } //请假原因
        var reasonsLeave = elem.querySelectorAll("#reasonsLeave");if (reasonsLeave && reasonsLeave.length > 0) {
          [].forEach.call(reasonsLeave, function (d, i) {
            data.resonLeave.push(d.textContent.trim());
          });
        } //附件信息
        var enclosure = elem.querySelectorAll("#enclosure");if (enclosure && enclosure.length > 0) {
          [].forEach.call(enclosure, function (d, i) {
            var enclosureArr = [];var tempArr = d.querySelectorAll("a");if (tempArr && tempArr.length > 0) {
        ...
        var table = elem.querySelectorAll(".mini-datagrid");if (table && table.length > 0) {
          [].forEach.call(table, function (dd, ii) {
            var head = dd.querySelectorAll(".mini-grid-headerCell");var tableObj = { columnTitle: [], content: [] };[].forEach.call(head, function (item, ind) {
              tableObj.columnTitle.push(item.textContent);
            });var rowTable = dd.querySelectorAll(".mini-grid-rowstable")[1];if (rowTable) {
    ...
    getTemplate_uiControl116_UnmeiG: function () {
      ...
      return '"use strict";\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require("react");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));\n  }\n\n  _createClass(_class, [{\n    key: "enclosure",\n    value: function enclosure(e) {\n      var target = e.target;\n      var handler = this.props.customHandler;\n      if (handler) {\n        handler({\n          data: [target.dataset.i, target.dataset.index],\n          eventType: "enclosure"\n        });\n      }\n    }\n  }, {\n    key: "render",\n    value: function render() {\n      var data = this.props.customData || [];\n      var _this = this;\n      var bord = data && data.holidayDetail && data.holidayDetail.length > 0 && data.holidayDetail.map(function (dd, ii) {\n        return React.createElement(\n          "div",\n          null,\n          React.createElement(\n            "div",\n            { className: "ysp_hrDetailInfo_content" },\n            dd.map(function (d, i) {\n              return React.createElement(\n                "div",\n                { className: "ysp_border" },\n                React.createElement(\n                  "span",\n                  { className: "ysp_title" },\n                  d.title\n                ),\n                React.createElement(\n                  "label",\n                  { className: "ysp_content" },\n                  d.content\n                )\n              );\n            }),\n            React.createElement(\n              "div",\n              { className: "ysp_border" },\n              React.createElement(\n                "span",\n                { className: "ysp_title" },\n                "\\u8BF7\\u5047\\u539F\\u56E0:"\n              ),\n              React.createElement(\n                "label",\n                { className: "ysp_content" },\n                data.resonLeave[ii]\n              )\n            ),\n            React.createElement(\n              "div",\n              { className: "ysp_border" },\n              React.createElement(\n                "span",\n                { className: "ysp_title" },\n                "\\u9644\\u4EF6\\u4FE1\\u606F:"\n              ),\n              data.enclosure && data.enclosure.length && data.enclosure[ii].map(function (d, i) {\n                return React.createElement(\n                  "div",\n                  { className: "ysp_hrDownload", onClick: _this.enclosure.bind(_this), "data-i": i, "data-index": ii },\n                  d\n                );\n              })\n            )\n          ),\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet" },\n            React.createElement(\n              "div",\n              { className: "ysp-flowsheet-twoPart" },\n              React.createElement(\n                "div",\n                null,\n                data.table[ii] && data.table[ii].content && data.table[ii].content.length > 0 && data.table[ii].content.map(function (d, i) {\n                  return React.createElement(\n                    "div",\n                    { className: "ysp-flowsheet-twoPart-card" },\n                    React.createElement(\n                      "p",\n                      { className: "ysp-twoPart-cardTit" },\n                      React.createElement(\n                        "span",\n                        null,\n                        React.createElement("b", null),\n                        i + 1\n                      )\n                    ),\n                    d.map(function (d3, i3) {\n                      return React.createElement(\n                        "div",\n                        null,\n                        React.createElement(\n                          "span",\n                          null,\n                          data.table[ii].columnTitle[i3],\n                          "\\uFF1A"\n                        ),\n                        React.createElement(\n                          "label",\n                          null,\n                          d3\n                        )\n                      );\n                    })\n                  );\n                })\n              )\n            )\n          )\n        );\n      });\n      if (data && data.topTitle && data.topTitle !== "") {\n        return React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo", style: { marginTop: "10px" } },\n          React.createElement(\n            "div",\n            { className: "ysp_hrDetailInfo_title" },\n            data.topTitle\n          ),\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet" },\n            React.createElement(\n              "div",\n              { className: "ysp-total" },\n              React.createElement(\n                "h1",\n                null,\n                " \\u603B\\u4F11\\u5047\\u5929\\u6570:"\n              ),\n              React.createElement(\n                "label",\n                { className: "ysp_content", style: { textAlign: \'center\', fontSize: \'15px\' } },\n                data && data.totalHoliday && data.totalHoliday[0]\n              )\n            )\n          ),\n          bord\n        );\n      } else {\n        return React.createElement("div", null);\n      }\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;';
    },
    ...
    getData_control155_SF9UmQ: function (elem) {
      if (!elem) {
        return;
      }if (elem) {
        var data = { topTitle: "", totalHoliday: "", holidayDetail: [], resonLeave: "", enclosure: [], table: { columnTitle: [], content: [] }, marryInfoDiv: [] };if (elem.querySelector(".mini-panel-header")) {
          data.topTitle = elem.querySelector(".mini-panel-header").textContent.trim();
        }if (elem.querySelector("#holidayDays")) {
          data.totalHoliday = elem.querySelector("#holidayDays").textContent.trim().match(/\d.*/g); //请假详情
        ...
        } /**********************************结婚情况******************************************/var marryInfoDiv = elem.ownerDocument.querySelector("#marryInfoDiv");if (marryInfoDiv) {
          var oddTd = marryInfoDiv.querySelectorAll(".form_label");[].forEach.call(oddTd, function (item, index) {
            var obj = {};obj.title = item.textContent.trim();obj.content = item.nextElementSibling.textContent.trim();data.marryInfoDiv.push(obj);
          });
        }return data;
      }
    },
    doAction_uiControl148_JqyqFc: function (data, elem) {
      if (data.eventType == "enclosure") {
        var i = data.dataCustom;var _btn = elem.querySelector("#enclosure").querySelectorAll("a")[i];var url = _btn.href;var _url = url.match(/putiantaili.*/); //elem.ownerDocument.defaultView.open("ftp://ftp." + _url[0]);
    ...
    getTemplate_uiControl148_JqyqFc: function () {
    ...
    getData_control150_3NoCQI: function (elem) {
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl143_km2a76: function (data, elem) {},
    getTemplate_uiControl143_km2a76: function () {
      ...
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData || "";\n    return React.createElement(\n      "div",\n      { className: "ysp_hrDetailInfo" },\n      React.createElement(\n        "div",\n        { className: "ysp_hrDetailInfo_content", style: { padding: \'0px 0.75rem\' } },\n        React.createElement(\n          "div",\n          { className: "ysp_border" },\n          React.createElement(\n            "span",\n            { className: "ysp_title" },\n            "\\u63D0\\u4EA4\\u65F6\\u95F4\\uFF1A"\n          ),\n          React.createElement(\n            "label",\n            { className: "ysp_content" },\n            data\n          )\n        )\n      )\n    );\n  }\n});';
    },
    getData_control167_P4Z2aq: function (elem) {
      //提示
      if (!elem) {
        return;
      }if (elem && elem.querySelector("#toast") && elem.querySelector("#toast").style.display != "none") {
    ...
    doAction_uiControl160_pMrqi7: function (data, elem) {},
    getTemplate_uiControl160_pMrqi7: function () {
