(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control279_sGHaKI: function (elem) {
      'use strict';
    ...
    doAction_uiControl275_ewUbG6: function (data, elem) {
      ...
      if (data.eventType == 'click') {
        var d = data.dataCustom;var btn = elem.ownerDocument.querySelectorAll('.mini-tools-close')[1];
        if (d == '领取') {
          ...
          if (_click) {
            ...
            var _click = elem.contentWindow.document.querySelector('#td_0_2').querySelector("a");var _innerHTML = _click.querySelector('span').textContent;_click.click();
    ...
    }, getTemplate_uiControl275_ewUbG6: function () {
    ...
    getData_control280_LSSZtl: function (elem) {
      'use strict';
    ...
    doAction_uiControl276_TKn050: function (data, elem) {
      'use strict';
    ...
    getTemplate_uiControl276_TKn050: function () {
    ...
    getData_control281_g5Jcwo: function (elem) {
      "use strict";
      ;if (!elem) {
        return;
      }if (elem) {
        var data = [];var table1 = elem.querySelector("table");if (table1) {
          var title = table1.querySelectorAll("td.form_label");for (var i = 0; i < title.length; i++) {
            debugger;var obj = { title: "", content: "" };obj.title = title[i].textContent.trim();if (title[i].nextElementSibling.querySelectorAll("input").length > 0 && title[i].nextElementSibling.querySelectorAll("textarea").length == 0) {
    ...
    doAction_uiControl277_5BGb1I: function (data, elem) {
      "use strict";
    },
    getTemplate_uiControl277_5BGb1I: function () {
    ...
    getData_control282_JqnKMl: function (elem) {
      "use strict";
    ...
    doAction_uiControl278_dMILvQ: function (data, elem) {
      "use strict";
    ...
    getTemplate_uiControl278_dMILvQ: function () {
    ...
    getData_control283_gTIMHc: function (elem) {
      "use strict";
    ...
    doAction_uiControl280_cTkF9O: function (data, elem) {
      'use strict';
    ...
    getTemplate_uiControl280_cTkF9O: function () {
