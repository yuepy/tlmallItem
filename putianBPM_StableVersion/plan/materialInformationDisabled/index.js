(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control285_D72UNs: function (elem) {
      ;if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl280_ZBvNG4: function (data, elem) {
    ...
    getTemplate_uiControl280_ZBvNG4: function () {
    ...
    getData_control286_a8gb9L: function (elem) {
      ;if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl281_aAbeQw: function (data, elem) {
      if (data.eventType == 'click') {
    ...
    getTemplate_uiControl281_aAbeQw: function () {
    ...
    getData_control287_3VRixX: function (elem) {
      ;if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl282_PbeOS7: function (data, elem) {},
    getTemplate_uiControl282_PbeOS7: function () {
    ...
    getData_control288_INa0lK: function (elem) {
      ;if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl283_z68FLt: function (data, elem) {
      if (data.eventType == "blur") {
        elem.value = data.dataCustom;elem.dispatchEvent(new Event("change"));
      }
    },
    getTemplate_uiControl283_z68FLt: function () {
    ...
    getData_control289_10R11K: function (elem) {
      ;if (!elem) {
        return;
    ...
    doAction_uiControl285_AyaTDy: function (data, elem) {
      if (data.eventType == 'click') {
    ...
    getTemplate_uiControl285_AyaTDy: function () {
    ...
    getData_control291_hWUqoW: function (elem) {
      //loading 加载。
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl287_W5VqFE: function (data, elem) {
    ...
    getTemplate_uiControl287_W5VqFE: function () {
