(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control154_UqN5eJ: function (elem) {
      ...
      var data = { base: { bigtit: "", tit: [], con: [] }, tableTit: "", tablehead: [], table: [], total: { num: [], con: [] }, reason: [], annex: [], surggest: [], errorTip: {} }; //基础信息
      var baseBigtit = elem.querySelectorAll(".mini-panel")[0].querySelector(".mini-panel-title");data.base.bigtit = baseBigtit.textContent;var basefil = elem.querySelectorAll(".mini-panel")[0].querySelector("table").querySelectorAll("tr");if (basefil[0].style.display == "none") {
        var basetit = elem.querySelectorAll(".mini-panel")[0].querySelector("table").querySelectorAll("tr:nth-child(n+2)");
      } else {
        var basetit = elem.querySelectorAll(".mini-panel")[0].querySelector("table").querySelectorAll("tr");
      ...
      if (elem.querySelectorAll(".mini-panel")[1].querySelector(".mini-panel-header").style.display !== "none") {
        data.tableTit = elem.querySelectorAll(".mini-panel")[1].querySelector(".mini-panel-header").textContent;
      }var thead = elem.querySelectorAll(".mini-panel")[1].querySelector(".mini-grid-columns-view").querySelector("tbody tr:nth-child(2)").querySelectorAll("td");[].map.call(thead, function (item, index) {
        data.tablehead.push(item.textContent);
      });if (elem.querySelector("#apply")) {
        data.tablehead.shift();data.tablehead.shift();
      } else {
        data.tablehead.shift();
      }var tbody = elem.querySelectorAll(".mini-panel")[1].querySelector(".mini-panel-body").querySelector(".mini-grid-rows-view").querySelectorAll("tbody tr");[].map.call(tbody, function (item, index) {
        if (index != 0) {
          var td = item.querySelectorAll("td");var tr = [];[].map.call(td, function (d, i) {
      ...
      var totalTd = elem.querySelectorAll(".mini-panel")[1].querySelector(".mini-grid-summaryRow").querySelector(".mini-grid-summaryRow-view").querySelector("tbody tr:nth-child(2)").querySelectorAll("td");[].map.call(totalTd, function (item, index) {
        if (item.textContent.trim() != "") {
          data.total.con.push(item.textContent.trim());if (elem.querySelector("#apply")) {
            data.total.num.push(index);
          } else {
            data.total.num.push(index + 1);
          }
        }
      });data.total.con.shift();data.total.num.shift(); //附件信息
      var ann = elem.querySelector("#file").querySelectorAll("a");if (ann) {
    ...
    doAction_uiControl145_w0WV0T: function (data, elem) {
      if (data.eventType == 'change') {
        ...
        debugger;var i = data.dataCustom;var _btn = elem.querySelectorAll(".mini-panel")[3].querySelectorAll("tbody tr td a")[i];var url = _btn.href;var num = url.lastIndexOf(".");var type = url.slice(num);var string = encodeURIComponent(_btn.textContent.trim());if (ysp.appMain.isIOS()) {
    ...
    getData_control273_O9Q47p: function (elem) {
      //loading 加载。
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl267_55bzgF: function (data, elem) {
    ...
    getTemplate_uiControl267_55bzgF: function () {
