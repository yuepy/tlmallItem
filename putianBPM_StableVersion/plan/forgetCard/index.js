  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl92_MEbWbI: function (data, elem) {
      if (data.eventType == 'click') {
        ...
        var btn = elem.ownerDocument.querySelectorAll('.mini-tools-close')[1];if (d == '领取') {
    ...
    getData_control194_ImrJ4A: function (elem) {
      //loading 加载。
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl187_7olbLG: function (data, elem) {
    ...
    getTemplate_uiControl187_7olbLG: function () {
