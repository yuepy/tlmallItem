(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control255_xHMsgk: function (elem) {
      if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl248_EebPvq: function (data, elem) {
    ...
    getTemplate_uiControl248_EebPvq: function () {
    ...
    getData_control256_bKtrsh: function (elem) {
      if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl249_4f9h53: function (data, elem) {
      if (data.eventType == 'click') {
    ...
    getTemplate_uiControl249_4f9h53: function () {
    ...
    getData_control257_M9tcFi: function (elem) {
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl250_ULaJHL: function (data, elem) {},
    getTemplate_uiControl250_ULaJHL: function () {
    ...
    getData_control258_z7gE8E: function (elem) {
      if (!elem) {
        return;
      };if (elem) {
    ...
    doAction_uiControl252_HcZ7BB: function (data, elem) {},
    getTemplate_uiControl252_HcZ7BB: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data=this.props.customData||[];\n    return (\n      <div>\n      \t{\n          data&&data.bigTit&&data.bigTit=="\u8C03\u52A8\u524D\u85AA\u916C/\u804C\u52A1\u4FE1\u606F"? \n            <div className="ysp_hrDetailInfo">\n              <div className="ysp_hrDetailInfo_title">{data.bigTit}</div>\n              <div className="ysp_hrDetailInfo_content">\n              {data.table.map(function(item,index){\n                return(\n                  <div className="ysp_border">\n                    <span className="ysp_title">{item.title}\uFF1A</span>\n                    <label className="ysp_content">{item.content}</label>\n                  </div>\n                )\n              })}  \n              </div>\n            </div>:<div></div>\n        }\n      </div>\n      \n    )\n  }\n});\n\n\n';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData || [];\n    return React.createElement(\n      "div",\n      null,\n      data && data.bigTit && data.bigTit == "\u8C03\u52A8\u524D\u85AA\u916C/\u804C\u52A1\u4FE1\u606F" ? React.createElement(\n        "div",\n        { className: "ysp_hrDetailInfo" },\n        React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo_title" },\n          data.bigTit\n        ),\n        React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo_content" },\n          data.table.map(function (item, index) {\n            return React.createElement(\n              "div",\n              { className: "ysp_border" },\n              React.createElement(\n                "span",\n                { className: "ysp_title" },\n                item.title,\n                "\\uFF1A"\n              ),\n              React.createElement(\n                "label",\n                { className: "ysp_content" },\n                item.content\n              )\n            );\n          })\n        )\n      ) : React.createElement("div", null)\n    );\n  }\n});';
    },
    getData_control260_9mZmHr: function (elem) {
      if (!elem) {
        return;
      };if (elem) {
        var data = { bigTit: "", table: [] };data.bigTit = elem.querySelector(".mini-panel-header").textContent;var title = elem.querySelectorAll("td.form_label");for (var i = 0; i < title.length; i++) {
    ...
    doAction_uiControl253_yxixlL: function (data, elem) {},
    getTemplate_uiControl253_yxixlL: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data=this.props.customData||[];\n    return (\n      <div>\n      \t{\n          data&&data.bigTit&&data.bigTit=="\u8C03\u52A8\u540E\u85AA\u916C/\u804C\u52A1\u4FE1\u606F"? \n            <div className="ysp_hrDetailInfo">\n              <div className="ysp_hrDetailInfo_title">{data.bigTit}</div>\n              <div className="ysp_hrDetailInfo_content">\n              {data.table.map(function(item,index){\n                return(\n                  <div className="ysp_border">\n                    <span className="ysp_title">{item.title}\uFF1A</span>\n                    <label className="ysp_content">{item.content}</label>\n                  </div>\n                )\n              })}  \n              </div>\n            </div>:<div></div>\n        }\n      </div>\n      \n    )\n  }\n});\n\n\n';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData || [];\n    return React.createElement(\n      "div",\n      null,\n      data && data.bigTit && data.bigTit == "\u8C03\u52A8\u540E\u85AA\u916C/\u804C\u52A1\u4FE1\u606F" ? React.createElement(\n        "div",\n        { className: "ysp_hrDetailInfo" },\n        React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo_title" },\n          data.bigTit\n        ),\n        React.createElement(\n          "div",\n          { className: "ysp_hrDetailInfo_content" },\n          data.table.map(function (item, index) {\n            return React.createElement(\n              "div",\n              { className: "ysp_border" },\n              React.createElement(\n                "span",\n                { className: "ysp_title" },\n                item.title,\n                "\\uFF1A"\n              ),\n              React.createElement(\n                "label",\n                { className: "ysp_content" },\n                item.content\n              )\n            );\n          })\n        )\n      ) : React.createElement("div", null)\n    );\n  }\n});';
    },
    getData_control261_nQ4EaA: function (elem) {
      if (!elem) {
        return;
      }if (elem) {
    ...
    doAction_uiControl254_lEZPMS: function (data, elem) {
      if (data.eventType == "blur") {
        elem.value = data.dataCustom;elem.dispatchEvent(new Event("change"));
      }
    },
    getTemplate_uiControl254_lEZPMS: function () {
    ...
    getData_control262_z7ETPV: function (elem) {
      //提示
      if (!elem) {
        return;
    ...
    doAction_uiControl255_vyTOcw: function (data, elem) {},
    getTemplate_uiControl255_vyTOcw: function () {
    ...
    getData_control263_Ghhz6y: function (elem) {
      if (!elem) {
        return;
      } // if (elem && elem.querySelector("#toast") && elem.querySelector("#toast").style.display != "none") {
      //   return elem.querySelector("#toast").textContent;
    ...
    doAction_uiControl256_pi2USF: function (data, elem) {
      if (data.eventType == 'click') {
    ...
    getTemplate_uiControl256_pi2USF: function () {
    ...
    getData_control264_HslZbJ: function (elem) {
      if (!elem) {
        return;
      }if (elem) {
        var data = { bigTit: "", table: [] };data.bigTit = elem.querySelector(".mini-panel-header").textContent;var enclosure = elem.querySelectorAll("a");if (enclosure && enclosure.length > 0) {
          [].forEach.call(enclosure, function (d, i) {
            data.table.push(d.textContent);
          });
        }return data;
      }
    },
    doAction_uiControl257_rNqKIm: function (data, elem) {
    ...
    doAction_uiControl274_P5c1Qs: function (data, elem) {
    ...
    getTemplate_uiControl274_P5c1Qs: function () {
