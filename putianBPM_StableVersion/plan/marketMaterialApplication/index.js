(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control268_aGzvg1: function (elem) {
      'use strict';
      ;if (!elem) {
        return [];
      }if (elem) {
    ...
    doAction_uiControl262_c5O7AP: function (data, elem) {
    ...
    getTemplate_uiControl262_c5O7AP: function () {
    ...
    getData_control269_d0rbJR: function (elem) {
      'use strict';
    ...
    doAction_uiControl263_sWiSsG: function (data, elem) {
      'use strict';
    ...
    getTemplate_uiControl263_sWiSsG: function () {
    ...
    getData_control270_gPT4zm: function (elem) {
      "use strict";
      ...
      if (elem) {
        var input = elem.querySelector("input[name='materialCode']");if (input) {
          return input.value;
        }
      }
    },
    doAction_uiControl264_ZPNElP: function (data, elem) {
      "use strict";
    },
    getTemplate_uiControl264_ZPNElP: function () {
    ...
    getData_control271_9DZsSK: function (elem) {
      "use strict";
    ...
    doAction_uiControl265_gRi6R9: function (data, elem) {
      'use strict';

      if (data.eventType == 'preview') {
        debugger;var url = data.dataCustom;var xhr = new XMLHttpRequest();xhr.open('GET', url, false);xhr.onreadystatechange = function () {
          if (xhr.status == 200 && xhr.readyState == 4) {
            alert('请求成功！');var resText = xhr.getAllResponseHeaders(); //获取请求头
            ...
            alert('http://192.168.220.1:31080/pttlmp-file/unauth/file/getFileById/842566-1551862908771' + '.png' + '?_ysp_filepreview=1');if (ysp.appMain.isIOS()) {
            ...
            alert('请求失败！');elem.ownerDocument.defaultView.open(url, '404 - found');
          }
        };xhr.send();
      }
    },
    getTemplate_uiControl265_gRi6R9: function () {
    ...
    getData_control272_KKrtQV: function (elem) {
      "use strict";
    ...
    doAction_uiControl266_P6wCet: function (data, elem) {
      "use strict";
    ...
    getTemplate_uiControl266_P6wCet: function () {
    ...
    getData_control273_lQUl5H: function (elem) {
      "use strict";
    ...
    doAction_uiControl268_lTXXWI: function (data, elem) {
      'use strict';
    ...
    getTemplate_uiControl268_lTXXWI: function () {
