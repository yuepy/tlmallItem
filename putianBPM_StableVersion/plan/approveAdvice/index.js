  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control52_ASAZ2n: function (elem) {
      if (!elem) {
        ...
        var elem = $($(elem).children("div:not([style*='none'])").children("iframe"))[0];var data = { onePartTitle: [], onePartCont: [], twoPartTitle: [], twoPartCont: [] };var signOne = elem && elem.contentWindow && elem.contentWindow.document.querySelectorAll('#datagrid1');if (signOne && signOne.length > 0) {
          var signTwo = elem.contentWindow.document.querySelectorAll('#datagrid1 .mini-grid-columns	.mini-grid-columns-view	.mini-grid-table');if (signTwo && signTwo.length > 0) {
            ...
            var sheep = elem.contentWindow.document.querySelectorAll('#datagrid1	.mini-panel-body .mini-grid-rows-view .mini-grid-table .mini-grid-row');if (typeof sheep != 'undefined' && sheep && sheep.length > 0) {
          ...
          }var _PagesMessage = elem.contentWindow.document.querySelector('.mini-pager-right') && elem.contentWindow.document.querySelector('.mini-pager-right').textContent;data.PagesMessage = _PagesMessage;var _PageNumber = elem.contentWindow.document.querySelector('.mini-pager-num') && elem.contentWindow.document.querySelector('.mini-pager-num').value;data.PageNumber = _PageNumber;var _PageCount = elem.contentWindow.document.querySelector('.mini-pager-pages') && elem.contentWindow.document.querySelector('.mini-pager-pages').textContent;data.PageCount = _PageCount;
        }return data;
      }
    },
