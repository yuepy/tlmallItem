(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control120_G7MVnc: function (elem) {
      ...
      }); /* 申请信息*/var applicatetit = elem.querySelectorAll(".mini-panel")[3].querySelectorAll(".mini-panel-body .nui-form-table tr");[].map.call(applicatetit, function (item, index) {
        var a = item.querySelectorAll("td.form_label");[].map.call(a, function (d, i) {
          data.applicate.tit.push(d.textContent);
        });
      });var applicatetr1 = elem.querySelectorAll(".mini-panel")[3].querySelector(".mini-panel-body .nui-form-table tr:first-child").querySelectorAll("td:nth-child(2n)");[].map.call(applicatetr1, function (item, index) {
        var a = item.querySelector("input");if (a) {
          data.applicate.con.push(a.value);
        }
      });var applicatetr2 = elem.querySelectorAll(".mini-panel")[3].querySelector(".mini-panel-body .nui-form-table tr:nth-child(2)").querySelectorAll("td:nth-child(2n)");[].map.call(applicatetr2, function (item, index) {
        var a = item.querySelector("input");data.applicate.con.push(a.value);
      });var applicatetr3 = elem.querySelectorAll(".mini-panel")[3].querySelector(".mini-panel-body .nui-form-table tr:nth-child(3)").querySelectorAll("td:nth-child(2n)");[].map.call(applicatetr3, function (item, index) {
        var a = item.querySelector("input");data.applicate.con.push(a.value);
      });if (elem.querySelector("[id='scopeComStart$text']") && elem.querySelector("[id='scopeComEnd$text']")) {
        var applicatetr4 = elem.querySelector("[id='scopeComStart$text']").value + "~" + elem.querySelector("[id='scopeComEnd$text']").value;
      }data.applicate.con.push(applicatetr4);if (elem.querySelector("[id='actScopeComstart$text']") && elem.querySelector("[id='actScopeComend$text']")) {
        var applicatetr5 = elem.querySelector("[id='actScopeComstart$text']").value + "~" + elem.querySelector("[id='actScopeComend$text']").value;
      }data.applicate.con.push(applicatetr5); // var applicatetr3 = elem.querySelectorAll(".mini-panel")[2].querySelector(".mini-panel-body .nui-form-table tr:nth-child(3)").querySelector("td:nth-child(2n)");
      ...
      /*离职原因*/if (elem.querySelector("[id='consultReason$text']")) {
        data.leaveReason.cancelReason = elem.querySelector("[id='consultReason$text']").value;
      }data.leaveReason.tips = elem.querySelectorAll(".mini-panel")[2].querySelector(".mini-panel-body .nui-form-table tr:nth-child(2)").textContent.trim();if (elem.querySelector("[id='reasonExplain$text']")) {
        data.leaveReason.reason = elem.querySelector("[id='reasonExplain$text']").value; /*审批意见*/
      }var sugg = elem.querySelector("#approval .nui-form-table tbody tr td:nth-child(2)");if (sugg && sugg.querySelector("textarea")) {
