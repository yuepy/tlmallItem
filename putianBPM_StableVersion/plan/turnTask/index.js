  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl128_etQXUR: function (data, elem) {
      if (data.eventType == 'change') {
        var data = data.dataCustom;elem.querySelectorAll(".mini-panel")[4].querySelector("tbody tr td textarea").value = data;elem.querySelectorAll(".mini-panel")[4].querySelector("tbody tr td textarea").dispatchEvent(new Event('change'));
    ...
    doAction_uiControl273_KxxcUC: function (data, elem) {
    ...
    getTemplate_uiControl273_KxxcUC: function () {
