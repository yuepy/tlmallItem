(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control64_OUgNmD: function (elem) {
      //loading 加载。
      if (!elem) {
        return;
      }
    ...
    doAction_uiControl59_SdAfFA: function (data, elem) {},
    getTemplate_uiControl59_SdAfFA: function () {
