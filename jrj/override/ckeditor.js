...
(function() {
    ...
    e.extend(d.node.prototype, {
        ...
        getAscendant: function(h, i) {
            ...
            if (!i)
                j = j.parentNode;
            while (j) {
                if (j.nodeName && (k = j.nodeName.toLowerCase(),
                typeof h == 'string' ? k == h : k in h))
                    return new d.node(j);
                j = j.parentNode;
            }
            return null ;
    ...
    e.extend(h.prototype, {
        ...
        isIdentical: function(i) {
            ...
            for (var n = 0; n < l; n++) {
                ...
                if (o.nodeName == '_moz_dirty')
                    continue;if ((!c || o.specified && o.nodeName != 'data-cke-expando') && o.nodeValue != i.getAttribute(o.nodeName))
                    return false;
            }
            if (c)
                for (n = 0; n < m; n++) {
        ...
        isEmptyInlineRemoveable: function() {
            ...
            for (var j = 0, k = i.count(); j < k; j++) {
                ...
                if (l.type == 1 && l.data('cke-bookmark'))
                    continue;if (l.type == 1 && !l.isEmptyInlineRemoveable() || l.type == 3 && e.trim(l.getText()))
                    return false;
            }
            return true;
        },
        ...
        copyAttributes: function(i, j) {
            ...
            for (var l = 0; l < k.length; l++) {
                ...
                if (n in j)
                    continue;if (n == 'checked' && (o = p.getAttribute(n)))
                    i.setAttribute(n, o);
    ...
    (function() {
        ...
        h.prototype.getBogus = function() {
            ...
            while (r(s));if (s && (!c ? s.is && s.is('br') : s.getText && o.test(s.getText())))
                return s;
            return false;
        }
        ;
            ...
            function q(t, u, v) {
                ...
                m.ui.add(t, 'panelbutton', {
                    ...
                    onOpen: function() {
                        ...
                        while (u == 'back' && A == 'transparent' && y && (y = y.getParent()));if (!A || A == 'transparent')
                            A = '#ffffff';
        ...
        ;function r(v, w, x, y) {
            ...
            for (var B in y) {
                ...
                if (z.type == 'hbox' || z.type == 'vbox')
                    r(v, w, x, z.children);
                if (!z.filebrowser)
                    continue;if (typeof z.filebrowser == 'string') {
                    var C = {
    ...
    a.unlinkCommand.prototype = {
        exec: function(m) {
            ...
            for (var s = 0; s < p.length; s++) {
                ...
                if (!r)
                    continue;p[s].selectNodeContents(r);
            }
            n.selectRanges(p);
    ...
    (function() {
        ...
        ;function y(G) {
            ...
            if (H) {
                for (var I = 0, J = G.getChildren(), K; K = J.getItem(I),
                I < J.count(); I++) {
    ...
    (function() {
        ...
        k.dialog.uiElement.prototype = {
            ...
            registerEvents: function(S) {
                ...
                for (var W in S) {
                    if (!(U = W.match(T)))
                        continue;if (this.eventProcessors[W])
            ...
            checkElementRemovable: function(T, U) {
                ...
                if (typeof ae.element == 'string' ? X == ae.element : X in ae.element) {
                    ...
                    if (W._length) {
                        for (var Y in W) {
                            if (Y == '_length')
                                continue;var Z = T.getAttribute(Y) || '';
                    ...
                    if (!al || ab[al] && !an && (!am || aa) && (af.getPosition(ae) | 4 | 0 | 8) == 4 + 0 + 8 && (!X.childRule || X.childRule(af))) {
                        ...
                        if (ao && ((ao.getDtd() || f.span)[W] || Y) && (!X.parentRule || X.parentRule(ao))) {
                            ...
                            if (ak == 3 || am || ak == 1 && !af.getChildCount()) {
                                var ap = af, aq;
                                while ((aj = !ap.getNext(q)) && (aq = ap.getParent(),
                                ab[aq.getName()]) && (aq.getPosition(ad) | 2 | 0 | 8) == 2 + 0 + 8 && (!X.childRule || X.childRule(aq)))
                                    ap = aq;
                                ag.setEndAfter(ap);
                            }
                        } else
                        ...
                        if (at.getName() == W) {
                            for (av in X.attributes) {
                                if (au.blockedAttrs[av] || !(ax = at.getAttribute(aw)))
                                    continue;if (ar.getAttribute(av) == ax)
                                    au.attrs[av] = 1;
                                else
                    ...
                    if (z) {
                        ...
                        for (var C = 0; C < B.length; C++) {
                            ...
                            if (E.isReadOnly())
                                B.splice(C, 1);
                            if (D.collapsed)
                                continue;if (D.startContainer.isReadOnly()) {
    ...
    (function() {
        ...
        k.dialog.file.prototype = e.extend(new k.dialog.labeledElement(), q, {
            ...
            registerEvents: function(u) {
                ...
                for (var y in u) {
                    if (!(w = y.match(v)))
                        continue;if (this.eventProcessors[y])
