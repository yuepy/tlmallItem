  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl0: function (data, elem) {
      if (data.eventType === 'submit') {
        ...
        var url = 'http://192.168.0.200:8080/ptsoa/servlet/LogoutServlet.cmd';
        ...
        XHR.onload = function (event) {
          if (XHR.status === 200) {
            ...
            if (response === ' ') {
              ...
              elem.ownerDocument.defaultView.location.href = 'http://192.168.0.200:8080/ptsoa/theme/FixCS/loginform.html';
            }
          } else {
            console.log('fail');
          }
