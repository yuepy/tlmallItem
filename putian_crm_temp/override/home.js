...
if(wrapper){
  ...
  if(href && href.indexOf('configType') != -1){
    ...
    */
    ...
    var header_text = document.createTextNode('销量与销售额');
    //将标题文本挂到span中
    ...
    //创建6个div，3个一组分别挂在content_row_*上
    //本日销量
    ...
    var span_text = document.createTextNode('本日销量(万)');
    ...
    var span_text = document.createTextNode('本月销量(万)');
    ...
    var span_text = document.createTextNode('本年销量(万)');
    span2.appendChild(span_text);
    div2.appendChild(h22);
    div2.appendChild(span2);
    //本日销售额
    var div3 = document.createElement('div');
    div3.className = 'content-item';
    var h23 = document.createElement('h2');
    h23.id = 'todayAmt';
    var span3 = document.createElement('span');
    var span_text = document.createTextNode('本日销售额(万)');
    span3.appendChild(span_text);
    div3.appendChild(h23);
    div3.appendChild(span3);
    //本月销售额
    var div4 = document.createElement('div');
    div4.className = 'content-item';
    var h24 = document.createElement('h2');
    h24.id = 'monthAmt';
    var span4 = document.createElement('span');
    var span_text = document.createTextNode('本月销售额(万)');
    span4.appendChild(span_text);
    div4.appendChild(h24);
    div4.appendChild(span4);
    //本年销售额
    var div5 = document.createElement('div');
    div5.className = 'content-item';
    var h25 = document.createElement('h2');
    h25.id = 'yearAmt';
    var span5 = document.createElement('span');
    var span_text = document.createTextNode('本年销售额(万)');
    span5.appendChild(span_text);
    ...
    content_row_1.appendChild(div3);
    content_row_1.appendChild(div4);
    content_row_1.appendChild(div5);
    ...
    var header_client_text = document.createTextNode('销量与销售额');
    //将标题文本挂到span中
    ...
    var content_client_row_1 = document.createElement('div');
    content_client.appendChild(content_client_row_0);
    content_client.appendChild(content_client_row_1);
    //创建6个div，3个一组分别挂在content_client_row_*上
    //总拜访客户
    var div0_client = document.createElement('div');
    div0_client.className = 'content-item';
    var h20_client = document.createElement('h2');
    h20_client.id = 'clientCount';
    var span0_client = document.createElement('span');
    var span_client_text = document.createTextNode('总拜访客户');
    ...
    h21_client.id = 'vistClientCount';
    var span1_client = document.createElement('span');
    var span_client_text = document.createTextNode('总拜访客户次数');
    ...
    h22_client.id = 'storeCount';
    var span2_client = document.createElement('span');
    var span_client_text = document.createTextNode('总拜访门店');
    ...
    div3_client.className = 'content-item';
    var h23_client = document.createElement('h2');
    h23_client.id = 'vistStoreCount';
    var span3_client = document.createElement('span');
    var span_client_text = document.createTextNode('总拜访门店次数');
    span3_client.appendChild(span_client_text);
    div3_client.appendChild(h23_client);
    div3_client.appendChild(span3_client);
    //业务人员
    var div4_client = document.createElement('div');
    div4_client.className = 'content-item';
    var h24_client = document.createElement('h2');
    h24_client.id = 'saleManCount';
    var span4_client = document.createElement('span');
    var span_client_text = document.createTextNode('业务人员');
    span4_client.appendChild(span_client_text);
    div4_client.appendChild(h24_client);
    div4_client.appendChild(span4_client);
    ...
    content_client_row_1.appendChild(div3_client);
    content_client_row_1.appendChild(div4_client);
