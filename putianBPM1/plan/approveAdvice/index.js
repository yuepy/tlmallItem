    ...
    ysp.runtime.Model.extendLoadingModel({
        ...
        getData_control52_ASAZ2n: function(elem) {
            ...
            if (elem && $(elem).children("div:not([style*='none'])") && $(elem).children("div:not([style*='none'])").children("iframe")) {
                var elem = $($(elem).children("div:not([style*='none'])").children("iframe"))[0];
                var data = { onePartTitle: [], onePartCont: [], twoPartTitle: [], twoPartCont: [] };
                var signOne = elem.contentWindow && elem.contentWindow.document.querySelectorAll('#datagrid1');
                if (signOne && signOne.length > 0) {
                    var signTwo = elem.contentWindow.document.querySelectorAll('#datagrid1 .mini-grid-columns	.mini-grid-columns-view	.mini-grid-table');
                    if (signTwo && signTwo.length > 0) {
                        var sheep = elem.contentWindow.document.querySelectorAll('#datagrid1 .mini-grid-columns	.mini-grid-columns-view	.mini-grid-table	tr')[1].querySelectorAll('td');
                    ...
                    var signThree = elem.contentWindow.document.querySelectorAll('#datagrid1 .mini-panel-body .mini-grid-rows-view .mini-grid-table');
                    if (signThree && signThree.length > 0) {
                        var sheep = elem.contentWindow.document.querySelectorAll('.mini-panel-viewport	.mini-panel-body .mini-grid-rows-view .mini-grid-table .mini-grid-row');
                        if (sheep && sheep.length > 0) {
                            for (var i = 0; i < sheep.length; i++) {
                                var birth = sheep[i].children;
                                var arry = [];
