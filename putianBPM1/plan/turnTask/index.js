(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control95_h1V7Wk: function (elem) {
      if (!elem) {
        return;
      }console.log(elem);const data = { processTit: [], base: { tit: [], con: [] }, turn: { tit: [], con: [] }, remark: {}, surggest: [], errorTip: {} }; //各项title
      ...
      const turntit = elem.querySelectorAll(".table")[1].querySelectorAll("tbody tr");
