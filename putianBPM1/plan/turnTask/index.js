(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control95_h1V7Wk: function (elem) {
      if (!elem) {
        return;
      }const data = { processTit: [], base: { tit: [], con: [] }, turn: { tit: [], con: [] }, remark: {}, annex: [], surggest: [], errorTip: {} }; //各项title
      ...
      const mark = elem.querySelectorAll(".table")[2].querySelector("tbody tr td textarea");data.remark = mark.value; //附件信息
      ...
      const surgg = elem.querySelectorAll(".table")[4].querySelector("tbody tr td textarea");data.surggest.push(surgg.placeholder);data.surggest.push(surgg.value); //判断审批意见文本框是否可写
      const surggspan = elem.querySelectorAll(".table")[4].querySelector("tbody tr td .mini-textbox-readOnly");if (surggspan) {
