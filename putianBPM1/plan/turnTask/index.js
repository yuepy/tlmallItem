(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control95_h1V7Wk: function (elem) {
      ...
      //   data.errorTip.push(true);
      // } else {
      //   data.errorTip.push(false);
      // }
      // ;
      return data;
    },
    ...
    getData_control100_uqm5Ry: function (elem) {
      ...
      if (!elem) {
        return;
      }console.log(elem);if (elem && elem.querySelector("#toast") && elem.querySelector("#toast").style.display != "none") {
        return elem.querySelector("#toast").textContent;
      }
    },
