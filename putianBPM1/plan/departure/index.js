(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control124_4JK5eW: function (elem) {
      if (!elem) {
        return;
      }const data = { processTit: [], base: { tit: [], con: [] }, contract: { tit: [], con: [] }, appli: { tip: "", tit: [], con: [] }, surggest: "", errorTip: {} }; //各项title
      ...
      const basetit = elem.querySelectorAll(".mini-panel .nui-form-table")[0].querySelectorAll("tbody tr");[].map.call(basetit, function (item, index) {
      ...
      const contracttit = elem.querySelectorAll(".mini-panel .nui-form-table")[1].querySelector("tbody tr");const ctit = contracttit.querySelectorAll(".form_label");const ccon = contracttit.querySelectorAll("td:nth-child(2n)");[].map.call(ctit, function (d, i) {
        data.contract.tit.push(d.textContent);
      });[].map.call(ccon, function (m, n) {
        data.contract.con.push(m.querySelector("input").value);
      }); //申请信息
      const applitip = elem.querySelectorAll(".mini-panel .mini-panel-body")[2].querySelector("span:first-child");data.appli.tip = applitip.innerHTML;const applitit = elem.querySelectorAll(".mini-panel .nui-form-table")[2].querySelectorAll("tbody tr");[].map.call(applitit, function (d, i) {
        const a = d.querySelectorAll("td:nth-child(2n+1)");[].map.call(a, function (item, index) {
          data.appli.tit.push(item.textContent);
        });
      });const applicon1 = elem.querySelectorAll(".mini-panel .nui-form-table")[2].querySelector("tbody tr:first-child").querySelector("td:nth-child(2)").querySelector("input");data.appli.con.push(applicon1.value);const applicon2 = elem.querySelectorAll(".mini-panel .nui-form-table")[2].querySelector("tbody tr:first-child").querySelector("td:nth-child(4)").querySelector("textarea");data.appli.con.push(applicon2.value);const applicon3 = elem.querySelectorAll(".mini-panel .nui-form-table")[2].querySelector("tbody tr:nth-child(2)").querySelector("td:nth-child(2)").querySelector("textarea");data.appli.con.push(applicon3.value); //审批意见
      const surgg = elem.querySelector("#approval .nui-form-table").querySelector("tbody tr td textarea");data.surggest = surgg.value;return data;
    },
    doAction_uiControl117_tTLZK0: function (data, elem) {
      if (data.eventType == 'change') {
        var data = data.dataCustom;elem.querySelector("#approval .nui-form-table").querySelector("tbody tr td textarea").value = data;
      }
    },
    getTemplate_uiControl117_tTLZK0: function () {
      var selfTemplate = 'import { Component } from \'react\';\nexport default class extends React.Component {\n\n\t\t\t\trender() {\n\t\t\t\t\tconst data = this.props.data.customData;\n\t\t\t\t\tif(data) {\n\t\t\t\t\t\treturn(<div className="ysp-flowsheet ysp-turn-wrap">\n\t\t\t{data.processTit.length>0?\n\t\t\t<div>\n\t\t\t<div className="ysp-turn-box">\n\t\t\t\t<h2><i className="ysp-tit-bar"></i>{data.processTit[0]}\uFF1A</h2>\n\t\t\t\t<ul>\n\t\t\t\t\t{ data.base.tit.map((item,index)=>{ return(\n\t\t\t\t\t<li><span className="li-l">{item}\uFF1A</span><span className="li-r">{data.base.con[index]}</span></li>\n\t\t\t\t\t) }) }\n\t\t\t\t</ul>\n\t\t\t</div>\n        <div className="ysp-turn-box">\n\t\t\t\t<h2><i className="ysp-tit-bar"></i>{data.processTit[1]}\uFF1A</h2>\n\t\t\t\t<ul>\n\t\t\t\t\t{ data.contract.tit.map((item,index)=>{ return(\n\t\t\t\t\t<li><span className="li-l">{item}\uFF1A</span><span className="li-r">{data.contract.con[index]}</span></li>\n\t\t\t\t\t) }) }\n\t\t\t\t</ul>\n\t\t\t</div>\n                    <div className="ysp-turn-box">\n                    <h2><i className="ysp-tit-bar"></i>{data.processTit[2]}\uFF1A</h2>\n                      <p className="ysp-txt-tip">{data.appli.tip}</p>\n                      <ul>{data.appli.tit.map((item,index)=>{\n                          if(index ==0){\n                            return(<li><span className="li-l">{item}\uFF1A</span><span className="li-r">{data.appli.con[index]}</span></li>)\n                          }else{\n                            return(<li><div className="ysp-area-tit">{item}\uFF1A</div><ATextarea value={data.appli.con[index]} className="ysp-area" disabled ></ATextarea></li>)\n                          }\n                          \n                        })\n                         \n                                    \n                           }\n                        \n                      </ul>\n                    </div>\n                    <div className="ysp-turn-box">\n        <h2>\u5BA1\u6279\u610F\u89C1\uFF1A</h2>\n        <div className="ysp-area-box">\n\t\t\t\t<ATextarea onBlur={(e)=>{\n            const handler=this.props.customHandler;\n            if(handler){\n              handler({\n                data:e.target.value,\n            \t\teventType:"change"\n              })\n            }\n           }} value={data.surggest}></ATextarea>\n          </div>\n\t\t\t</div>\n\n\t\t\t</div>:\n\t\t\t<div className="ysp-no-data">\n\t\t\t\t<i></i>\n\t\t\t\t<div>\u6682\u65E0\u6570\u636E</div>\n\t\t\t</div>\n\t\t\t}\n\t\t\t</div>)\n\t\t\t\t\t} else {\n\t\t\t\t\t\treturn(\n\t\t\t\t\t\t\t<div style={{display: "none"}}></div>)\n\t\t\t\t\t}\n\t\t\t\t}\n};';
      return '"use strict";\n\nObject.defineProperty(exports, "__esModule", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require("react");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_React$Component) {\n\t_inherits(_class, _React$Component);\n\n\tfunction _class() {\n\t\t_classCallCheck(this, _class);\n\n\t\treturn _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));\n\t}\n\n\t_createClass(_class, [{\n\t\tkey: "render",\n\t\tvalue: function render() {\n\t\t\tvar _this2 = this;\n\n\t\t\tvar data = this.props.data.customData;\n\t\t\tif (data) {\n\t\t\t\treturn React.createElement(\n\t\t\t\t\t"div",\n\t\t\t\t\t{ className: "ysp-flowsheet ysp-turn-wrap" },\n\t\t\t\t\tdata.processTit.length > 0 ? React.createElement(\n\t\t\t\t\t\t"div",\n\t\t\t\t\t\tnull,\n\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\t{ className: "ysp-turn-box" },\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"h2",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\tReact.createElement("i", { className: "ysp-tit-bar" }),\n\t\t\t\t\t\t\t\tdata.processTit[0],\n\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"ul",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\tdata.base.tit.map(function (item, index) {\n\t\t\t\t\t\t\t\t\treturn React.createElement(\n\t\t\t\t\t\t\t\t\t\t"li",\n\t\t\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t"span",\n\t\t\t\t\t\t\t\t\t\t\t{ className: "li-l" },\n\t\t\t\t\t\t\t\t\t\t\titem,\n\t\t\t\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t"span",\n\t\t\t\t\t\t\t\t\t\t\t{ className: "li-r" },\n\t\t\t\t\t\t\t\t\t\t\tdata.base.con[index]\n\t\t\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t\t);\n\t\t\t\t\t\t\t\t})\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t),\n\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\t{ className: "ysp-turn-box" },\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"h2",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\tReact.createElement("i", { className: "ysp-tit-bar" }),\n\t\t\t\t\t\t\t\tdata.processTit[1],\n\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"ul",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\tdata.contract.tit.map(function (item, index) {\n\t\t\t\t\t\t\t\t\treturn React.createElement(\n\t\t\t\t\t\t\t\t\t\t"li",\n\t\t\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t"span",\n\t\t\t\t\t\t\t\t\t\t\t{ className: "li-l" },\n\t\t\t\t\t\t\t\t\t\t\titem,\n\t\t\t\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t"span",\n\t\t\t\t\t\t\t\t\t\t\t{ className: "li-r" },\n\t\t\t\t\t\t\t\t\t\t\tdata.contract.con[index]\n\t\t\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t\t);\n\t\t\t\t\t\t\t\t})\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t),\n\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\t{ className: "ysp-turn-box" },\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"h2",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\tReact.createElement("i", { className: "ysp-tit-bar" }),\n\t\t\t\t\t\t\t\tdata.processTit[2],\n\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"p",\n\t\t\t\t\t\t\t\t{ className: "ysp-txt-tip" },\n\t\t\t\t\t\t\t\tdata.appli.tip\n\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"ul",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\tdata.appli.tit.map(function (item, index) {\n\t\t\t\t\t\t\t\t\tif (index == 0) {\n\t\t\t\t\t\t\t\t\t\treturn React.createElement(\n\t\t\t\t\t\t\t\t\t\t\t"li",\n\t\t\t\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t\t"span",\n\t\t\t\t\t\t\t\t\t\t\t\t{ className: "li-l" },\n\t\t\t\t\t\t\t\t\t\t\t\titem,\n\t\t\t\t\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t\t"span",\n\t\t\t\t\t\t\t\t\t\t\t\t{ className: "li-r" },\n\t\t\t\t\t\t\t\t\t\t\t\tdata.appli.con[index]\n\t\t\t\t\t\t\t\t\t\t\t)\n\t\t\t\t\t\t\t\t\t\t);\n\t\t\t\t\t\t\t\t\t} else {\n\t\t\t\t\t\t\t\t\t\treturn React.createElement(\n\t\t\t\t\t\t\t\t\t\t\t"li",\n\t\t\t\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\t\t\t\t\t\t{ className: "ysp-area-tit" },\n\t\t\t\t\t\t\t\t\t\t\t\titem,\n\t\t\t\t\t\t\t\t\t\t\t\t"\\uFF1A"\n\t\t\t\t\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\t\t\t\t\tReact.createElement(ATextarea, { value: data.appli.con[index], className: "ysp-area", disabled: true })\n\t\t\t\t\t\t\t\t\t\t);\n\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t})\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t),\n\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\t{ className: "ysp-turn-box" },\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"h2",\n\t\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t\t"\\u5BA1\\u6279\\u610F\\u89C1\\uFF1A"\n\t\t\t\t\t\t\t),\n\t\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\t\t{ className: "ysp-area-box" },\n\t\t\t\t\t\t\t\tReact.createElement(ATextarea, { onBlur: function onBlur(e) {\n\t\t\t\t\t\t\t\t\t\tvar handler = _this2.props.customHandler;\n\t\t\t\t\t\t\t\t\t\tif (handler) {\n\t\t\t\t\t\t\t\t\t\t\thandler({\n\t\t\t\t\t\t\t\t\t\t\t\tdata: e.target.value,\n\t\t\t\t\t\t\t\t\t\t\t\teventType: "change"\n\t\t\t\t\t\t\t\t\t\t\t});\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t}, value: data.surggest })\n\t\t\t\t\t\t\t)\n\t\t\t\t\t\t)\n\t\t\t\t\t) : React.createElement(\n\t\t\t\t\t\t"div",\n\t\t\t\t\t\t{ className: "ysp-no-data" },\n\t\t\t\t\t\tReact.createElement("i", null),\n\t\t\t\t\t\tReact.createElement(\n\t\t\t\t\t\t\t"div",\n\t\t\t\t\t\t\tnull,\n\t\t\t\t\t\t\t"\\u6682\\u65E0\\u6570\\u636E"\n\t\t\t\t\t\t)\n\t\t\t\t\t)\n\t\t\t\t);\n\t\t\t} else {\n\t\t\t\treturn React.createElement("div", { style: { display: "none" } });\n\t\t\t}\n\t\t}\n\t}]);\n\n\treturn _class;\n}(React.Component);\n\nexports.default = _class;\n;';
    },
    ...
    getData_control126_FpDrkT: function (elem) {},
    doAction_uiControl119_ZZEIOy: function (data, elem) {},
    getTemplate_uiControl119_ZZEIOy: function () {
