(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control124_4JK5eW: function (elem) {
      if (!elem) {
        return;
      }var data = { processTit: [], time: "", base: { tit: [], con: [] }, contract: { tit: [], con: [] }, appli: { tip: "", tit: [], con: [] }, surggest: [], errorTip: {} }; //各项title
      ...
      var timetit = elem.querySelector("#dataform1").querySelectorAll(".mini-textbox")[0].querySelector("input");data.time = timetit.value; //基础信息表格
