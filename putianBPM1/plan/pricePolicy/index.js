(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control181_pw25vK: function (elem) {
      if (elem) {
        return elem.textContent;
      }return [];
    },
    doAction_uiControl174_4fBuQz: function (data, elem) {},
    getTemplate_uiControl174_4fBuQz: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n       <div className="ysp-flowsheet ysp-datafrom2">{data&&data.length>0 ? <div className="ysp-total"><h1>{data}</h1></div> : ""}</div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData;\n    return React.createElement(\n      "div",\n      { className: "ysp-flowsheet ysp-datafrom2" },\n      data && data.length > 0 ? React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data\n        )\n      ) : ""\n    );\n  }\n});';
    },
    getData_control182_zJgpQZ: function (elem) {
      if (elem) {
        var arr = { title: [], content: [] };var tab1 = elem.querySelector(".mini-grid-columns-view").querySelector("table");var ths = tab1.querySelectorAll(".mini-grid-headerCell.mini-grid-bottomCell");for (var i = 0; i < ths.length; i++) {
          arr.title.push(ths[i].textContent);
        }var tab2 = elem.querySelector(".mini-grid-rows-view").querySelector("table");var trs = tab2.querySelectorAll("tr");for (var i = 1; i < trs.length; i++) {
          var con = [];var tds = trs[i].querySelectorAll("td");for (var j = 1; j < tds.length; j++) {
            con.push(tds[j].textContent);
          }arr.content.push(con);
        }return arr;
      }return [];
    },
    doAction_uiControl175_Ac8mke: function (data, elem) {},
    getTemplate_uiControl175_Ac8mke: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n \xA0 \xA0var cards = data&&data.content.length>0&&data.content.map(function(d,i){\n      return(\n        <div className="ysp-flowsheet-twoPart-card">\n        \t<p className="ysp-twoPart-cardTit">{d[0]}</p>\n          {d.map(function(item,index){\n            if(index != 0){\n              return( \n                <div>\n                \t<span>{data.title[index]}</span>\n                  <label>{item}</label>\n                </div>\n              )\n            }\n            })\n          }\n        </div>\n      )\n    })\n    return (\n        <div className="ysp-flowsheet ysp-datafrom2">{data!="" ? <div className="ysp-flowsheet-twoPart">{cards}</div> : ""}</div>\n    )\n  }\n});';
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    var data = this.props.customData;\n    var cards = data && data.content.length > 0 && data.content.map(function (d, i) {\n      return React.createElement(\n        \"div\",\n        { className: \"ysp-flowsheet-twoPart-card\" },\n        React.createElement(\n          \"p\",\n          { className: \"ysp-twoPart-cardTit\" },\n          d[0]\n        ),\n        d.map(function (item, index) {\n          if (index != 0) {\n            return React.createElement(\n              \"div\",\n              null,\n              React.createElement(\n                \"span\",\n                null,\n                data.title[index]\n              ),\n              React.createElement(\n                \"label\",\n                null,\n                item\n              )\n            );\n          }\n        })\n      );\n    });\n    return React.createElement(\n      \"div\",\n      { className: \"ysp-flowsheet ysp-datafrom2\" },\n      data != \"\" ? React.createElement(\n        \"div\",\n        { className: \"ysp-flowsheet-twoPart\" },\n        cards\n      ) : \"\"\n    );\n  }\n});";
    },
    ...
    doAction_uiControl177_ANEIk3: function (data, elem) {
      if (data.eventType == "change") {
        var i = data.dataCustom;debugger;var clas = i.cla;var val = i.val;if (clas == "ysp-agree") {
          elem.querySelector("textarea").value = val;
        }
      }
    },
    getTemplate_uiControl177_ANEIk3: function () {
      var selfTemplate = 'import { Component } from \'react\';\nexport default class extends Component {\n  onChange(e){\n    var target=e.target;\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        data:{val:target.value,cla:target.className},\n        eventType:"change"\n      })\n    }\n  }\n  render() {\n    var data = this.props.customData;\n    var _this = this;\n    return (\n      <div className="ysp-flowsheet ysp-datafrom2">{data&&data.length>0 ? <div className="ysp-Approval-opinions"><span>{data[0]}</span><textarea onChange={_this.onChange.bind(_this)} className="ysp-agree">{data[1]}</textarea></div> : ""}</div>\n    )\n  }\n};';
      return '"use strict";\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require("react");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));\n  }\n\n  _createClass(_class, [{\n    key: "onChange",\n    value: function onChange(e) {\n      var target = e.target;\n      var handler = this.props.customHandler;\n      if (handler) {\n        handler({\n          data: { val: target.value, cla: target.className },\n          eventType: "change"\n        });\n      }\n    }\n  }, {\n    key: "render",\n    value: function render() {\n      var data = this.props.customData;\n      var _this = this;\n      return React.createElement(\n        "div",\n        { className: "ysp-flowsheet ysp-datafrom2" },\n        data && data.length > 0 ? React.createElement(\n          "div",\n          { className: "ysp-Approval-opinions" },\n          React.createElement(\n            "span",\n            null,\n            data[0]\n          ),\n          React.createElement(\n            "textarea",\n            { onChange: _this.onChange.bind(_this), className: "ysp-agree" },\n            data[1]\n          )\n        ) : ""\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;\n;';
    },
    ...
    getData_control196_Ny8x1x: function (elem) {
      if (elem) {
        ...
        var a = div1.getAttribute("style");arr.status.push(a);var b = div2.getAttribute("style");arr.status.push(b);var c = div3.getAttribute("style");arr.status.push(c);var d = div4.getAttribute("style");arr.status.push(c);var e = div5.getAttribute("style");arr.status.push(c);if (a == "display: none;") {
          arr.titleOne.push("");arr.contentOne.push("");
        } else {
          //标题
          var tit = div1.querySelector(".mini-toolbar").querySelector("td");arr.headOne = tit.textContent; //表格标题
          var tab1 = div1.querySelector(".mini-grid-columns-view").querySelector("table");var ths = tab1.querySelectorAll(".mini-grid-headerCell.mini-grid-bottomCell");for (var i = 0; i < ths.length; i++) {
            arr.titleOne.push(ths[i].textContent);
          } //表格内容
          var tab2 = div1.querySelector(".mini-grid-rows-view").querySelector("table");var trs = tab2.querySelectorAll("tr");for (var i = 1; i < trs.length; i++) {
            var con = [];var tds = trs[i].querySelectorAll("td");for (var j = 1; j < tds.length; j++) {
              con.push(tds[j].textContent);
            }arr.contentOne.push(con);
          }
        }if (b == "display: none;") {
          arr.titleTwo.push("");arr.contentTwo.push("");
        } else {
          //标题
          var tit = div2.querySelector(".mini-toolbar").querySelector("td");arr.headTwo = tit.textContent; //表格标题
          var tab1 = div2.querySelector(".mini-grid-columns-view").querySelector("table");var ths = tab1.querySelectorAll(".mini-grid-headerCell.mini-grid-bottomCell");for (var i = 0; i < ths.length; i++) {
            arr.titleTwo.push(ths[i].textContent);
          } //表格内容
          var tab2 = div2.querySelector(".mini-grid-rows-view").querySelector("table");var trs = tab2.querySelectorAll("tr");for (var i = 1; i < trs.length; i++) {
            var con = [];var tds = trs[i].querySelectorAll("td");for (var j = 1; j < tds.length; j++) {
              con.push(tds[j].textContent);
            }arr.contentTwo.push(con);
          }
        }if (c == "display: none;") {
          arr.titleThree.push("");arr.contentThree.push("");
        } else {
          //标题
          var tit = div3.querySelector(".mini-toolbar").querySelector("td");arr.headThree = tit.textContent; //表格标题
          var tab1 = div3.querySelector(".mini-grid-columns-view").querySelector("table");var ths = tab1.querySelectorAll(".mini-grid-headerCell.mini-grid-bottomCell");for (var i = 0; i < ths.length; i++) {
            arr.titleThree.push(ths[i].textContent);
          } //表格内容
          var tab2 = div3.querySelector(".mini-grid-rows-view").querySelector("table");var trs = tab2.querySelectorAll("tr");for (var i = 1; i < trs.length; i++) {
            var con = [];var tds = trs[i].querySelectorAll("td");for (var j = 1; j < tds.length; j++) {
              con.push(tds[j].textContent);
            }arr.contentThree.push(con);
          }
        }if (d == "display: none;") {
          arr.titleFour.push("");arr.contentFour.push("");
        } else {
          //标题
          var tit = div4.querySelector(".mini-toolbar").querySelector("td");arr.headFour = tit.textContent; //表格标题
          var tab1 = div4.querySelector(".mini-grid-columns-view").querySelector("table");var ths = tab1.querySelectorAll(".mini-grid-headerCell.mini-grid-bottomCell");for (var i = 0; i < ths.length; i++) {
            arr.titleFour.push(ths[i].textContent);
          } //表格内容
          var tab2 = div4.querySelector(".mini-grid-rows-view").querySelector("table");var trs = tab2.querySelectorAll("tr");for (var i = 1; i < trs.length; i++) {
            var con = [];var tds = trs[i].querySelectorAll("td");for (var j = 1; j < tds.length; j++) {
              con.push(tds[j].textContent);
            }arr.contentFour.push(con);
          }
        }if (e == "display: none;") {
          arr.titleFive.push("");arr.contentFive.push("");
        } else {
          //标题
          var tit = div5.querySelector(".mini-toolbar").querySelector("td");arr.headFive = tit.textContent; //表格标题
          var tab1 = div5.querySelector(".mini-grid-columns-view").querySelector("table");var ths = tab1.querySelectorAll(".mini-grid-headerCell.mini-grid-bottomCell");for (var i = 0; i < ths.length; i++) {
            arr.titleFive.push(ths[i].textContent);
          } //表格内容
          var tab2 = div5.querySelector(".mini-grid-rows-view").querySelector("table");var trs = tab2.querySelectorAll("tr");for (var i = 1; i < trs.length; i++) {
            var con = [];var tds = trs[i].querySelectorAll("td");for (var j = 1; j < tds.length; j++) {
              con.push(tds[j].textContent);
            }arr.contentFive.push(con);
          }
        }return arr;
      }return [];
    },
    ...
    getTemplate_uiControl189_NBalgT: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    var cards = data&&data.status.length>0&&data.status[0] == null?  \n        <div>\n          <div className="ysp-total">\n            <h1>{data.headOne}</h1>\n          </div> \n       \t\t{data && data.contentOne.map(function(d,i){\n          return(\n              <div className="ysp-flowsheet-twoPart">\n                <div className="ysp-flowsheet-twoPart-card">\n                  <p className="ysp-twoPart-cardTit">{d[0]}</p>\n                  {d.map(function(item,index){\n                    if(index !== 0){\n                      return( \n                        <div>\n                          <span>{data.titleOne[index]}</span>\n                          <label>{item}</label>\n                        </div>\n                      )\n                    }\n                  })\n                  }\n              </div>\n              </div>\n          )\n        })}\n        </div> : data&&data.status.length>0&&data.status[1] == null?  \n        <div>\n          <div className="ysp-total">\n            <h1>{data.headTwo}</h1>\n          </div> \n       \t\t{data && data.contentTwo.map(function(d,i){\n          return(\n              <div className="ysp-flowsheet-twoPart">\n                <div className="ysp-flowsheet-twoPart-card">\n                  <p className="ysp-twoPart-cardTit">{d[0]}</p>\n                  {d.map(function(item,index){\n                    if(index !== 0){\n                      return( \n                        <div>\n                          <span>{data.titleTwo[index]}</span>\n                          <label>{item}</label>\n                        </div>\n                      )\n                    }\n                  })\n                  }\n              </div>\n              </div>\n          )\n        })}\n        </div> : data&&data.status.length>0&&data.status[2] == null?  \n        <div>\n          <div className="ysp-total">\n            <h1>{data.headThree}</h1>\n          </div> \n       \t\t{data && data.contentThree.map(function(d,i){\n          return(\n              <div className="ysp-flowsheet-twoPart">\n                <div className="ysp-flowsheet-twoPart-card">\n                  <p className="ysp-twoPart-cardTit">{d[0]}</p>\n                  {d.map(function(item,index){\n                    if(index !== 0){\n                      return( \n                        <div>\n                          <span>{data.titleThree[index]}</span>\n                          <label>{item}</label>\n                        </div>\n                      )\n                    }\n                  })\n                  }\n              </div>\n              </div>\n          )\n        })}\n        </div> : data&&data.status.length>0&&data.status[3] == null?  \n        <div>\n          <div className="ysp-total">\n            <h1>{data.headFour}</h1>\n          </div> \n       \t\t{data && data.contentFour.map(function(d,i){\n          return(\n              <div className="ysp-flowsheet-twoPart">\n                <div className="ysp-flowsheet-twoPart-card">\n                  <p className="ysp-twoPart-cardTit">{d[0]}</p>\n                  {d.map(function(item,index){\n                    if(index !== 0){\n                      return( \n                        <div>\n                          <span>{data.titleFour[index]}</span>\n                          <label>{item}</label>\n                        </div>\n                      )\n                    }\n                  })\n                  }\n              </div>\n              </div>\n          )\n        })}\n        </div> : data&&data.status.length>0&&data.status[4] == null?  \n        <div>\n          <div className="ysp-total">\n            <h1>{data.headFive}</h1>\n          </div> \n       \t\t{data && data.contentFive.map(function(d,i){\n          return(\n              <div className="ysp-flowsheet-twoPart">\n                <div className="ysp-flowsheet-twoPart-card">\n                  <p className="ysp-twoPart-cardTit">{d[0]}</p>\n                  {d.map(function(item,index){\n                    if(index !== 0){\n                      return( \n                        <div>\n                          <span>{data.titleFive[index]}</span>\n                          <label>{item}</label>\n                        </div>\n                      )\n                    }\n                  })\n                  }\n              </div>\n              </div>\n          )\n        })}\n        </div> : "";\n    // var aa=[];\n    // aa.push(<div>hahah</div>)\n    return (\n        <div className="ysp-flowsheet ysp-datafrom2">{data!=="" ? <div>{cards}</div> : ""}</div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData;\n    var cards = data && data.status.length > 0 && data.status[0] == null ? React.createElement(\n      "div",\n      null,\n      React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data.headOne\n        )\n      ),\n      data && data.contentOne.map(function (d, i) {\n        return React.createElement(\n          "div",\n          { className: "ysp-flowsheet-twoPart" },\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet-twoPart-card" },\n            React.createElement(\n              "p",\n              { className: "ysp-twoPart-cardTit" },\n              d[0]\n            ),\n            d.map(function (item, index) {\n              if (index !== 0) {\n                return React.createElement(\n                  "div",\n                  null,\n                  React.createElement(\n                    "span",\n                    null,\n                    data.titleOne[index]\n                  ),\n                  React.createElement(\n                    "label",\n                    null,\n                    item\n                  )\n                );\n              }\n            })\n          )\n        );\n      })\n    ) : data && data.status.length > 0 && data.status[1] == null ? React.createElement(\n      "div",\n      null,\n      React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data.headTwo\n        )\n      ),\n      data && data.contentTwo.map(function (d, i) {\n        return React.createElement(\n          "div",\n          { className: "ysp-flowsheet-twoPart" },\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet-twoPart-card" },\n            React.createElement(\n              "p",\n              { className: "ysp-twoPart-cardTit" },\n              d[0]\n            ),\n            d.map(function (item, index) {\n              if (index !== 0) {\n                return React.createElement(\n                  "div",\n                  null,\n                  React.createElement(\n                    "span",\n                    null,\n                    data.titleTwo[index]\n                  ),\n                  React.createElement(\n                    "label",\n                    null,\n                    item\n                  )\n                );\n              }\n            })\n          )\n        );\n      })\n    ) : data && data.status.length > 0 && data.status[2] == null ? React.createElement(\n      "div",\n      null,\n      React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data.headThree\n        )\n      ),\n      data && data.contentThree.map(function (d, i) {\n        return React.createElement(\n          "div",\n          { className: "ysp-flowsheet-twoPart" },\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet-twoPart-card" },\n            React.createElement(\n              "p",\n              { className: "ysp-twoPart-cardTit" },\n              d[0]\n            ),\n            d.map(function (item, index) {\n              if (index !== 0) {\n                return React.createElement(\n                  "div",\n                  null,\n                  React.createElement(\n                    "span",\n                    null,\n                    data.titleThree[index]\n                  ),\n                  React.createElement(\n                    "label",\n                    null,\n                    item\n                  )\n                );\n              }\n            })\n          )\n        );\n      })\n    ) : data && data.status.length > 0 && data.status[3] == null ? React.createElement(\n      "div",\n      null,\n      React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data.headFour\n        )\n      ),\n      data && data.contentFour.map(function (d, i) {\n        return React.createElement(\n          "div",\n          { className: "ysp-flowsheet-twoPart" },\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet-twoPart-card" },\n            React.createElement(\n              "p",\n              { className: "ysp-twoPart-cardTit" },\n              d[0]\n            ),\n            d.map(function (item, index) {\n              if (index !== 0) {\n                return React.createElement(\n                  "div",\n                  null,\n                  React.createElement(\n                    "span",\n                    null,\n                    data.titleFour[index]\n                  ),\n                  React.createElement(\n                    "label",\n                    null,\n                    item\n                  )\n                );\n              }\n            })\n          )\n        );\n      })\n    ) : data && data.status.length > 0 && data.status[4] == null ? React.createElement(\n      "div",\n      null,\n      React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data.headFive\n        )\n      ),\n      data && data.contentFive.map(function (d, i) {\n        return React.createElement(\n          "div",\n          { className: "ysp-flowsheet-twoPart" },\n          React.createElement(\n            "div",\n            { className: "ysp-flowsheet-twoPart-card" },\n            React.createElement(\n              "p",\n              { className: "ysp-twoPart-cardTit" },\n              d[0]\n            ),\n            d.map(function (item, index) {\n              if (index !== 0) {\n                return React.createElement(\n                  "div",\n                  null,\n                  React.createElement(\n                    "span",\n                    null,\n                    data.titleFive[index]\n                  ),\n                  React.createElement(\n                    "label",\n                    null,\n                    item\n                  )\n                );\n              }\n            })\n          )\n        );\n      })\n    ) : "";\n    // var aa=[];\n    // aa.push(<div>hahah</div>)\n    return React.createElement(\n      "div",\n      { className: "ysp-flowsheet ysp-datafrom2" },\n      data !== "" ? React.createElement(\n        "div",\n        null,\n        cards\n      ) : ""\n    );\n  }\n});';
    }
  }, "pricePolicy");
})(window, ysp);