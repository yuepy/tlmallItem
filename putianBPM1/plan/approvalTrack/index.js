  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl12_KI2hm3: function (data, elem) {
      if (data.eventType == 'click') {
        var d = data.dataCustom;if (d == 'btn ysp-btn-one') {
          ...
          var btnTwo = elem.contentWindow.document.querySelector('#td_0_0').querySelector("a");btnTwo.click();var json = { time: new Date().getTime() };ysp.appMain.getActiveWindow().history.replaceState(json, "", "http://192.168.220.51:8000/ptsoa/bps/wfclient/task/taskList.jsp?taskType=self"); //     setTimeout(function () {
          //       var json = {
          //         time: new Date().getTime()
          ...
          //     var btn = elem.ownerDocument.querySelector('.mini-tools-close');
          // 		btn.click()
          //       ysp.appMain.getActiveWindow().history.replaceState(json, "", "http://192.168.220.51:8000/ptsoa/bps/wfclient/task/taskList.jsp?taskType=self");
          //     }, 500);
        }
      };
    },
    ...
    getData_control188_Pz2Hxn: function (elem) {
      ...
      if (elem) {
        ...
        var windowDrag = elem.querySelector(".mini-window-drag");if (windowDrag) {
