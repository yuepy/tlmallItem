    ...
    ysp.runtime.Model.extendLoadingModel({
        ...
        getData_control20_y0QdaI: function(elem) {
            ...
            if (elem.contentWindow && elem.contentWindow.document) {
                ...
                var signOne = elem.contentWindow.document.querySelectorAll('.mini-panel-viewport');
        ...
        getData_control198_kM3Zde: function(elem) {
            if (!elem) {
                return;
            } // if (elem && elem.querySelector("#toast") && elem.querySelector("#toast").style.display != "none") {
            //   return elem.querySelector("#toast").textContent;
        ...
        doAction_uiControl191_TanyTx: function(data, elem) {
            if (data.eventType == 'click') {
        ...
        getTemplate_uiControl191_TanyTx: function() {
        ...
        getData_control201_yX7Svk: function(elem) {
            if (!elem) {
                return;
            }
        ...
        doAction_uiControl194_A1uDt7: function(data, elem) {
        ...
        getTemplate_uiControl194_A1uDt7: function() {
