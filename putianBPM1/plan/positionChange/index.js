(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control132_LWU68G: function (elem) {
      if (!elem) {
        return;
      }const data = { boxTit: [], time: { tit: [], con: [] }, base: { tit: [], con: [] }, before: { tit: [], con: [] }, after: { tit: [], con: [], tip: {} }, method: { tit: [], con: [] }, money: { tit: [], con: [], icon: [], error: [] }, performed: { tit: [], con: [], icon: [], error: [] }, reason: [], annex: [], surggest: [], errorTip: {} }; //提交日期
      const timetit = elem.querySelector("#form1").querySelectorAll(".table")[0].querySelectorAll("tr");[].map.call(timetit, function (item, index) {
      ...
      const box = elem.querySelectorAll(".mini-panel");[].map.call(box, (item, index) => {
        const boxtit = item.querySelectorAll(".mini-panel-title");const tr = item.querySelectorAll(".mini-panel-body tbody tr");[].map.call(boxtit, (item, index) => {
          data.boxTit.push(item.textContent);
        });const aftertip = elem.querySelectorAll(".mini-panel")[2].querySelector("tr:last-child").textContent;data.after.tip = aftertip.replace(/\s+/g, ""); //基础信息
        if (index == 0) {
          [].map.call(tr, (d, i) => {
          ...
          [].map.call(tr, (d, i) => {
            const a = d.querySelectorAll("td.form_label");const b = d.querySelectorAll("td:nth-child(2n)");[].map.call(a, (m, n) => {
              ...
              data.money.con.push(m.querySelector("input").value);const readonly = m.querySelector(".mini-buttonedit-readOnly");const minierror = m.querySelector(".mini-error");if (!readonly && m.querySelector(".mini-buttonedit-icon")) {
          ...
          [].map.call(tr, (d, i) => {
            const a = d.querySelectorAll("td.form_label");const b = d.querySelectorAll("td:nth-child(2n)");[].map.call(a, (m, n) => {
              ...
              if (m.querySelector("input")) {
                data.performed.con.push(m.querySelector("input").value);const readonly = m.querySelector(".mini-buttonedit-readOnly");const minierror = m.querySelector(".mini-error");if (!readonly && m.querySelector(".mini-buttonedit-icon")) {
      ...
      const reas = elem.querySelectorAll(".mini-panel")[6].querySelector(".mini-panel-body textarea");data.reason.push(reas.placeholder);data.reason.push(reas.value);const next = elem.querySelectorAll(".mini-panel")[6].nextElementSibling;data.reason.push(next.textContent.replace(/\s+/g, ""));const read = elem.querySelectorAll(".mini-panel")[6].querySelector(".mini-panel-body .mini-textbox-readOnly");if (read) {
    ...
    doAction_uiControl125_5ZOR9A: function (data, elem) {
      ...
      } else if (data.eventType == "selector") {
      ...
      } else if (data.eventType == "selector1") {
