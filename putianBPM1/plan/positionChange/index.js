(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control132_LWU68G: function (elem) {
      if (!elem) {
        return;
      }var data = { boxTit: [], time: { tit: [], con: [] }, base: { tit: [], con: [] }, before: { tit: [], con: [] }, after: { tit: [], con: [], tip: {} }, method: { tit: [], con: [] }, money: { tit: [], con: [], icon: [], error: [] }, moneypop1: [], moneypop2: [], moneypop3: [], moneypop4: [], moneypop5: [], performed: { tit: [], con: [], icon: [], error: [] }, perfpop1: [], reason: [], annex: [], surggest: [], errorTip: {} }; //提交日期
