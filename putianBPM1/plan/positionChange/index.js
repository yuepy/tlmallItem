(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control132_LWU68G: function (elem) {
      if (!elem) {
        return;
      }const data = { test: [], boxTit: [], time: { tit: [], con: [] }, base: { tit: [], con: [] }, before: { tit: [], con: [] }, after: { tit: [], con: [], tip: {} }, method: { tit: [], con: [] }, money: { tit: [], con: [] }, performed: { tit: [], con: [], icon: [] }, reason: [], annex: [], surggest: [], errorTip: {} };const aaa = elem.querySelectorAll(".mini-panel")[5].querySelectorAll("tbody td")[5].innerHTML;data.test.push(aaa); //提交日期
        ...
        if (index == 0) {
          ...
          [].map.call(tr, (d, i) => {
            const a = d.querySelectorAll("td.form_label");const b = d.querySelectorAll("td:nth-child(2n)");[].map.call(a, (m, n) => {
              ...
              data.money.con.push(m.querySelector("input").value);
            });
          }); //绩效信息
        } else if (index == 5) {
          [].map.call(tr, (d, i) => {
            const a = d.querySelectorAll("td.form_label");const b = d.querySelectorAll("td:nth-child(2n)");[].map.call(a, (m, n) => {
              ...
              if (m.querySelector("input")) {
                data.performed.con.push(m.querySelector("input").value);const readonly = m.querySelector(".mini-buttonedit-readOnly");if (!readonly && m.querySelector(".mini-buttonedit-icon")) {
