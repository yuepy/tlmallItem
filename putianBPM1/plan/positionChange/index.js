(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control132_LWU68G: function (elem) {
      if (!elem) {
        return;
      }const data = { boxTit: [], time: { tit: [], con: [] }, base: { tit: [], con: [] }, before: { tit: [], con: [] }, after: { tit: [], con: [] }, method: { tit: [], con: [] }, money: { tit: [], con: [] }, performed: { tit: [], con: [] }, reason: [], annex: [], surggest: [], errorTip: {} }; //提交日期
