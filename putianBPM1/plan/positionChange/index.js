(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control132_LWU68G: function (elem) {
      if (!elem) {
        return;
      }var data = { boxTit: [], time: { tit: [], con: [] }, base: { tit: [], con: [] }, before: { tit: [], con: [] }, after: { tit: [], con: [], tip: {} }, method: { tit: [], con: [] }, money: { tit: [], con: [], icon: [], error: [] }, moneypop1: [], moneypop2: [], moneypop3: [], moneypop4: [], moneypop5: [], performed: { tit: [], con: [], icon: [], error: [] }, perfpop1: [], reason: [], annex: [], surggest: [], errorTip: {} };if (document.querySelectorAll('iframe')[2].contentWindow.document.querySelectorAll('iframe')[1].contentWindow.document.querySelector('.mini-mask-loading') == null) {
        //提交日期
        ...
        var ppop1 = elem.querySelector("#mini-84");if (ppop1 && ppop1.style.display != "none") {
          var perfpoptd1 = ppop1.querySelectorAll("td:nth-child(even)");[].map.call(perfpoptd1, function (item, index) {
            data.perfpop1.push(item.textContent);
          });
        } //职位变动原因
    ...
    doAction_uiControl125_5ZOR9A: function (data, elem) {
      if (data.eventType == 'change') {
        var data = data.dataCustom;elem.querySelectorAll(".mini-panel")[6].querySelector(".mini-panel-body textarea").value = data;elem.querySelectorAll(".mini-panel")[6].querySelector(".mini-panel-body textarea").dispatchEvent(new Event('change'));
