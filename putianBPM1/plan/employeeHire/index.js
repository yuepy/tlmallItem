(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl136_23yEhh: function (data, elem) {
      if (data.eventType == 'click') {
        var d = data.dataCustom;debugger;if (d[0] == 'ysp-tabs') {
    ...
    getData_control145_lXPpvy: function (elem) {
      if (!elem) {
        ...
        var data = { dataItem: [] };var form1 = elem.querySelector("#form1");if (form1) {
          var table1 = form1.querySelector("#table1");data.isshenpi = form1.querySelector("#isshenpi").querySelector("input").checked;if (table1) {
