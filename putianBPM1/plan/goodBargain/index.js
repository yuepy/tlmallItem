  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control176_GRJUNr: function (elem) {
      if (elem) {
        ...
        }arr.push(tit);var spans = elem.querySelectorAll('.mini-textbox-border');for (var j = 0; j < spans.length; j++) {
    ...
    doAction_uiControl173_cIDdi1: function (data, elem) {
      if (data.eventType == 'click') {
        var d = data.dataCustom.classNames;debugger;if (d == 'btn ysp-btn-one') {
    ...
    getData_control188_HqRJHJ: function (elem) {
      //红色提示
      if (!elem) {
        return;
      }if (elem && elem.contentWindow && elem.contentWindow.document) {
    ...
    doAction_uiControl181_c8Wwa2: function (data, elem) {},
    getTemplate_uiControl181_c8Wwa2: function () {
    ...
    getData_control181_ptwra5: function (elem) {
      if (elem) {
        var arr = [];var tit = [];var pData = [];var obj1 = { tip: "", lists: [], check: [], clas: "" };var obj2 = { tip: "", lists: [], check: [], clas: "" };var inp = { tip: "", value: "" };var tds = elem.querySelectorAll('.form_label');var tdsLen = tds.length;for (var j = 0; j < tdsLen; j++) {
          tit.push(tds[j].textContent.trim());
        }arr.push(tit);var label1 = elem.querySelector("#isBelowJcPrice").querySelectorAll("input");for (var i = 0; i < label1.length - 1; i++) {
          obj1.tip = "div";var checked = label1[i].checked;var ys = elem.querySelector("#isBelowJcPrice").className;obj1.clas = ys;if (ys == "mini-radiobuttonlist mini-disabled") {
            if (checked) {
        ...
        }pData.push(obj1);var label2 = elem.querySelector("#isBelowKsPrice").querySelectorAll("input");for (var i = 0; i < label2.length - 1; i++) {
          obj2.tip = "radio";var checked = label1[i].checked;var ys = elem.querySelector("#isBelowJcPrice").className;obj2.clas = ys;if (ys == "mini-radiobuttonlist mini-disabled") {
            if (checked) {
        ...
        }pData.push(obj2);var span = elem.querySelector("#ksPrice").querySelector("input");inp.tip = "input";inp.value = span.value;inp.disable = span.disabled;pData.push(inp);arr.push(pData);return arr;
      }return [];
    },
    doAction_uiControl174_FXKnek: function (data, elem) {
      if (data.eventType == "inputclick") {
        var a = data.dataCustom;var ind = parseInt(a.ind);var clases = a.clas;debugger;if (clases == "ysp-shenpiMoney one") {
          elem.querySelector("#isBelowJcPrice").querySelectorAll("input")[ind].click();
        } else if (clases == "ysp-shenpiMoney two") {
          elem.querySelector("#isBelowKsPrice").querySelectorAll("input")[ind].click();
        }
      } else if (data.eventType == "change") {
        debugger;var obj = data.dataCustom;elem.querySelector("#ksPrice").querySelector("input").value = obj.val;
      }
    },
    getTemplate_uiControl174_FXKnek: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  inputClick:function(e){\n    var target=e.target;\n    var handler=this.props.customHandler;\n    if(handler){\n      handler({\n        data:{ind:target.getAttribute("data-id"),clas:target.className},\n        eventType:"inputclick"\n      })\n    }\n  },\n  onChange:function(e){\n    var target=e.target;\n    var handler=this.props.customHandler;\n    // var reg = /[^0-9\\.]/g;\n    // target.value=target.value.replace( reg, \'\' );\n    // if(\ttarget.value==\'\'\t){\n    //    target.value=target.dataset.old;\n    // }\n    // if( target.value=="undefined" ){\n    //   target.value="";\n    // }\n    if(handler){\n      handler({\n        data:{val:target.value},\n        eventType:"change"\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.customData;\n    var _this = this;\n    var con = data&&data.length>0&&<div className="ysp-flowsheet-onePart">\n    <div>\n        <span>{data[0][0]}:</span>\n        {data[1][0].clas=="mini-radiobuttonlist mini-disabled" ? <label>{data[1][0].check[0]=="Y" ? "\u662F" : "\u5426"}</label> : <AMUI.List>\n        <AMUI.List.Item nested="radio" >\n        <AMUI.Field label="\u662F" type="radio"  name="radio-list-1" data-key={data[1][0].lists[0].parent}\tdata-id=\'0\'\tdata-sign={data[1][0].lists[0].id}\tdata-goal={data[1][0].lists[0].sign}\tchecked={data[1][0].lists[0] ==\'Y\'\t?\t\'true\'\t:\tnull}\tclassName=\'ysp-shenpiMoney one\' onClick={_this.inputClick.bind(_this)}/>\n        </AMUI.List.Item>\n        <AMUI.List.Item nested="radio" >\n        <AMUI.Field label="\u5426" type="radio"\tchecked={data[1][0].lists[1]==\'N\'\t?\t\'true\'\t:\tnull} name="radio-list-1" data-key={data[1][0].lists[1].parent}\tdata-id=\'1\'\tdata-sign={data[1][0].lists[1].id}\tclassName=\'ysp-shenpiMoney one\'\tdata-goal={data[1][0].lists[1].sign} onClick={_this.inputClick.bind(_this)}/>\n        </AMUI.List.Item>\n        </AMUI.List> }\n    </div>\n    <div>\n        <span>{data[0][1]}:</span>\n        {data[1][1].clas=="mini-radiobuttonlist mini-disabled" ? <label>{data[1][1].check[0]=="Y" ? "\u662F" : "\u5426"}</label> : <AMUI.List>\n        <AMUI.List.Item nested="radio" >\n        <AMUI.Field label="\u662F" type="radio"  name="radio-list-2" data-key={data[1][1].lists[0].parent}\tdata-id=\'0\'\tdata-sign={data[1][1].lists[0].id}\tdata-goal={data[1][1].lists[0].sign}\tchecked={data[1][1].lists[0] ==\'Y\'\t?\t\'true\'\t:\tnull}\tclassName=\'ysp-shenpiMoney two\' onClick={_this.inputClick.bind(_this)}/>\n        </AMUI.List.Item>\n        <AMUI.List.Item nested="radio" >\n        <AMUI.Field label="\u5426" type="radio"\tchecked={data[1][1].lists[1]==\'N\'\t?\t\'true\'\t:\tnull} name="radio-list-2" data-key={data[1][1].lists[1].parent}\tdata-id=\'1\'\tdata-sign={data[1][1].lists[1].id}\tclassName=\'ysp-shenpiMoney two\'\tdata-goal={data[1][1].lists[1].sign} onClick={_this.inputClick.bind(_this)}/>\n        </AMUI.List.Item>\n        </AMUI.List> }\n    </div>  \n    <div>\n        <span>{data[0][2]}:</span>\n        <label className="inp"><AInput type="number" value={data[1][2].value} onChange={_this.onChange.bind(_this)} disabled={data[1][2].disable ? "disabled" : ""} className="num"/><span>\u5143</span></label>\n    </div>\n</div>\n    return (\n      <div className="ysp-flowsheet ysp-datafrom2">{data&&data.length>0 ? <div>{con}</div> : ""}</div>\n    )\n  }\n});\n';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  inputClick: function inputClick(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        data: { ind: target.getAttribute("data-id"), clas: target.className },\n        eventType: "inputclick"\n      });\n    }\n  },\n  onChange: function onChange(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    // var reg = /[^0-9\\.]/g;\n    // target.value=target.value.replace( reg, \'\' );\n    // if(\ttarget.value==\'\'\t){\n    //    target.value=target.dataset.old;\n    // }\n    // if( target.value=="undefined" ){\n    //   target.value="";\n    // }\n    if (handler) {\n      handler({\n        data: { val: target.value },\n        eventType: "change"\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.customData;\n    var _this = this;\n    var con = data && data.length > 0 && React.createElement(\n      "div",\n      { className: "ysp-flowsheet-onePart" },\n      React.createElement(\n        "div",\n        null,\n        React.createElement(\n          "span",\n          null,\n          data[0][0],\n          ":"\n        ),\n        data[1][0].clas == "mini-radiobuttonlist mini-disabled" ? React.createElement(\n          "label",\n          null,\n          data[1][0].check[0] == "Y" ? "\u662F" : "\u5426"\n        ) : React.createElement(\n          AMUI.List,\n          null,\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u662F", type: "radio", name: "radio-list-1", "data-key": data[1][0].lists[0].parent, "data-id": "0", "data-sign": data[1][0].lists[0].id, "data-goal": data[1][0].lists[0].sign, checked: data[1][0].lists[0] == \'Y\' ? \'true\' : null, className: "ysp-shenpiMoney one", onClick: _this.inputClick.bind(_this) })\n          ),\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u5426", type: "radio", checked: data[1][0].lists[1] == \'N\' ? \'true\' : null, name: "radio-list-1", "data-key": data[1][0].lists[1].parent, "data-id": "1", "data-sign": data[1][0].lists[1].id, className: "ysp-shenpiMoney one", "data-goal": data[1][0].lists[1].sign, onClick: _this.inputClick.bind(_this) })\n          )\n        )\n      ),\n      React.createElement(\n        "div",\n        null,\n        React.createElement(\n          "span",\n          null,\n          data[0][1],\n          ":"\n        ),\n        data[1][1].clas == "mini-radiobuttonlist mini-disabled" ? React.createElement(\n          "label",\n          null,\n          data[1][1].check[0] == "Y" ? "\u662F" : "\u5426"\n        ) : React.createElement(\n          AMUI.List,\n          null,\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u662F", type: "radio", name: "radio-list-2", "data-key": data[1][1].lists[0].parent, "data-id": "0", "data-sign": data[1][1].lists[0].id, "data-goal": data[1][1].lists[0].sign, checked: data[1][1].lists[0] == \'Y\' ? \'true\' : null, className: "ysp-shenpiMoney two", onClick: _this.inputClick.bind(_this) })\n          ),\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u5426", type: "radio", checked: data[1][1].lists[1] == \'N\' ? \'true\' : null, name: "radio-list-2", "data-key": data[1][1].lists[1].parent, "data-id": "1", "data-sign": data[1][1].lists[1].id, className: "ysp-shenpiMoney two", "data-goal": data[1][1].lists[1].sign, onClick: _this.inputClick.bind(_this) })\n          )\n        )\n      ),\n      React.createElement(\n        "div",\n        null,\n        React.createElement(\n          "span",\n          null,\n          data[0][2],\n          ":"\n        ),\n        React.createElement(\n          "label",\n          { className: "inp" },\n          React.createElement(AInput, { type: "number", value: data[1][2].value, onChange: _this.onChange.bind(_this), disabled: data[1][2].disable ? "disabled" : "", className: "num" }),\n          React.createElement(\n            "span",\n            null,\n            "\\u5143"\n          )\n        )\n      )\n    );\n    return React.createElement(\n      "div",\n      { className: "ysp-flowsheet ysp-datafrom2" },\n      data && data.length > 0 ? React.createElement(\n        "div",\n        null,\n        con\n      ) : ""\n    );\n  }\n});';
    }
  }, "goodBargain");
})(window, ysp);