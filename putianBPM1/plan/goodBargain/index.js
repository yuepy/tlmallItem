(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control172_Tk1SWX: function (elem) {
      if (elem) {
    ...
    doAction_uiControl165_tWUoT9: function (data, elem) {},
    getTemplate_uiControl165_tWUoT9: function () {
    ...
    getData_control172_7wFt5N: function (elem) {
      if (elem) {
        return elem.textContent;
      }return [];
    },
    doAction_uiControl165_AMXN11: function (data, elem) {},
    getTemplate_uiControl165_AMXN11: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n       <div className="ysp-flowsheet ysp-datafrom2">{data&&data.length>0 ? <div className="ysp-total"><h1>{data}</h1></div> : ""}</div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData;\n    return React.createElement(\n      "div",\n      { className: "ysp-flowsheet ysp-datafrom2" },\n      data && data.length > 0 ? React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data\n        )\n      ) : ""\n    );\n  }\n});';
    },
    getData_control185_Qg9CED: function (elem) {},
    doAction_uiControl178_BoEGdc: function (data, elem) {},
    getTemplate_uiControl178_BoEGdc: function () {
    ...
    getData_control189_H9oQSP: function (elem) {
      if (!elem) {
        return;
      }var iframe = elem && elem.ownerDocument.defaultView.frameElement;console.log(elem);if (elem && elem.textContent.indexOf("回退方式") !== -1) {
    ...
    doAction_uiControl182_gP4EzM: function (data, elem) {
      if (data.eventType == 'change') {
    ...
    getTemplate_uiControl182_gP4EzM: function () {
