  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control181_ptwra5: function (elem) {
      if (elem) {
        var arr = [];var tit = [];var pData = [];var obj1 = { tip: "", lists: [], check: [], clas: "" };var obj2 = { tip: "", lists: [], check: [], clas: "" };var inp = { tip: "", value: "" };var tds = elem.querySelectorAll('.form_label');var tdsLen = tds.length;for (var j = 0; j < tdsLen; j++) {
          ...
          obj1.tip = "radio";obj1.lists.push(label1[i].value);obj1.check.push(label1[i].checked);obj1.clas = elem.querySelector("#isBelowJcPrice").className;
        }pData.push(obj1);var label2 = elem.querySelector("#isBelowKsPrice").querySelectorAll("input");for (var i = 0; i < label2.length - 1; i++) {
          obj2.tip = "radio";obj2.lists.push(label2[i].value);obj2.check.push(label2[i].checked);obj2.clas = elem.querySelector("#isBelowKsPrice").className;
    ...
    doAction_uiControl174_FXKnek: function (data, elem) {
      if (data.eventType == "inputclick") {
        var a = data.dataCustom;var inputInd = parseInt(a.inputInd);var ind = parseInt(a.ind);var clases = a.clas;if (clases == "ysp-shenpiMoney one") {
          elem.querySelector("#isBelowJcPrice").querySelectorAll("input")[inputInd].click();
    ...
    getTemplate_uiControl174_FXKnek: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  inputClick:function(e){\n    var target=e.target;\n    var handler=this.props.customHandler;\n    if(handler){\n      handler({\n        data:{inputInd:target.dataset.i,ind:target.getAttribute("data-index"),clas:target.className},\n        eventType:"inputclick"\n      })\n    }\n  },\n  onChange:function(e){\n    var target=e.target;\n    var handler=this.props.customHandler;\n    // var reg = /[^0-9\\.]/g;\n    // target.value=target.value.replace( reg, \'\' );\n    // if(\ttarget.value==\'\'\t){\n    //    target.value=target.dataset.old;\n    // }\n    // if( target.value=="undefined" ){\n    //   target.value="";\n    // }\n    if(handler){\n      handler({\n        data:{val:target.value},\n        eventType:"change"\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.customData;\n    var _this = this;\n    var con = data&&data[0].length>0&&data[0].map(function(d,i){\n      return(\n        <div>\n          <span>{d}:</span>\n          {data[1][i].tip=="div" ? <AMUI.List>\n            <AMUI.List.Item nested="radio" >\n              <AMUI.Field label="\u662F" type="radio"  name="radio-list-1" data-key={data[1][i].lists[0].parent} data-id=\'0\' data-sign={data[1][i].lists[0].id} data-goal={data[1][i].lists[0].sign} checked={data[1][i].lists[0]==\'\u662F\' ? \'true\' : null} className=\'ysp-shenpiMoney one\'/>\n            </AMUI.List.Item>\n            <AMUI.List.Item nested="radio" >\n              <AMUI.Field label="\u5426" type="radio" checked={data[1][i].lists[1]==\'\u5426\' ? \'true\' : null} name="radio-list-1" data-key={data[1][i].lists[1].parent} data-id=\'1\'  data-sign={data[1][i].lists[1].id} className=\'ysp-shenpiMoney one\' data-goal={data[1][i].lists[1].sign}/>\n            </AMUI.List.Item>\n          </AMUI.List> : data[1][i].tip=="radio" ? <AMUI.List>\n            <AMUI.List.Item nested="radio" >\n              <AMUI.Field label="\u662F" type="radio"  name="radio-list-2" data-key={data[1][i].lists[0].parent} data-id=\'0\' data-sign={data[1][i].lists[0].id} data-goal={data[1][i].lists[0].sign} checked={data[1][i].lists[0]==\'\u662F\' ? \'true\' : null} className=\'ysp-shenpiMoney two\'/>\n            </AMUI.List.Item>\n            <AMUI.List.Item nested="radio" >\n              <AMUI.Field label="\u5426" type="radio" checked={data[1][i].lists[1]==\'\u5426\' ? \'true\' : null} name="radio-list-2" data-key={data[1][i].lists[1].parent} data-id=\'1\'  data-sign={data[1][i].lists[1].id} className=\'ysp-shenpiMoney two\' data-goal={data[1][i].lists[1].sign}/>\n            </AMUI.List.Item>\n          </AMUI.List> : data[1][i].tip=="input" ? <label className="inp"><AInput type="number" value={data[1][i].value} onChange={_this.onChange.bind(_this)} disabled={data[1][i].disable ? "disabled" : ""} className="num"/><span>\u5143</span></label> : ""}\n        </div>\n      )\n    })\n    return (\n      <div className="ysp-flowsheet ysp-datafrom2">{data&&data.length>0 ? <div className="ysp-flowsheet-onePart">{con}</div> : ""}</div>\n    )\n  }\n});\n';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  inputClick: function inputClick(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        data: { inputInd: target.dataset.i, ind: target.getAttribute("data-index"), clas: target.className },\n        eventType: "inputclick"\n      });\n    }\n  },\n  onChange: function onChange(e) {\n    var target = e.target;\n    var handler = this.props.customHandler;\n    // var reg = /[^0-9\\.]/g;\n    // target.value=target.value.replace( reg, \'\' );\n    // if(\ttarget.value==\'\'\t){\n    //    target.value=target.dataset.old;\n    // }\n    // if( target.value=="undefined" ){\n    //   target.value="";\n    // }\n    if (handler) {\n      handler({\n        data: { val: target.value },\n        eventType: "change"\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.customData;\n    var _this = this;\n    var con = data && data[0].length > 0 && data[0].map(function (d, i) {\n      return React.createElement(\n        "div",\n        null,\n        React.createElement(\n          "span",\n          null,\n          d,\n          ":"\n        ),\n        data[1][i].tip == "div" ? React.createElement(\n          AMUI.List,\n          null,\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u662F", type: "radio", name: "radio-list-1", "data-key": data[1][i].lists[0].parent, "data-id": "0", "data-sign": data[1][i].lists[0].id, "data-goal": data[1][i].lists[0].sign, checked: data[1][i].lists[0] == \'\u662F\' ? \'true\' : null, className: "ysp-shenpiMoney one" })\n          ),\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u5426", type: "radio", checked: data[1][i].lists[1] == \'\u5426\' ? \'true\' : null, name: "radio-list-1", "data-key": data[1][i].lists[1].parent, "data-id": "1", "data-sign": data[1][i].lists[1].id, className: "ysp-shenpiMoney one", "data-goal": data[1][i].lists[1].sign })\n          )\n        ) : data[1][i].tip == "radio" ? React.createElement(\n          AMUI.List,\n          null,\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u662F", type: "radio", name: "radio-list-2", "data-key": data[1][i].lists[0].parent, "data-id": "0", "data-sign": data[1][i].lists[0].id, "data-goal": data[1][i].lists[0].sign, checked: data[1][i].lists[0] == \'\u662F\' ? \'true\' : null, className: "ysp-shenpiMoney two" })\n          ),\n          React.createElement(\n            AMUI.List.Item,\n            { nested: "radio" },\n            React.createElement(AMUI.Field, { label: "\\u5426", type: "radio", checked: data[1][i].lists[1] == \'\u5426\' ? \'true\' : null, name: "radio-list-2", "data-key": data[1][i].lists[1].parent, "data-id": "1", "data-sign": data[1][i].lists[1].id, className: "ysp-shenpiMoney two", "data-goal": data[1][i].lists[1].sign })\n          )\n        ) : data[1][i].tip == "input" ? React.createElement(\n          "label",\n          { className: "inp" },\n          React.createElement(AInput, { type: "number", value: data[1][i].value, onChange: _this.onChange.bind(_this), disabled: data[1][i].disable ? "disabled" : "", className: "num" }),\n          React.createElement(\n            "span",\n            null,\n            "\\u5143"\n          )\n        ) : ""\n      );\n    });\n    return React.createElement(\n      "div",\n      { className: "ysp-flowsheet ysp-datafrom2" },\n      data && data.length > 0 ? React.createElement(\n        "div",\n        { className: "ysp-flowsheet-onePart" },\n        con\n      ) : ""\n    );\n  }\n});';
    }
  }, "goodBargain");
})(window, ysp);