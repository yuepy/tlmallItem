(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl169_qxPrPT: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    var con = data&&data[0].length>0&&data[0].map(function(d,i){\n      return(\n        <div>\n          <span>{d}:</span>\n          {data[1]&&data[1].length>0 ? <label>{data[1][i]}</label> : ""}\n          <span></span>\n        </div>\n      )\n    })\n    return (\n      <div className="ysp-flowsheet ysp-datafrom2">\n \xA0 \xA0 \xA0  {data&&data.length>0 ? <div className="ysp-rejectsStatus">{con}</div> : ""}\n \xA0 \xA0 \xA0</div>\n    )\n  }\n});';
    ...
    getTemplate_uiControl170_UFvWod: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n      <div className="ysp-flowsheet ysp-datafrom2">\n \xA0 \xA0 \xA0  {data&&data.length>0 ? <div className="ysp-Approval-opinions"><span>{data[0]}</span><textarea className="ysp-agree">{data[1]}</textarea></div> : ""}\n \xA0 \xA0 \xA0</div>\n    )\n  }\n});';
    ...
    getTemplate_uiControl165_AMXN11: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.customData;\n    return (\n       <div className="ysp-flowsheet ysp-datafrom2">\n \xA0 \xA0 \xA0  {data&&data.length>0 ? <div className="ysp-total"><h1>{data}</h1></div> : ""}\n \xA0 \xA0 \xA0</div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.customData;\n    return React.createElement(\n      "div",\n      { className: "ysp-flowsheet ysp-datafrom2" },\n      "\\xA0 \\xA0 \\xA0  ",\n      data && data.length > 0 ? React.createElement(\n        "div",\n        { className: "ysp-total" },\n        React.createElement(\n          "h1",\n          null,\n          data\n        )\n      ) : "",\n      "\\xA0 \\xA0 \\xA0"\n    );\n  }\n});';
    }
  }, "goodBargain");
})(window, ysp);