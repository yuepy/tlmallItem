(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control120_G7MVnc: function (elem) {
      if (!elem) {
        return;
      }const data = { processTit: [], base: { tit: [], con: [] }, contract: { tit: [], con: [] }, applicate: { tit: [], con: [] }, surggest: [], errorTip: {} }; //各项title
      ...
      const basetit = elem.querySelectorAll(".mini-panel")[0].querySelectorAll(".mini-panel-body .nui-form-table tr");[].map.call(basetit, function (item, index) {
      ...
      const contracttit = elem.querySelectorAll(".mini-panel")[1].querySelectorAll(".mini-panel-body .nui-form-table tr");[].map.call(contracttit, function (item, index) {
      ...
      const applicatetit = elem.querySelectorAll(".mini-panel")[2].querySelectorAll(".mini-panel-body .nui-form-table tr");[].map.call(applicatetit, function (item, index) {
        ...
        const a = item.querySelector("input");data.applicate.con.push(a.value);
      });const applicatetr3 = elem.querySelectorAll(".mini-panel")[2].querySelector(".mini-panel-body .nui-form-table tr:nth-child(3)").querySelector("td:nth-child(2n)");data.applicate.con.push(applicatetr3.textContent);const applicatetr4 = elem.querySelectorAll(".mini-panel")[2].querySelector(".mini-panel-body .nui-form-table tr:nth-child(4)").querySelector("textarea");data.applicate.con.push(applicatetr4.value); //审批意见
      const sugg = elem.querySelector("#approval .nui-form-table tbody tr td:nth-child(2)");data.surggest.push(sugg.querySelector("textarea").value);return data;
    },
