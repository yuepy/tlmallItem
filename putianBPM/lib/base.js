  ...
  utils.extend(ysp.customHelper, {
    ...
    */
    ...
    menuManager: {
      init: function() {
        this.menuHash = {
          "待处理的任务": "/ptsoa/bps/wfclient/task/taskList.jsp?taskType=self",
          "已处理的任务": "/ptsoa/bps/wfclient/task/taskList.jsp?taskType=finishedSelf",
    ...
    beforeTargetLoad: function(aWin, doc) {
      aWin.Object.defineProperty(aWin,'getTop',{
        value:function(){
          return aWin.top;
        },
        configurable:true,
