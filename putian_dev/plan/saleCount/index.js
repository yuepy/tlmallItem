...
if (elem.querySelectorAll('table') && elem.querySelectorAll('table')[1]) {
  ...
  for (var i = 0; i < theadTds.length; i = i + 2) {
    obj.push(theadTds[i].textContent);
  }
...
for (var i = 0; i < tbodyTrs.length; i++) {
  ...
  for (var j = 0; j < tbodyTds.length; j++) {
    objData.push(tbodyTds[j].textContent);
  }
...
return data;
    ...
    getTemplate_uiControl12: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function render() {\n    var data = this.props.data.customData;\n    var thead = data.thead;\n    var tbody = data.tbody;\n    var theadF = thead.map(function(th){\n      return (\n        <td>{th}</td>\n      );\n    });\n    var tbodyF = tbody.map(function(tbr){\n      var tbrT = tbr.map(function(tb){\n        return <td>{tb}</td>\n      });\n      return <tr>{tbrT}</tr>\n    });\n    return (\n      <table className="custom-table">\n        <thead className="tr-blue">\n          {theadF}\n        </thead>\n        <tbody className="tr-gray">\n          {tbodyF}\n        </tbody>\n      </table>\n    );\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.data.customData;\n    var thead = data.thead;\n    var tbody = data.tbody;\n    var theadF = thead.map(function (th) {\n      return React.createElement(\n        "td",\n        null,\n        th\n      );\n    });\n    var tbodyF = tbody.map(function (tbr) {\n      var tbrT = tbr.map(function (tb) {\n        return React.createElement(\n          "td",\n          null,\n          tb\n        );\n      });\n      return React.createElement(\n        "tr",\n        null,\n        tbrT\n      );\n    });\n    return React.createElement(\n      "table",\n      { className: "custom-table" },\n      React.createElement(\n        "thead",\n        { className: "tr-blue" },\n        theadF\n      ),\n      React.createElement(\n        "tbody",\n        { className: "tr-gray" },\n        tbodyF\n      )\n    );\n  }\n});';
    }
  });
})(window, ysp);