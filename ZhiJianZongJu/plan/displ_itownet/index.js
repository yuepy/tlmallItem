(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl12_lcnmT4: function () {
      var selfTemplate = 'import { Header, HeaderLeft } from \'ysp-interior-components\';\nimport { back } from \'appRenderer\';\nmodule.exports = React.createClass({\n  handleClick: function() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'click\'\n      });\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    const me = this;\n    return (\n      <div>\n        <Header amStyle="primary" title={data}>\n          <HeaderLeft>\n            <AMUI.Button amStyle="primary"  onClick={me.handleClick} style={{marginBottom:0,textAlign:"left", background:"#0a568c",borderColor:"#0a568c"}}><span className="icon icon-left-nav"></span>\u8FD4\u56DE</AMUI.Button>\n          </HeaderLeft>\n        </Header>\n      </div>\n    )\n  }\n});\n';
      return '\'use strict\';\n\nvar _yspInteriorComponents = require(\'ysp-interior-components\');\n\nvar _appRenderer = require(\'appRenderer\');\n\nmodule.exports = React.createClass({\n  displayName: \'exports\',\n\n  handleClick: function handleClick() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'click\'\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n    var me = this;\n    return React.createElement(\n      \'div\',\n      null,\n      React.createElement(\n        _yspInteriorComponents.Header,\n        { amStyle: \'primary\', title: data },\n        React.createElement(\n          _yspInteriorComponents.HeaderLeft,\n          null,\n          React.createElement(\n            AMUI.Button,\n            { amStyle: \'primary\', onClick: me.handleClick, style: { marginBottom: 0, textAlign: "left", background: "#0a568c", borderColor: "#0a568c" } },\n            React.createElement(\'span\', { className: \'icon icon-left-nav\' }),\n            \'\\u8FD4\\u56DE\'\n          )\n        )\n      )\n    );\n  }\n});';
    },
    ...
    getData_control20_dU6LML: function (elem) {
      if (!elem) {
        ...
        return;
      }var textArea = elem.querySelector('#openedDialog').querySelector('iframe').contentDocument.querySelector('textarea').value;var btnTxt = elem.querySelector('.dialog-button').querySelector('.l-btn').querySelector('.l-btn-left').querySelector('.l-btn-text').textContent;var data = [];var obj = {};obj.title = title;obj.btnTxt = btnTxt;obj.textArea = textArea;data.push(obj);return data;
    },
    ...
    doAction_uiControl9_0T1lGT: function (data, elem) {
      var type = data.eventType;var customData = data.customData;if (type === 'onBlur') {
        var inputs = elem.querySelectorAll('.textbox-text')[customData.index]; //inputs.value = customData.val;
        inputs.focus();$(inputs).val(customData.val);ysp.customHelper.fireKeyEvent(inputs, "keyup", 13);
      }if (type === 'onClick') {
        // var select = elem.querySelector("#acceptanceStatus");
        // select.value = customData;
      ...
      if (!elem) {
        ...
        var index = k;if ($(trs[k]).hasClass('datagrid-row-checked')) {
          var tds = trs[k].querySelectorAll('td');for (var j = 0; j < tIndex.length; j++) {
            if (j == 0) {
              data.push({ items: [], checked: true, index: index });
            }var val = tds[tIndex[j].index].textContent.trim();if (tIndex[j].name == "计量器具") {
              data[data.length - 1].mechanism = val;
            } else if (tIndex[j].name == "使用区域") {
              data[data.length - 1].code = val;
            } else if (tIndex[j].name == "状态") {
    ...
    getTemplate_uiControl8_GHEmhF: function () {
      var selfTemplate = 'const{  Container,TodoItemTypeOne,Pair,Icon}=AMUITouch2;\nmodule.exports = React.createClass({\n  onClick: function(index) {\n    var handler = this.props.customHandler;\n    var index = index;\n    if (handler) {\n      handler({\n        eventType: \'click\',\n        data:index\n      });\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    if(data == undefined){\n      return(<div></div>)\n    }else\n    var me = this;\n    var lis = data.map(function(d,i){\n if(d.mechanism == ""){\n      return(\n         <div style={{textAlign:"center"}}>\u6682\u65E0\u6570\u636E</div>\n        )\n      }\n      return(\n       <TodoItemTypeOne \n         defaultCollapsed\n         title={\n            <div style={{fontWeight:"bold"}} onClick={()=>{me.onClick(d.index)}}>{!d.checked?<span style={{paddingRight:5}}><Icon data-index={d.index} name="elect-l-c" /></span>:<span style={{paddingRight:5}}><Icon data-index={d.index} name="elect-c" /></span>}{d.mechanism}\n              {d.state == "\u5F85\u5206\u914D"?<span  style={{color:"#ff9d00",fontSize:12,float:"right"}}>O {d.state}</span>:<span  style={{color:"#eb092e",fontSize:12,float:"right"}}>O {d.state}</span>}</div>\n          }\n\n         subtitle={ <div style={{color:"#87939f"}}><Pair  name="\u4F7F\u7528\u533A\u57DF\uFF1A" value={d.code} /></div>}\n            >\n          \n          {d.items.map(function(item,j){\n            return(\n               <Pair  name={item.title} value={item.val} />\n            )\n          })}       \n       </TodoItemTypeOne>\n      )\n    })  \n    return (\n      <div>\n      \t{lis}\n      </div>\n    )\n  }\n});';
      return '"use strict";\n\nvar _AMUITouch = AMUITouch2,\n    Container = _AMUITouch.Container,\n    TodoItemTypeOne = _AMUITouch.TodoItemTypeOne,\n    Pair = _AMUITouch.Pair,\n    Icon = _AMUITouch.Icon;\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  onClick: function onClick(index) {\n    var handler = this.props.customHandler;\n    var index = index;\n    if (handler) {\n      handler({\n        eventType: \'click\',\n        data: index\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n    if (data == undefined) {\n      return React.createElement("div", null);\n    } else var me = this;\n    var lis = data.map(function (d, i) {\n      if (d.mechanism == "") {\n        return React.createElement(\n          "div",\n          { style: { textAlign: "center" } },\n          "\\u6682\\u65E0\\u6570\\u636E"\n        );\n      }\n      return React.createElement(\n        TodoItemTypeOne,\n        {\n          defaultCollapsed: true,\n          title: React.createElement(\n            "div",\n            { style: { fontWeight: "bold" }, onClick: function onClick() {\n                me.onClick(d.index);\n              } },\n            !d.checked ? React.createElement(\n              "span",\n              { style: { paddingRight: 5 } },\n              React.createElement(Icon, { "data-index": d.index, name: "elect-l-c" })\n            ) : React.createElement(\n              "span",\n              { style: { paddingRight: 5 } },\n              React.createElement(Icon, { "data-index": d.index, name: "elect-c" })\n            ),\n            d.mechanism,\n            d.state == "\u5F85\u5206\u914D" ? React.createElement(\n              "span",\n              { style: { color: "#ff9d00", fontSize: 12, float: "right" } },\n              "O ",\n              d.state\n            ) : React.createElement(\n              "span",\n              { style: { color: "#eb092e", fontSize: 12, float: "right" } },\n              "O ",\n              d.state\n            )\n          ),\n\n          subtitle: React.createElement(\n            "div",\n            { style: { color: "#87939f" } },\n            React.createElement(Pair, { name: "\\u4F7F\\u7528\\u533A\\u57DF\\uFF1A", value: d.code })\n          )\n        },\n        d.items.map(function (item, j) {\n          return React.createElement(Pair, { name: item.title, value: item.val });\n        })\n      );\n    });\n    return React.createElement(\n      "div",\n      null,\n      lis\n    );\n  }\n});';
    },
    ...
    getTemplate_uiControl10_1oAid9: function () {
      var selfTemplate = 'import { Header, HeaderLeft } from \'ysp-interior-components\';\nimport { back } from \'appRenderer\';\nmodule.exports = React.createClass({\n  handleClick: function() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'click\'\n      });\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    const me = this;\n    return (\n      <div>\n        <Header amStyle="primary" title={data}>\n          <HeaderLeft>\n            <AMUI.Button amStyle="primary" onClick={back} style={{marginBottom:0,textAlign:"left", background:"#0a568c",borderColor:"#0a568c"}}><span className="icon icon-left-nav"></span>\u8FD4\u56DE</AMUI.Button>\n          </HeaderLeft>\n        </Header>\n      </div>\n    )\n  }\n});\n';
      return '\'use strict\';\n\nvar _yspInteriorComponents = require(\'ysp-interior-components\');\n\nvar _appRenderer = require(\'appRenderer\');\n\nmodule.exports = React.createClass({\n  displayName: \'exports\',\n\n  handleClick: function handleClick() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'click\'\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n    var me = this;\n    return React.createElement(\n      \'div\',\n      null,\n      React.createElement(\n        _yspInteriorComponents.Header,\n        { amStyle: \'primary\', title: data },\n        React.createElement(\n          _yspInteriorComponents.HeaderLeft,\n          null,\n          React.createElement(\n            AMUI.Button,\n            { amStyle: \'primary\', onClick: _appRenderer.back, style: { marginBottom: 0, textAlign: "left", background: "#0a568c", borderColor: "#0a568c" } },\n            React.createElement(\'span\', { className: \'icon icon-left-nav\' }),\n            \'\\u8FD4\\u56DE\'\n          )\n        )\n      )\n    );\n  }\n});';
    },
    ...
    getTemplate_uiControl25_Ga28wL: function () {
      var selfTemplate = "const {Icon} = AMUITouch2;\nmodule.exports = React.createClass({\n  next: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'next',\n      });\n    }\n  },\n  prev: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'prev',\n      });\n    }\n  },\n  first: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'first',\n      });\n    }\n  },\n  last: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'last',\n      });\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    var _this = this;\n    if(data.page == \"0\"){\n      return(\n        <div></div> \n      )\n    }\n    return (\n      <div>\n        <div className=\"hzx-page-box\">\n          <div className=\"hzx-page-center\">\n            <div className=\"hzx-page-btn\"><span onClick={_this.first}><Icon name=\"double-left\"/></span><span onClick={_this.prev}><Icon name=\"left\"/></span></div>\n            <div style={{float:\"left\",marginLeft:20}}>\u7B2C</div>\n            <div className=\"hzx-page-round\">{data.page}</div>\n            <div style={{float:\"left\",marginRight:20}}>{data.allPage}</div>\n            <div className=\"hzx-page-btn\" style={{float:\"right\"}}><span onClick={_this.next}><Icon name=\"right\"/></span><span onClick={_this.last}><Icon name=\"double-right\"/></span></div>\n           </div>\n        </div>\n      </div>\n    )\n  }\n});";
      return "'use strict';\n\nvar _AMUITouch = AMUITouch2,\n    Icon = _AMUITouch.Icon;\n\nmodule.exports = React.createClass({\n  displayName: 'exports',\n\n  next: function next(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'next'\n      });\n    }\n  },\n  prev: function prev(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'prev'\n      });\n    }\n  },\n  first: function first(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'first'\n      });\n    }\n  },\n  last: function last(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'last'\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n    var _this = this;\n    if (data.page == \"0\") {\n      return React.createElement('div', null);\n    }\n    return React.createElement(\n      'div',\n      null,\n      React.createElement(\n        'div',\n        { className: 'hzx-page-box' },\n        React.createElement(\n          'div',\n          { className: 'hzx-page-center' },\n          React.createElement(\n            'div',\n            { className: 'hzx-page-btn' },\n            React.createElement(\n              'span',\n              { onClick: _this.first },\n              React.createElement(Icon, { name: 'double-left' })\n            ),\n            React.createElement(\n              'span',\n              { onClick: _this.prev },\n              React.createElement(Icon, { name: 'left' })\n            )\n          ),\n          React.createElement(\n            'div',\n            { style: { float: \"left\", marginLeft: 20 } },\n            '\\u7B2C'\n          ),\n          React.createElement(\n            'div',\n            { className: 'hzx-page-round' },\n            data.page\n          ),\n          React.createElement(\n            'div',\n            { style: { float: \"left\", marginRight: 20 } },\n            data.allPage\n          ),\n          React.createElement(\n            'div',\n            { className: 'hzx-page-btn', style: { float: \"right\" } },\n            React.createElement(\n              'span',\n              { onClick: _this.next },\n              React.createElement(Icon, { name: 'right' })\n            ),\n            React.createElement(\n              'span',\n              { onClick: _this.last },\n              React.createElement(Icon, { name: 'double-right' })\n            )\n          )\n        )\n      )\n    );\n  }\n});";
    }
  }, "displ_itownet");
})(window, ysp);