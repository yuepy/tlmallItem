(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl8_GHEmhF: function () {
      var selfTemplate = 'const{  Container,TodoItemTypeOne,Pair,Icon}=AMUITouch2;\nmodule.exports = React.createClass({\n  onClick: function(index) {\n    var handler = this.props.customHandler;\n    var index = index;\n    if (handler) {\n      handler({\n        eventType: \'click\',\n        data:index\n      });\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    if(data == undefined){\n      return(<div></div>)\n    }else\n    var me = this;\n    var lis = data.map(function(d,i){    \n    if(d.mechanism == ""){\n      return(\n         <div style={{textAlign:"center"}}>\u6682\u65E0\u6570\u636E</div>\n        )\n      }\n      return(\n       <TodoItemTypeOne \n         defaultCollapsed\n         title={\n            <div style={{fontWeight:"bold"}} onClick={()=>{me.onClick(d.index)}}>{!d.checked?<span style={{paddingRight:5}}><Icon data-index={d.index} name="elect-l-c" /></span>:<span style={{paddingRight:5}}><Icon data-index={d.index} name="elect-c" style={{color:"#0a568c"}} /></span>}{d.mechanism}\n              {d.state == "\u5F85\u5206\u914D"?<span  style={{color:"#ff9d00",fontSize:12,float:"right"}}>O {d.state}</span>:<span  style={{color:"#eb092e",fontSize:12,float:"right"}}>O {d.state}</span>}</div>\n          }\n\n         subtitle={ <div style={{color:"#87939f"}}><Pair  name="\u4F7F\u7528\u533A\u57DF\uFF1A" value={d.code} /></div>}\n            >\n          \n          {d.items.map(function(item,j){\n            return(\n               <Pair  name={item.title} value={item.val} />\n            )\n          })}       \n       </TodoItemTypeOne>\n      )\n    })  \n    return (\n      <div>\n      \t{lis}\n      </div>\n    )\n  }\n});';
    ...
    getTemplate_uiControl24_02QD6P: function () {
      var selfTemplate = 'const {Modal} = AMUITouch2;\nmodule.exports = React.createClass({\n  handleClick: function() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'click\'\n      });\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    var me = this;\n    if(data == undefined){\n      return(<div></div>)\n    }\n    return (\n      <div>\n        <Modal\n          role="alert" style={{position:"fixed",zIndex:9999}}\n          isOpen= {true}\n          onAction={me.handleClick}\n        >\n          <div className="hzx-success-icon"></div>\n          {data}\n        </Modal>\n      </div>\n    )\n  }\n});\n';
      return '"use strict";\n\nvar _AMUITouch = AMUITouch2,\n    Modal = _AMUITouch.Modal;\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  handleClick: function handleClick() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: \'click\'\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n    var me = this;\n    if (data == undefined) {\n      return React.createElement("div", null);\n    }\n    return React.createElement(\n      "div",\n      null,\n      React.createElement(\n        Modal,\n        {\n          role: "alert", style: { position: "fixed", zIndex: 9999 },\n          isOpen: true,\n          onAction: me.handleClick\n        },\n        React.createElement("div", { className: "hzx-success-icon" }),\n        data\n      )\n    );\n  }\n});';
    },
