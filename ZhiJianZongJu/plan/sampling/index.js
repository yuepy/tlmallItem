(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control8_em0xM3: function (elem) {
      if (!elem) {
        return;
      }console.log(elem);var obj = {};obj.current = [];obj.hide = [];var btn = elem.querySelectorAll('.cydjbut'); // console.log(btn);
      for (var i = 0; i < 2; i++) {
    ...
    getData_control11_2TiVW6: function (elem) {
      if (!elem) {
        return;
      }var elem = elem.querySelector('iframe').contentWindow.document;var elema = elem.querySelector('#enterprise-info');var redio = elem.querySelectorAll('.combo-panel');var obj = {};var title = elema.querySelector('.tabs-inner').textContent;obj.title = title;var trs = elema.querySelector('#queryDiv').querySelectorAll('tr');obj.list = [];var a = 0;for (var i = 0; i < trs.length; i++) {
    ...
    getData_control27_tNyV2f: function (elem) {
      if (!elem) {
        return;
      }var elem = elem.querySelector('iframe').contentWindow.document;var arr = [];var seleElem = elem.querySelectorAll('.combo-p');for (var i = 0; i < seleElem.length; i++) {
    ...
    doAction_uiControl27_kvRr1i: function (data, elem) {
      var type = data.eventType;var customData = data.customData;var elem = elem.querySelector('iframe').contentWindow.document;if (type == 'closeModal') {
    ...
    getTemplate_uiControl27_kvRr1i: function () {
    ...
    getData_control28_ex29s2: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl28_BFwHgV: function (data, elem) {
    ...
    getTemplate_uiControl28_BFwHgV: function () {
    ...
    getData_control29_bpluQ1: function (elem) {
      if (!elem) {
        return;
      }var obj = {};console.log(elem.querySelector('.panel-tool').querySelector('a'));obj.title = elem.querySelector('.panel-title').textContent;obj.currentPage = elem.querySelector('.datagrid-pager').querySelectorAll('td')[6].querySelector('input').value;obj.allPage = elem.querySelector('.datagrid-pager').querySelectorAll('td')[7].textContent;return obj;
    },
    doAction_uiControl29_APpiko: function (data, elem) {
      var type = data.eventType;if (type == 'next') {
        elem.querySelector('.datagrid-pager').querySelectorAll('td')[9].click();
      } else if (type == 'prev') {
        elem.querySelector('.datagrid-pager').querySelectorAll('td')[3].click();
      } else if (type == 'first') {
        elem.querySelector('.datagrid-pager').querySelectorAll('td')[2].click();
      } else if (type == 'last') {
        elem.querySelector('.datagrid-pager').querySelectorAll('td')[10].click();
      } else if (type == 'back') {
        elem.querySelector('.panel-tool').querySelector('a').click();
      }
    },
    getTemplate_uiControl29_APpiko: function () {
      var selfTemplate = "import { Header, HeaderLeft,HeaderRight } from 'ysp-interior-components';\nconst {Icon} = AMUITouch2;\nmodule.exports = React.createClass({\n  back:function(){\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'back',\n      });\n    }\n  },\n  next: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'next',\n      });\n    }\n  },\n  prev: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'prev',\n      });\n    }\n  },\n  first: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'first',\n      });\n    }\n  },\n  last: function(index) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'last',\n      });\n    }\n  },\n  render: function() {\n    var _this = this;\n    var data=this.props.data.customData;\n    return (\n      <div style={{position:'fixed',top:0,zIndex:'9999',width:'100%'}}>\n        {data?<div>\n        \t<Header amStyle=\"primary\" title={data.title} style={{position:'relative',zIndex:1,background:'#0a568c'}}>\n        <HeaderLeft>\n          <AMUI.Button amStyle=\"primary\" onClick={_this.back} style={{marginLeft:'-15px',background:'#0a568c',border:\"#0a568c\",marginBottom:0}}><span className=\"icon icon-left-nav\"></span>\u8FD4\u56DE</AMUI.Button>\n        \t</HeaderLeft>\n      </Header>\n         <div className=\"hzx-page-box\">\n          <span className=\"hzx-page-left\">\n            <span onClick={_this.first}>|&lt;</span>\n            <span onClick={_this.prev}>&lt;</span>\n          </span>\n          <span className=\"hzx-page-center\">\n            <span>\n              <span>\u7B2C</span>\n              <span>{data.currentPage}</span>\n            </span>\n            <span>{data.allPage}</span>\n          </span>\n          <span className=\"hzx-page-right\">\n            <span onClick={_this.next} >&gt;</span>\n            <span onClick={_this.last} >&gt;|</span>\n          </span>\n        </div> \t\n        </div>:<div></div>}\n      </div>\n    )\n  }\n});";
