(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control33_5P7ZlT: function (elem) {
      ...
      }console.log(obj[obj.length - 1]);return obj;
    },
