(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl31_AoLagy: function () {
      var selfTemplate = 'const{  Container,TodoItemTypeOne,Pair,Icon}=AMUITouch2;\nmodule.exports = React.createClass({\n  click:function(e){\n    var target = e.target;\n    if(target.className==\'deilTitle\'){\n      target = target.querySelectorAll(\'p\')[1];\n    }else{\n      target = target.parentElement.querySelectorAll(\'p\')[1];\n    }\n    if(target.parentElement.nextElementSibling.style.display==\'none\'){\n      // target.style.backgroundImage = \'url(./img/top.png)\';\n      target.className = \'top\';\n      target.parentElement.style.borderBottom = \'1px solid #ccc\';\n      target.parentElement.nextElementSibling.style.display = \'block\';\n    }else{\n      // target.style.backgroundImage = \'url(./img/xia.png)\';\n      target.className = \'xia\';\n      target.parentElement.style.borderBottom = \'0\';\n      target.parentElement.nextElementSibling.style.display = \'none\';\n    }\n    e.stopPropagation();\n  },\n  onClick:function(e){\n    var handler = this.props.customHandler,\n        target = e.target,\n        index = target.dataset.index;\n    if(handler){\n      handler({\n        eventType:\'icon\',\n        data:index\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.data.customData;\n    var _this = this;\n    const oder={\n\t\t\t  width:\'8px\',\n      \theight:\'8px\',\n        borderRadius: \'50%\',\n      \tborder:\'solid 1px #ff9d00\',\n      display: \'inline-block\',\n      marginRight:\'10px\'\n\t\t}\n    var lis = data.map(function(ele,index){\n      return(\n        <div className=\'deilitem deilQuery\' >\n          <div data-index={index} onClick={_this.onClick.bind(_this)} className={ele.className==\'datagrid-row datagrid-row-checked datagrid-row-selected\'||ele.className==\'datagrid-row   datagrid-row-checked datagrid-row-selected\'?\'seledradio\':\'\'}></div>\n          <div onClick={_this.click.bind(_this)} className=\'deilTitle\' style={{position: \'relative\'}}>\n          \t<p onClick={_this.click.bind(_this)}>{ele.checkPlanName}</p>\n            <p className=\'xia\' onClick={_this.click.bind(_this)}>\u4EA7\u54C1\u540D\u79F0\uFF1A{ele.prodName}</p>\n            <span style={{position: \'absolute\',top:33,right:21,fontSize:\'12px\',color:\'#ff9d00\'}}>{ele.samplState}</span>\n          </div>\n          <div className=\'deilContent\' style={{\'display\':\'none\'}} >\n            {ele.detail.map(function(ele,index){\n              return(\n              <p>{ele.key}:&nbsp;&nbsp;&nbsp;{ele.val}</p>\n              )\n            })}\n          \t\n          </div>\n        </div>\n      )\n    })    \n    return (\n      <div style={{background:\'#f2f2f2\',padding:\'10px 0\'}} className=\'deilTable\'>\n      \t{!data[0].checkPlanName?null:lis}\n      </div>\n    )\n  }\n});';
      return '\'use strict\';\n\nvar _AMUITouch = AMUITouch2,\n    Container = _AMUITouch.Container,\n    TodoItemTypeOne = _AMUITouch.TodoItemTypeOne,\n    Pair = _AMUITouch.Pair,\n    Icon = _AMUITouch.Icon;\n\nmodule.exports = React.createClass({\n  displayName: \'exports\',\n\n  click: function click(e) {\n    var target = e.target;\n    if (target.className == \'deilTitle\') {\n      target = target.querySelectorAll(\'p\')[1];\n    } else {\n      target = target.parentElement.querySelectorAll(\'p\')[1];\n    }\n    if (target.parentElement.nextElementSibling.style.display == \'none\') {\n      // target.style.backgroundImage = \'url(./img/top.png)\';\n      target.className = \'top\';\n      target.parentElement.style.borderBottom = \'1px solid #ccc\';\n      target.parentElement.nextElementSibling.style.display = \'block\';\n    } else {\n      // target.style.backgroundImage = \'url(./img/xia.png)\';\n      target.className = \'xia\';\n      target.parentElement.style.borderBottom = \'0\';\n      target.parentElement.nextElementSibling.style.display = \'none\';\n    }\n    e.stopPropagation();\n  },\n  onClick: function onClick(e) {\n    var handler = this.props.customHandler,\n        target = e.target,\n        index = target.dataset.index;\n    if (handler) {\n      handler({\n        eventType: \'icon\',\n        data: index\n      });\n    }\n  },\n  render: function render() {\n    var data = this.props.data.customData;\n    var _this = this;\n    var oder = {\n      width: \'8px\',\n      height: \'8px\',\n      borderRadius: \'50%\',\n      border: \'solid 1px #ff9d00\',\n      display: \'inline-block\',\n      marginRight: \'10px\'\n    };\n    var lis = data.map(function (ele, index) {\n      return React.createElement(\n        \'div\',\n        { className: \'deilitem deilQuery\' },\n        React.createElement(\'div\', { \'data-index\': index, onClick: _this.onClick.bind(_this), className: ele.className == \'datagrid-row datagrid-row-checked datagrid-row-selected\' || ele.className == \'datagrid-row   datagrid-row-checked datagrid-row-selected\' ? \'seledradio\' : \'\' }),\n        React.createElement(\n          \'div\',\n          { onClick: _this.click.bind(_this), className: \'deilTitle\', style: { position: \'relative\' } },\n          React.createElement(\n            \'p\',\n            { onClick: _this.click.bind(_this) },\n            ele.checkPlanName\n          ),\n          React.createElement(\n            \'p\',\n            { className: \'xia\', onClick: _this.click.bind(_this) },\n            \'\\u4EA7\\u54C1\\u540D\\u79F0\\uFF1A\',\n            ele.prodName\n          ),\n          React.createElement(\n            \'span\',\n            { style: { position: \'absolute\', top: 33, right: 21, fontSize: \'12px\', color: \'#ff9d00\' } },\n            ele.samplState\n          )\n        ),\n        React.createElement(\n          \'div\',\n          { className: \'deilContent\', style: { \'display\': \'none\' } },\n          ele.detail.map(function (ele, index) {\n            return React.createElement(\n              \'p\',\n              null,\n              ele.key,\n              \':\\xA0\\xA0\\xA0\',\n              ele.val\n            );\n          })\n        )\n      );\n    });\n    return React.createElement(\n      \'div\',\n      { style: { background: \'#f2f2f2\', padding: \'10px 0\' }, className: \'deilTable\' },\n      !data[0].checkPlanName ? null : lis\n    );\n  }\n});';
    },
    getData_control34_GOSLPz: function (elem) {
      if (!elem) {
        return;
      }var obj = {};obj.current = [];obj.hide = [];var btn = elem.querySelectorAll('.cydjbut');for (var i = 0; i < 2; i++) {
        var cur = btn[i].value;obj.current.unshift(cur);
      }var hidea = btn[3].value;var hideb = btn[4].value;var hidec = btn[2].value;obj.hide.push(hideb);obj.hide.push(hidec);obj.hide.push(hidea);var ab = btn[0].getAttribute('disabled');if (ab == 'disabled') {
        obj.disabled = true;
      } else {
        obj.disabled = false;
      }return obj;
