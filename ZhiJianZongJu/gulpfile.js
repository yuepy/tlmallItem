...
//修改域名 ip http://egs.itownet.cn:9080 改为 域名 http://info.cofcoko.com
gulp.task('releaseCom', function() {
    gulp.src(['**/*', '!./gulpfile.js', '!./lib/images/**/*', '!./**/*.png', '!./**/css/**/*', '!/**/*.ico'])
        ...
        .pipe(replace(/http:\\{2}\/\\{2}\/172\\{2}.16\\{2}.11\\{2}.61:81/gm, 'https:\\\\/\\\\/payroll\\\\.cofcoko\\\\.com'))
        ...
        .pipe(replace(/http:\/\/172\.16\.11\.61:81/gm, 'https://payroll.cofcoko.com'))
...
gulp.task('devCom', function() {
    gulp.src(['**/*', '!./gulpfile.js', '!./lib/images/**/*', '!./**/*.png', '!./**/css/**/*', '!/**/*.ico'])
        //可口可乐 http://info.cofcoko.com 环境转移 http://egs.itownet.cn:9080 环境
