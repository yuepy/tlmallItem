(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control762_wZ6IKd: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.textContent.trim();return data;
    },
    doAction_uiControl762_CdXDPv: function (data, elem) {},
    getTemplate_uiControl762_CdXDPv: function () {
    ...
    getData_control763_aTwPDP: function (elem) {},
    doAction_uiControl763_IWgK0f: function (data, elem) {
    ...
    getTemplate_uiControl763_IWgK0f: function () {
    ...
    getData_control764_x6xSNr: function (elem) {},
    doAction_uiControl764_zK1e68: function (data, elem) {},
    getTemplate_uiControl764_zK1e68: function () {
    ...
    getData_control765_Bv7qGA: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.firstElementChild.textContent.trim();data.titleinfo = elem.firstElementChild.nextElementSibling.textContent.trim();data.imgs = [];data.texts = [];var textimgs = elem.querySelectorAll('div')[0].children;for (var i = 0; i < textimgs.length; i++) {
    ...
    doAction_uiControl765_NBOZFB: function (data, elem) {},
    getTemplate_uiControl765_NBOZFB: function () {
