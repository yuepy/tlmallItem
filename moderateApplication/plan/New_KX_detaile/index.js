(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control637_rNTSVo: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.textContent.trim();return data;
    },
    doAction_uiControl637_oq7FUE: function (data, elem) {},
    getTemplate_uiControl637_oq7FUE: function () {
    ...
    getData_control638_w4DHkT: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl638_dv9hDX: function (data, elem) {},
    getTemplate_uiControl638_dv9hDX: function () {
    ...
    getData_control642_rA1IaL: function (elem) {},
    doAction_uiControl642_1iayCt: function (data, elem) {
    ...
    getTemplate_uiControl642_1iayCt: function () {
