(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control723_48oTJh: function (elem) {
      ...
      var contents = elem.children;for (var i = 2; i < contents.length; i++) {
        if (contents[i].tagName.toLowerCase() == 'img' || contents[i].querySelector('img') || contents[i].textContent.trim() != '') {
          var obj = {};if (contents[i].tagName.toLowerCase() == 'img') {
            obj.src = [];obj.alt = [];obj.flat = 'img';obj.src.push(contents[i].src);obj.alt.push(contents[i].alt);
          } else {
    ...
    getData_control850_0kRi6H: function (elem) {},
    doAction_uiControl850_kkqJm1: function (data, elem) {},
    getTemplate_uiControl850_kkqJm1: function () {
