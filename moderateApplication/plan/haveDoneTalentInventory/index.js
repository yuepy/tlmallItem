(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control353_1uSZ1H: function (elem) {
      ...
      var trs = elem.querySelectorAll('tr');data.title = '申请人信息';data.content = [];for (var i = 0; i < trs.length; i++) {
    ...
    getData_control773_pGEGuk: function (elem) {},
    doAction_uiControl773_HeeMfG: function (data, elem) {},
    getTemplate_uiControl773_HeeMfG: function () {
