(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control758_zIG4To: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.textContent.trim();return data;
    },
    doAction_uiControl758_HhqPbT: function (data, elem) {},
    getTemplate_uiControl758_HhqPbT: function () {
    ...
    getData_control759_lHkVOX: function (elem) {},
    doAction_uiControl759_rBkILX: function (data, elem) {
    ...
    getTemplate_uiControl759_rBkILX: function () {
    ...
    getData_control760_TSNOcp: function (elem) {},
    doAction_uiControl760_JITLKt: function (data, elem) {},
    getTemplate_uiControl760_JITLKt: function () {
    ...
    getData_control761_yeIXQD: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl761_eI4vyl: function (data, elem) {},
    getTemplate_uiControl761_eI4vyl: function () {
