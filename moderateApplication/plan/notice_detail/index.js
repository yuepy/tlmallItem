(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
        ...
        var contents = elem.querySelectorAll('div')[0].children;for (var i = 0; i < contents.length; i++) {
          if (contents[i].querySelector('img') || contents[i].textContent.trim() != '') {
            ...
            if (contents[i].querySelector('a') && !contents[i].querySelector('img')) {
              obj.href = [];obj.text = [];
              var hrefs = contents[i].querySelectorAll('a');for (var k = 0; k < hrefs.length; k++) {
    ...
    getData_control851_xrfPTo: function (elem) {},
    doAction_uiControl851_IrDGiT: function (data, elem) {},
    getTemplate_uiControl851_IrDGiT: function () {
