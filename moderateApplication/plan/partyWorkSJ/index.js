(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control695_HeeHuX: function (elem) {
      if (!elem) {
        return;
      }var data = {};var span = elem.querySelector('span');data.title = span.nextSibling.nextSibling.textContent.trim();return data;
    },
    doAction_uiControl695_VPkWgq: function (data, elem) {},
    getTemplate_uiControl695_VPkWgq: function () {
    ...
    getData_control696_vVaUpl: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.firstElementChild.textContent.trim();data.titleinfo = elem.firstElementChild.nextElementSibling.textContent.trim();data.imgs = [];data.texts = [];if (elem.querySelectorAll('div')[0]) {
        var textimgs = elem.querySelectorAll('div')[0].children; // var textimgs = elem.children;
    ...
    doAction_uiControl696_4b2a8L: function (data, elem) {},
    getTemplate_uiControl696_4b2a8L: function () {
    ...
    getData_control697_kTnoWZ: function (elem) {},
    doAction_uiControl697_QnIZAg: function (data, elem) {
    ...
    getTemplate_uiControl697_QnIZAg: function () {
    ...
    getData_control435_1SmGTb: function (elem) {},
    doAction_uiControl435_N7CSi2: function (data, elem) {},
    getTemplate_uiControl435_N7CSi2: function () {
