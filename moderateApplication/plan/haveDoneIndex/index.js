            ...
            if (ysp.appMain.isAndroid()) {
              ...
              var _setupWebViewJavascriptBridge = function (callback) {
                if (window.WebViewJavascriptBridge) {
                  ...
                  return window.WVJBCallbacks.push(callback);
                }window.WVJBCallbacks = [callback];var WVJBIframe = document.createElement("iframe");WVJBIframe.style.display = "none";WVJBIframe.src = "wvjbscheme://__BRIDGE_LOADED__";
                document.documentElement.appendChild(WVJBIframe);setTimeout(function () {
                  document.documentElement.removeChild(WVJBIframe);
                }, 0);
              };_setupWebViewJavascriptBridge(function (bridge) {
                bridge.callHandler("closePageType", 'false', function responseCallback(responseData) {});
