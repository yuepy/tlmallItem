  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl193_bw3nWM: function (data, elem) {
      var type = data.eventType,
        ...
        var flat = arr.indexOf(data.text);if (flat == -1) {
          ...
          var hreflo = '';hreflo += elem.querySelectorAll('tr')[++data.id].querySelector('a').onclick.toString().split("ShowPage('")[1].split("')")[0];if (hreflo[0] == 'h') {
    ...
    getData_control240_SJr66K: function (elem) {
      ...
      for (var i = 0; i < trs.length; i++) {
        var trArr = { leftTitle: [], sel: { optType: [], opt: [] }, iptVal: [], iptType: [] };if (i == 0) {
