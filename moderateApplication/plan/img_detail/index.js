(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control645_R1t8pZ: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.textContent.trim();return data;
    },
    doAction_uiControl645_duSTU6: function (data, elem) {},
    getTemplate_uiControl645_duSTU6: function () {
    ...
    getData_control646_X4ikDB: function (elem) {
      if (!elem) {
        return;
      }var data = {};data.title = elem.firstElementChild.textContent.trim();data.titleinfo = elem.firstElementChild.nextElementSibling.textContent.trim();data.imgs = [];data.texts = [];var textimgs = elem.querySelectorAll('div')[0].children; // var textimgs = elem.children;
    ...
    doAction_uiControl646_TJfNKM: function (data, elem) {},
    getTemplate_uiControl646_TJfNKM: function () {
    ...
    getData_control647_aZrnWF: function (elem) {},
    doAction_uiControl647_ZsvWTC: function (data, elem) {
    ...
    getTemplate_uiControl647_ZsvWTC: function () {
