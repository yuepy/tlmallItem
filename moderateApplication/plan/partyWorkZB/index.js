(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control701_ItH1NQ: function (elem) {
      if (!elem) {
        return;
      }var data = {};var span = elem.querySelector('span');data.title = span.nextSibling.nextSibling.textContent.trim();return data;
    },
    doAction_uiControl701_l61H20: function (data, elem) {},
    getTemplate_uiControl701_l61H20: function () {
    ...
    getData_control702_s62inZ: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl702_aDnr1F: function (data, elem) {},
    getTemplate_uiControl702_aDnr1F: function () {
    ...
    getData_control703_1bUqFe: function (elem) {},
    doAction_uiControl703_dOhxK9: function (data, elem) {
    ...
    getTemplate_uiControl703_dOhxK9: function () {
    ...
    getData_control682_xLPhhE: function (elem) {},
    doAction_uiControl682_gkTulN: function (data, elem) {},
    getTemplate_uiControl682_gkTulN: function () {
