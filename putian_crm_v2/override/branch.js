            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (configType != '02') {
                        ...
                        // 地图上的分公司排名
                        $("#branchRankName").html(response.rank.name.substring(11));
                        $("#branchRankQty").html('第' + response.rank.qtyRank + '位');
                        $("#branchRankAmt").html('第' +response.rank.amtRank  + '位');
                        ...
                        if(response.bizUnits) {
                            ...
                            for (var k = 0; k < response.bizUnits.length; k++) {
                                ...
                                for(var j =0; j< projects.length ;j++) {
                                    // 项目 + 分公司
                                    var link = '/ptDataShow/salesPlan/salesOverview?type=05&projectName='+ encodeURIComponent(projects[j].name) + "&bizUnitName=" + encodeURIComponent($("#bizUnitName").text()) + '&branchName=' + encodeURIComponent(branchName) + "&filter_userId=" + loginName + '&encoder=' + encoder + '&date='+ $("#selDay").val();
                                    tableHtml = tableHtml + '<tr><td title="' + projects[j].name +'"><a href="'+ link +'" title="' + projects[j].name + '">' + projects[j].name + '</a></td><td>' + projects[j].targetQty + '</td><td>' + projects[j].reachQty + '</td><td>' + projects[j].reachQtyRate + '%</td><td>'
                        ...
                        if(response.officeName) {
                            for(var i =0; i< response.officeName.length ;i++) {
                                ...
                                var link = '/ptDataShow/salesPlan/salesOverview?type=06&officeName=' + encodeURIComponent(office.name) + "&projectName=" +  encodeURIComponent($("#projectName").text()) + "&bizUnitName=" + encodeURIComponent($("#bizUnitName").text()) + "&filter_userId=" + loginName + '&encoder=' + encoder + '&date='+ $("#selDay").val();
                                var html = '<tr><td><a href="'+ link +'" title="' + office.name + '">' + office.name + '</a></td><td>' + office.targetQty + '</td><td>' + office.reachQty + '</td><td>' + office.reachQtyRate + '%</td><td>'
                                    + office.targetAmt + '</td><td>' + office.reachAmt + '</td><td>' + office.reachAmtRate + '%</td></tr>';
                        ...
                        if(response.salerName) {
                            for(var i =0; i< response.salerName.length ;i++) {
                                ...
                                var link = '/ptDataShow/salesPlan/salesOverview?type=07&salerName=' + encodeURIComponent(man.name) + "&projectName=" +  encodeURIComponent($("#projectName").text()) + "&bizUnitName=" + encodeURIComponent($("#bizUnitName").text()) + "&filter_userId=" + loginName + '&encoder=' + encoder + '&date='+ $("#selDay").val();
                                var html = '<tr><td><a href="'+ link +'" title="' + man.name + '">' + man.name + '</a></td><td>' + man.targetQty + '</td><td>' + man.reachQty + '</td><td>' + man.reachQtyRate + '%</td><td>'
                                    + man.targetAmt + '</td><td>' + man.reachAmt + '</td><td>' + man.reachAmtRate + '%</td></tr>';
            ...
            $.get('/ptDataShow/js/echarts/province/' + provinceName + '/' + provinceName + '.json', function (data) {
                ...
                chart.on('click', function(params) {
                    ...
                    if(params.data.company && params.data.value){
                        ...
                        var link = '/ptDataShow/salesPlan/salesOverview?type=06&officeName=' + encodeURIComponent(officeName)+ "&projectName=" +  encodeURIComponent($("#projectName").text()) + "&bizUnitName=" + encodeURIComponent($("#bizUnitName").text()) + "&filter_userId=" + loginName + '&encoder=' + encoder + '&date='+ $("#selDay").val();
