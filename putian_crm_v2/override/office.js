                    ...
                    if (configType != '02') {
                        ...
                        if(response.salerName) {
                            for(var i =0; i< response.salerName.length ;i++) {
                                ...
                                var link = '/ptDataShow/salesPlan/salesOverview?type=07&salerName=' + encodeURIComponent(saler.name) + "&filter_userId=" + loginName + '&encoder=' + encoder + '&date='+ $("#selDay").val();
                                var html = '<tr><td><a href="'+link+'" title="' + saler.name + '">' + saler.name + '</a></td><td>' + saler.targetQty + '</td><td>' + saler.reachQty + '</td><td>' + saler.reachQtyRate + '%</td><td>'
                                    + saler.targetAmt + '</td><td>' + saler.reachAmt + '</td><td>' + saler.reachAmtRate + '%</td></tr>';
