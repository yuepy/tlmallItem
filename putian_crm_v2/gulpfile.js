...
//这是为了上线做的脚本http://192.168.1.224:8080/
gulp.task('release', function() {
    gulp.src(['**/*', '!./gulpfile.js', '!./lib/images/**/*', '!./**/*.png', '!./**/css/**/*', '!/**/*.ico'])
        //VRCM 192.168.1.224:8080 环境转移 192.168.1.227 环境
        .pipe(replace(/http:\\{2}\/\\{2}\/192\\{2}.168\\{2}.1\\{2}.224:8080/gm, 'http:\\\\/\\\\/192\\\\.168\\\\.1\\\\.227'))
        .pipe(replace(/192\.168\.1\.224:8080/gm, '192.168.1.227'))
        .pipe(replace(/192\.168\.1\.224/gm, '192.168.1.227'))
...
gulp.task('dev', function() {
    gulp.src(['**/*', '!./gulpfile.js', '!./lib/images/**/*', '!./**/*.png', '!./**/css/**/*', '!/**/*.ico'])
        ...
        .pipe(replace(/http:\\{2}\/\\{2}\/192\\{2}.168\\{2}.1\\{2}.227/gm, 'http:\\\\/\\\\/192\\\\.168\\\\.1\\\\.224:8080'))
        .pipe(replace(/192\.168\.1\.227/gm, '192.168.1.224:8080'))
        .pipe(replace(/192\.168\.1\.227/gm, '192.168.1.224'))
